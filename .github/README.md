...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.978.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.978.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UBMH8Y3icm8RdM35eqeFgGtZihFqO6lGUMHD5Iitd+7vSMwsPxWCRO0dAkuu+fL8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.978.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.978.0/index.min.mjs": "sha384-UBMH8Y3icm8RdM35eqeFgGtZihFqO6lGUMHD5Iitd+7vSMwsPxWCRO0dAkuu+fL8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.978.0/LICENSE
```

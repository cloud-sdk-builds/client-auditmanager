...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.1041.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1041.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mW48t6tSQoUJwsztVNMjm/GlBQPfrsjmFIcFAAF6R/XfvJhgZBVu7L4fYm2hQ+/m
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1041.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1041.0/index.min.mjs": "sha384-mW48t6tSQoUJwsztVNMjm/GlBQPfrsjmFIcFAAF6R/XfvJhgZBVu7L4fYm2hQ+/m"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.1041.0/LICENSE
```

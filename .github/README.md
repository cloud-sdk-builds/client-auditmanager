...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.1042.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1042.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-g+lUJFsl59blP+31h+Z1FABEM6jdfAI3YiHfSlkbWhfKAGQXnQiwL4ReowCayGDG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1042.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1042.0/index.min.mjs": "sha384-g+lUJFsl59blP+31h+Z1FABEM6jdfAI3YiHfSlkbWhfKAGQXnQiwL4ReowCayGDG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.1042.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.988.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.988.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RTHNJ+Iet2EZ2HN0AZmZhTAA3pwoYGvl4lS8jbD9eTEuffCkAAWPWYFnnu71UeU/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.988.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.988.0/index.min.mjs": "sha384-RTHNJ+Iet2EZ2HN0AZmZhTAA3pwoYGvl4lS8jbD9eTEuffCkAAWPWYFnnu71UeU/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.988.0/LICENSE
```

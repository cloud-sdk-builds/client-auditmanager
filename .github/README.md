...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.438.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.438.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0KeMY6rhcZ+RBUi68RG8i0rK/iaKTCgvKEz74TmQPRtSZA4jkI8Jg8YjZKg5/N9h
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.438.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.438.0/index.min.mjs": "sha384-0KeMY6rhcZ+RBUi68RG8i0rK/iaKTCgvKEz74TmQPRtSZA4jkI8Jg8YjZKg5/N9h"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.438.0/LICENSE
```

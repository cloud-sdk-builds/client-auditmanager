...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.662.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.662.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dk4YdOY4OBmbMq9r0YVH8b8cFPzj/K7byNIDbXlln8DQMXVmAdXBqHjqTHuTydW6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.662.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.662.0/index.min.mjs": "sha384-dk4YdOY4OBmbMq9r0YVH8b8cFPzj/K7byNIDbXlln8DQMXVmAdXBqHjqTHuTydW6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.662.0/LICENSE
```

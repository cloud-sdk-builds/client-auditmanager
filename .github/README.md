...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.621.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.621.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ap+3gVLf2zKNPDgVPR/u4X4Xyq/u8mUUwRUun39N+UjuXZ/FZS+Yz5nnME19JM2k
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.621.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.621.0/index.min.mjs": "sha384-ap+3gVLf2zKNPDgVPR/u4X4Xyq/u8mUUwRUun39N+UjuXZ/FZS+Yz5nnME19JM2k"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.621.0/LICENSE
```

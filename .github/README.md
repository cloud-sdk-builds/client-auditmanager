...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.983.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.983.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-v5hI6hKNZjq0eWNS3MCP6tPAmUC1ez4ijk1pypkAI/WfS5TVhYpHeCUDCxt9oc9o
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.983.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.983.0/index.min.mjs": "sha384-v5hI6hKNZjq0eWNS3MCP6tPAmUC1ez4ijk1pypkAI/WfS5TVhYpHeCUDCxt9oc9o"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.983.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.462.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.462.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DfRhu3zMUMMqWpvVRLFVunP2LrQxvxgZ4iRhzGyj5tV1GkmYYRkdqe6FezaFWzs3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.462.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.462.0/index.min.mjs": "sha384-DfRhu3zMUMMqWpvVRLFVunP2LrQxvxgZ4iRhzGyj5tV1GkmYYRkdqe6FezaFWzs3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.462.0/LICENSE
```

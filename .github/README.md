...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.45.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.45.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QvU7wHvHYIz8U642FjTSaw7o5ZTF7IYev/bv8x3E0eKPpC6B1uFUWxTMsiKXStBV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.45.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.45.0/index.min.mjs": "sha384-QvU7wHvHYIz8U642FjTSaw7o5ZTF7IYev/bv8x3E0eKPpC6B1uFUWxTMsiKXStBV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.45.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.893.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.893.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-S2PCOsc/mFt4qq7UOPP37wZBzgJ39sFtdBp3gAcX8jqcrw55+AWGmOCQ6EpcsNtq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.893.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.893.0/index.min.mjs": "sha384-S2PCOsc/mFt4qq7UOPP37wZBzgJ39sFtdBp3gAcX8jqcrw55+AWGmOCQ6EpcsNtq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.893.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.929.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.929.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6U0WzURAfyMwDR6tuNLorDcJg7/Vr/qR8S/izvZNO8khOjS3Rg/3YbdeAf5sqJ5T
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.929.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.929.0/index.min.mjs": "sha384-6U0WzURAfyMwDR6tuNLorDcJg7/Vr/qR8S/izvZNO8khOjS3Rg/3YbdeAf5sqJ5T"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.929.0/LICENSE
```

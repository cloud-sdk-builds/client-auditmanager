...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.515.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.515.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aM9F9+xhgl7uan76FUbFdgCs7DZ0/RbT3D+xiovmVv+rr2k0b+3+I3JZ2e3/+X3X
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.515.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.515.0/index.min.mjs": "sha384-aM9F9+xhgl7uan76FUbFdgCs7DZ0/RbT3D+xiovmVv+rr2k0b+3+I3JZ2e3/+X3X"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.515.0/LICENSE
```

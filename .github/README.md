...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.78.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.78.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xkHRyhFu8eId6mcwBnxURAF8ZCOOL7FoWzUsijxCRYVs9rwo3Syu6bdmJosBGSGz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.78.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.78.0/index.min.mjs": "sha384-xkHRyhFu8eId6mcwBnxURAF8ZCOOL7FoWzUsijxCRYVs9rwo3Syu6bdmJosBGSGz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.78.0/LICENSE
```

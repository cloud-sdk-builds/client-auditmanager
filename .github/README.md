...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.200.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.200.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4agYiHtZC0NO+ifaXsUhdRs+txcLtKih5+mMPPP+JBSh6UkZ6GlOQ+1A4efwAGJw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.200.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.200.0/index.min.mjs": "sha384-4agYiHtZC0NO+ifaXsUhdRs+txcLtKih5+mMPPP+JBSh6UkZ6GlOQ+1A4efwAGJw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.200.0/LICENSE
```

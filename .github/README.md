...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.138.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.138.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-f6lJMkmZ1bEygvdCGBnXQ4Mogosyhs+bLEWj+OT3+y6SVF2D/elMN4aby0PB9qia
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.138.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.138.0/index.min.mjs": "sha384-f6lJMkmZ1bEygvdCGBnXQ4Mogosyhs+bLEWj+OT3+y6SVF2D/elMN4aby0PB9qia"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.138.0/LICENSE
```

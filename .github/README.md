...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.796.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.796.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PP6sDwfGXXrPGOEoucTKasPv7OHNABD27iiPExd91kSr69C/vv34ogHnXyYv+jHe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.796.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.796.0/index.min.mjs": "sha384-PP6sDwfGXXrPGOEoucTKasPv7OHNABD27iiPExd91kSr69C/vv34ogHnXyYv+jHe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.796.0/LICENSE
```

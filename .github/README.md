...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.969.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.969.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vydA5aq0Hseqxz1QgdereugB6kZjkKgB0DXd2TyvxqXIBiD2GgMPFkrtBKKRQ/c/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.969.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.969.0/index.min.mjs": "sha384-vydA5aq0Hseqxz1QgdereugB6kZjkKgB0DXd2TyvxqXIBiD2GgMPFkrtBKKRQ/c/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.969.0/LICENSE
```

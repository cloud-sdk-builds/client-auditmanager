...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.271.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.271.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rOmQq96XJyjs6AJO78frX1RKj9eYKxDAw/XN5StOv8tqZI2cWWeRaSQyXHhQIgjt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.271.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.271.0/index.min.mjs": "sha384-rOmQq96XJyjs6AJO78frX1RKj9eYKxDAw/XN5StOv8tqZI2cWWeRaSQyXHhQIgjt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.271.0/LICENSE
```

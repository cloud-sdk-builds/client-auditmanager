...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.435.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.435.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tHipvUElYF960O7iaKS1j1V5X50R5PaffM0kgXcYS9a6lBLC0TXyZ4BalB6EL9+R
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.435.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.435.0/index.min.mjs": "sha384-tHipvUElYF960O7iaKS1j1V5X50R5PaffM0kgXcYS9a6lBLC0TXyZ4BalB6EL9+R"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.435.0/LICENSE
```

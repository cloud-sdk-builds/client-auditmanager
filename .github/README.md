...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.876.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.876.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/qPG3sV/rMT76lJn4WQ94XtcJf54FunNAMHmOEMqe3WdGahg5mQHGkkIR4bi96hG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.876.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.876.0/index.min.mjs": "sha384-/qPG3sV/rMT76lJn4WQ94XtcJf54FunNAMHmOEMqe3WdGahg5mQHGkkIR4bi96hG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.876.0/LICENSE
```

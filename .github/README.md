...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.567.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.567.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bLFgLlarepfJ7vb7Cg7rIJfRuN9ShMrLGfmq4OB0XkNbXD8lsCARb0XIZM2gmhco
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.567.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.567.0/index.min.mjs": "sha384-bLFgLlarepfJ7vb7Cg7rIJfRuN9ShMrLGfmq4OB0XkNbXD8lsCARb0XIZM2gmhco"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.567.0/LICENSE
```

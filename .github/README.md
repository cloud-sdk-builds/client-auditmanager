...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.563.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.563.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UGy46zTeDB5QGLfXg5fQv7V1J1ZkdnSXOY+HIiXRcJ1eADMRhPdkXWOg5WKjVatS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.563.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.563.0/index.min.mjs": "sha384-UGy46zTeDB5QGLfXg5fQv7V1J1ZkdnSXOY+HIiXRcJ1eADMRhPdkXWOg5WKjVatS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.563.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.32.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.32.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LmnAt75dTC1h+3jGwcvdy38T7c9zDD+44CfodU7wwYCSYmjltV7FUXJV4hIq1NcQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.32.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.32.0/index.min.mjs": "sha384-LmnAt75dTC1h+3jGwcvdy38T7c9zDD+44CfodU7wwYCSYmjltV7FUXJV4hIq1NcQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.32.0/LICENSE
```

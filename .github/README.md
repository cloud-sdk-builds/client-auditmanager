...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.398.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.398.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/PSG5fxO7qnG78pepxHOHy3Dc6fTqLfi4YU1mA/vaopf0+dX+hxPLXvKKrs/j26+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.398.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.398.0/index.min.mjs": "sha384-/PSG5fxO7qnG78pepxHOHy3Dc6fTqLfi4YU1mA/vaopf0+dX+hxPLXvKKrs/j26+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.398.0/LICENSE
```

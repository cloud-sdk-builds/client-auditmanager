...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.529.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.529.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-jz0fIAZmyFo1uIsr08lb+tG0SGFyo/db31KgQIp6n0chTJbnZex0g92miBxltQo5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.529.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.529.1/index.min.mjs": "sha384-jz0fIAZmyFo1uIsr08lb+tG0SGFyo/db31KgQIp6n0chTJbnZex0g92miBxltQo5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.529.1/LICENSE
```

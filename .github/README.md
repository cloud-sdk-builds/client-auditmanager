...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.216.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.216.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fr01M0BUpz1lOOl4kdeBXamBDCx6JLHy3z5gzN4Bkef+/sTnwpPixGUuXTEXYh7s
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.216.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.216.0/index.min.mjs": "sha384-fr01M0BUpz1lOOl4kdeBXamBDCx6JLHy3z5gzN4Bkef+/sTnwpPixGUuXTEXYh7s"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.216.0/LICENSE
```

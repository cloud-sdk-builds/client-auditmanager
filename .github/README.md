...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.67.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.67.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YL0GscyFSrzhY7HrAXa9bIzH0Ila825Kw6y7Sd/55cdyxhlz0nPcFoD+5LK43NJt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.67.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.67.0/index.min.mjs": "sha384-YL0GscyFSrzhY7HrAXa9bIzH0Ila825Kw6y7Sd/55cdyxhlz0nPcFoD+5LK43NJt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.67.0/LICENSE
```

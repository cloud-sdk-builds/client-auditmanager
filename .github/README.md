...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.418.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.418.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-keLdp7xnrh8xBR1VCvqBtHk0l66pJ7YvIDg9n7yZ+ICOOqn6euMeFp/4EtlO5Iuf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.418.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.418.0/index.min.mjs": "sha384-keLdp7xnrh8xBR1VCvqBtHk0l66pJ7YvIDg9n7yZ+ICOOqn6euMeFp/4EtlO5Iuf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.418.0/LICENSE
```

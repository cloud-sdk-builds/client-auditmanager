...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.1033.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1033.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ks+yyqtxe7IRfY8FWS7sYiMFCy4CxcAygf44OWRXAJ4C76Dv3zJ/GtmhQaR0+LRl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1033.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1033.0/index.min.mjs": "sha384-ks+yyqtxe7IRfY8FWS7sYiMFCy4CxcAygf44OWRXAJ4C76Dv3zJ/GtmhQaR0+LRl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.1033.0/LICENSE
```

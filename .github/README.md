...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.952.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.952.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xeMwPKWO4oGKzFhz+GRRmAo5n7rqItVTvUvuLkLJH9GDYaM3rxasrBuZzUiXKyaB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.952.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.952.0/index.min.mjs": "sha384-xeMwPKWO4oGKzFhz+GRRmAo5n7rqItVTvUvuLkLJH9GDYaM3rxasrBuZzUiXKyaB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.952.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.658.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.658.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-ePBhJRsbyCu30JDIw2GpE05wOqRHIEIes91FSDRqHm1VqE4IFSjAfIihNlLrrX5t
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.658.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.658.1/index.min.mjs": "sha384-ePBhJRsbyCu30JDIw2GpE05wOqRHIEIes91FSDRqHm1VqE4IFSjAfIihNlLrrX5t"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.658.1/LICENSE
```

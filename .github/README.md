...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.958.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.958.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-90d8daNBFm2PH0kwKcCle5QK3mc7SwyQv5xlzNnRncFU6+nwJNFH/764FXhWLJYt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.958.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.958.0/index.min.mjs": "sha384-90d8daNBFm2PH0kwKcCle5QK3mc7SwyQv5xlzNnRncFU6+nwJNFH/764FXhWLJYt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.958.0/LICENSE
```

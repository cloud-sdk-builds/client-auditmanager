...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.928.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.928.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zNYZKDU9DGcJM0PLm//M0+uOiYXA42vkFtlUHAiSeY/PCbxYZaNXCT7tSB9BJbMR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.928.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.928.0/index.min.mjs": "sha384-zNYZKDU9DGcJM0PLm//M0+uOiYXA42vkFtlUHAiSeY/PCbxYZaNXCT7tSB9BJbMR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.928.0/LICENSE
```

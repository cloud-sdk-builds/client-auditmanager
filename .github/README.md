...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.50.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.50.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-u/FY/wDj9aZR9xxS3u/LqtUW76RB3Qy9ICmxI4LqIyGrvfh9ifGlmxXPXUegBbwL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.50.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.50.0/index.min.mjs": "sha384-u/FY/wDj9aZR9xxS3u/LqtUW76RB3Qy9ICmxI4LqIyGrvfh9ifGlmxXPXUegBbwL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.50.0/LICENSE
```

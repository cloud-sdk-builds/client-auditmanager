...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.849.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.849.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9IopPhJcxnhh0TS7vjFVVe44ZJTZSbggYIOP6ufSB7OWIsgsLOxbp/1/QmcxpZif
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.849.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.849.0/index.min.mjs": "sha384-9IopPhJcxnhh0TS7vjFVVe44ZJTZSbggYIOP6ufSB7OWIsgsLOxbp/1/QmcxpZif"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.849.0/LICENSE
```

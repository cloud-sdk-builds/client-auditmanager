...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.162.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.162.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wBGgCPzFpPdEoAXguUGO5FwbfnJM1tNycCmOBuTiIO/0w/ZzGtx3qEdRTtJqDr4+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.162.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.162.0/index.min.mjs": "sha384-wBGgCPzFpPdEoAXguUGO5FwbfnJM1tNycCmOBuTiIO/0w/ZzGtx3qEdRTtJqDr4+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.162.0/LICENSE
```

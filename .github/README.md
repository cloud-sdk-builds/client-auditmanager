...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.262.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.262.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VjN0JTt3B8WkfkvnCWFeXscPHQT4dq/OD23Pxo9wsdtqa3cNj22wGLm8YKD4bbXz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.262.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.262.0/index.min.mjs": "sha384-VjN0JTt3B8WkfkvnCWFeXscPHQT4dq/OD23Pxo9wsdtqa3cNj22wGLm8YKD4bbXz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.262.0/LICENSE
```

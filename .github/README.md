...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.171.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.171.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+3+Q27GPu6LLSG5dtmq2xNkxzbzS/gDBfutUTqzhQxGqkpwgk6iFxsTMh/3iCqze
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.171.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.171.0/index.min.mjs": "sha384-+3+Q27GPu6LLSG5dtmq2xNkxzbzS/gDBfutUTqzhQxGqkpwgk6iFxsTMh/3iCqze"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.171.0/LICENSE
```

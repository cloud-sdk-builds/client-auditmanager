...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.496.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.496.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tGVRSUJgvjLiQWmBNjm5HTPpO5UxHgzqsecZH9nMr3eJkujt6VqH7vsARgQ6EKRx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.496.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.496.0/index.min.mjs": "sha384-tGVRSUJgvjLiQWmBNjm5HTPpO5UxHgzqsecZH9nMr3eJkujt6VqH7vsARgQ6EKRx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.496.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.335.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.335.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZzKbtIU2QxKjExXBTRN2O+jzy5Ul5V+HQhTvnKfu00IXd6S94SHCm1CKuQiOGqEA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.335.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.335.0/index.min.mjs": "sha384-ZzKbtIU2QxKjExXBTRN2O+jzy5Ul5V+HQhTvnKfu00IXd6S94SHCm1CKuQiOGqEA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.335.0/LICENSE
```

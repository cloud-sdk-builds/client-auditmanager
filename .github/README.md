...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.812.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.812.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IrdL3ezSOJektVD7qAHB/aTeX/6EaZuYwLL/+AEIxCwJb/BPcvvCQWrMypb9Jq2F
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.812.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.812.0/index.min.mjs": "sha384-IrdL3ezSOJektVD7qAHB/aTeX/6EaZuYwLL/+AEIxCwJb/BPcvvCQWrMypb9Jq2F"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.812.0/LICENSE
```

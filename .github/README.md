...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.198.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.198.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-b2UmoSD+RagH1MfpSAk/q4kAFI/3ZyWO8wAVLWRQcAdSWQuWMSq0iorCrEndfQJv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.198.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.198.0/index.min.mjs": "sha384-b2UmoSD+RagH1MfpSAk/q4kAFI/3ZyWO8wAVLWRQcAdSWQuWMSq0iorCrEndfQJv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.198.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.194.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.194.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hcAIFThg5oRVgWPSU/H54FbNaIwAmaGX+kxqcW8ntzMmpFn4tfA6p7jzVM0YJgEX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.194.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.194.0/index.min.mjs": "sha384-hcAIFThg5oRVgWPSU/H54FbNaIwAmaGX+kxqcW8ntzMmpFn4tfA6p7jzVM0YJgEX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.194.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.47.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.47.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WQa/SpgcvqNXIBX+Fcisqzn9FB/XSv99rOhXUrBqAmx5ffg23JhPPgeI8XbZUwYm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.47.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.47.0/index.min.mjs": "sha384-WQa/SpgcvqNXIBX+Fcisqzn9FB/XSv99rOhXUrBqAmx5ffg23JhPPgeI8XbZUwYm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.47.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.160.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.160.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Lo9hP8KSEAL90HpMA+AZy3lvqqnBl4at7C3bGmnSQflRD4RpT4z1nSZ4utwHxSZx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.160.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.160.0/index.min.mjs": "sha384-Lo9hP8KSEAL90HpMA+AZy3lvqqnBl4at7C3bGmnSQflRD4RpT4z1nSZ4utwHxSZx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.160.0/LICENSE
```

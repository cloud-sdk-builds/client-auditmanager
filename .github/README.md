...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.975.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.975.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sikXp3bmi3jed691tONkkT/9ZrK7nIVt+04HG8v37fSa2A6qJ9td9nENi0Uc88w9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.975.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.975.0/index.min.mjs": "sha384-sikXp3bmi3jed691tONkkT/9ZrK7nIVt+04HG8v37fSa2A6qJ9td9nENi0Uc88w9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.975.0/LICENSE
```

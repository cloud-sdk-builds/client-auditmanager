...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.234.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.234.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0VR63q92StuSNFVxKkGoQakFxvJlkHKRsGuzB6QeV9St5Ss+JmMaCC1F7fr8sAEe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.234.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.234.0/index.min.mjs": "sha384-0VR63q92StuSNFVxKkGoQakFxvJlkHKRsGuzB6QeV9St5Ss+JmMaCC1F7fr8sAEe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.234.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.588.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.588.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Jwqw7wg2oXfFZMaSYJkd3+NOEtjJ8i+KZZzDX2fPJR5HdtCEd2ssBaVh4nXp0HSq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.588.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.588.0/index.min.mjs": "sha384-Jwqw7wg2oXfFZMaSYJkd3+NOEtjJ8i+KZZzDX2fPJR5HdtCEd2ssBaVh4nXp0HSq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.588.0/LICENSE
```

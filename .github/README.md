...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.574.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.574.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-G3+DRZhvtBZ/I5pnbKMlLrIBPH3gerlF6H0S6y6vWtyeD5Qo2d69RDRD0mVFr0c1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.574.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.574.0/index.min.mjs": "sha384-G3+DRZhvtBZ/I5pnbKMlLrIBPH3gerlF6H0S6y6vWtyeD5Qo2d69RDRD0mVFr0c1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.574.0/LICENSE
```

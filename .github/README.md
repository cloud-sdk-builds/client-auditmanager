...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.179.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.179.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IMx4V1X+BBz9pWniM8ewzAA3IalWQQz6Lhv34N2b24mh44dSRjgfaRpD3Lw/8WGI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.179.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.179.0/index.min.mjs": "sha384-IMx4V1X+BBz9pWniM8ewzAA3IalWQQz6Lhv34N2b24mh44dSRjgfaRpD3Lw/8WGI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.179.0/LICENSE
```

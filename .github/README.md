...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.299.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.299.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/23Nxujnm6MLURKILIRO+PIQQ5mRbQCgaUIVTcym9lbPtmrbWcE6aiuNQtEGeZNL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.299.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.299.0/index.min.mjs": "sha384-/23Nxujnm6MLURKILIRO+PIQQ5mRbQCgaUIVTcym9lbPtmrbWcE6aiuNQtEGeZNL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.299.0/LICENSE
```

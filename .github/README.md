...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.33.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.33.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jWnWi8pgK0y00h9uo3x6WtTueQx+gCjs8RGXqdDLcn6KmonXgav+OIeCQo2VcgXK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.33.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.33.0/index.min.mjs": "sha384-jWnWi8pgK0y00h9uo3x6WtTueQx+gCjs8RGXqdDLcn6KmonXgav+OIeCQo2VcgXK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.33.0/LICENSE
```

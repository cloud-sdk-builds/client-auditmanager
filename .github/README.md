...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.693.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.693.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UW469Liq5RD1mwdFIGeCWY3OdyCgK9/hPkXItNkmH7pjT6IuPFbJ01LRViapE+ug
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.693.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.693.0/index.min.mjs": "sha384-UW469Liq5RD1mwdFIGeCWY3OdyCgK9/hPkXItNkmH7pjT6IuPFbJ01LRViapE+ug"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.693.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.749.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.749.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FezCBNWMhWz5lhBEIuo8NaCRrvq3uXufFtuIVqM+Y4j2G/44wjm0+40nJvkFZNlf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.749.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.749.0/index.min.mjs": "sha384-FezCBNWMhWz5lhBEIuo8NaCRrvq3uXufFtuIVqM+Y4j2G/44wjm0+40nJvkFZNlf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.749.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.154.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.154.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lzJH1ab3sY2vzzwX6KNpSSx8fF5ZIbGeluYUU9qIiPrzKVl75A3YrTQZcqp7+QNH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.154.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.154.0/index.min.mjs": "sha384-lzJH1ab3sY2vzzwX6KNpSSx8fF5ZIbGeluYUU9qIiPrzKVl75A3YrTQZcqp7+QNH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.154.0/LICENSE
```

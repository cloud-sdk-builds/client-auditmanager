...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.476.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.476.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-n6UFJGS5eDbHkriBiG+uuzhAR2VZ9U7tY8VHAhR+d82q/QeCdNrv4tYJFyzu8oXa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.476.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.476.0/index.min.mjs": "sha384-n6UFJGS5eDbHkriBiG+uuzhAR2VZ9U7tY8VHAhR+d82q/QeCdNrv4tYJFyzu8oXa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.476.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.1038.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1038.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HU1YFjoLI4SciPT8Sp+goYUoSQ+holPNoxYQA82GO6rF5eLn+7NIYG5AOwSpHbdU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1038.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1038.0/index.min.mjs": "sha384-HU1YFjoLI4SciPT8Sp+goYUoSQ+holPNoxYQA82GO6rF5eLn+7NIYG5AOwSpHbdU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.1038.0/LICENSE
```

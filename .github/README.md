...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.1005.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1005.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-K/LyHZ9kvQ84qNjvNtGBc0Dawtip2BODcLLvNE14EPN7hEj1abCGBZMgG+KLi4lg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1005.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1005.0/index.min.mjs": "sha384-K/LyHZ9kvQ84qNjvNtGBc0Dawtip2BODcLLvNE14EPN7hEj1abCGBZMgG+KLi4lg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.1005.0/LICENSE
```

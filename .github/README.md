...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.564.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.564.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8mGh8gn4DExsEU8VXr0aJNYcAOzFgjBW5/kUCdoSrU8re7+FVrQfP23r/SYwXMGZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.564.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.564.0/index.min.mjs": "sha384-8mGh8gn4DExsEU8VXr0aJNYcAOzFgjBW5/kUCdoSrU8re7+FVrQfP23r/SYwXMGZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.564.0/LICENSE
```

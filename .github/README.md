...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.310.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.310.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uAkChMUVRppxMmggGHQRau8AxO6d7cziMVTa0nDc0XRmzogE7WK0xwi/zh6mfDLW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.310.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.310.0/index.min.mjs": "sha384-uAkChMUVRppxMmggGHQRau8AxO6d7cziMVTa0nDc0XRmzogE7WK0xwi/zh6mfDLW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.310.0/LICENSE
```

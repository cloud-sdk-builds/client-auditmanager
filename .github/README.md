...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.687.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.687.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dWIircaKfU7lXeVdNvqgwqeStVDvfwuAgj42DVjuUa3ukyKAkfS63yegE7Fn8R6G
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.687.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.687.0/index.min.mjs": "sha384-dWIircaKfU7lXeVdNvqgwqeStVDvfwuAgj42DVjuUa3ukyKAkfS63yegE7Fn8R6G"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.687.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.309.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.309.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6480Tlcnp2VPZYLxHNLnsHjpV+MRI/Ab5nZxwYsqOeZFZFI1iurZxQ4Cfrb7Y2Dm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.309.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.309.0/index.min.mjs": "sha384-6480Tlcnp2VPZYLxHNLnsHjpV+MRI/Ab5nZxwYsqOeZFZFI1iurZxQ4Cfrb7Y2Dm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.309.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.105.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.105.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9/Dy0jcykaLJyY3xh33Q/8X9MHeeFjomksdI86fUr9cPVxTDgfYTlpsAsBezYxxi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.105.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.105.0/index.min.mjs": "sha384-9/Dy0jcykaLJyY3xh33Q/8X9MHeeFjomksdI86fUr9cPVxTDgfYTlpsAsBezYxxi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.105.0/LICENSE
```

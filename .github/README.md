...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.504.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.504.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BMlT5335hvUy0iKbkQtUA0azlXp6IA1wJkEdhVW1mrUlmnpY/ELwYEtGlt/quzrO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.504.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.504.0/index.min.mjs": "sha384-BMlT5335hvUy0iKbkQtUA0azlXp6IA1wJkEdhVW1mrUlmnpY/ELwYEtGlt/quzrO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.504.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.692.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.692.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wtl5gh4+pO/Z7ffhVfe6DLYN5AQwEm0HsGA62YXsPtcVQGxhwQKqBYP0QyP3/7YS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.692.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.692.0/index.min.mjs": "sha384-wtl5gh4+pO/Z7ffhVfe6DLYN5AQwEm0HsGA62YXsPtcVQGxhwQKqBYP0QyP3/7YS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.692.0/LICENSE
```

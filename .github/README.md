...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.894.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.894.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-iQxdAPa/kk6ZMi9E/UQLT0egMjp5pqCHraaJXWFfpztIm56fvmosCXPAl4dhODp8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.894.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.894.0/index.min.mjs": "sha384-iQxdAPa/kk6ZMi9E/UQLT0egMjp5pqCHraaJXWFfpztIm56fvmosCXPAl4dhODp8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.894.0/LICENSE
```

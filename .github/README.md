...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.598.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.598.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kGMzDBHSfMfT3/wpzy0TUjXnwdAAjVPyL2NTCKgcwub2zX6CQYuIv9K0S3Xa/fU2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.598.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.598.0/index.min.mjs": "sha384-kGMzDBHSfMfT3/wpzy0TUjXnwdAAjVPyL2NTCKgcwub2zX6CQYuIv9K0S3Xa/fU2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.598.0/LICENSE
```

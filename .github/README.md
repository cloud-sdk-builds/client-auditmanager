...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.266.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.266.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-Cm+Rv0iLjpvZrfvNH3K6B+8Y27O3/JTQ1kfxR9T8QtYwQlrOHnl9qJLLX2nfGeL8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.266.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.266.1/index.min.mjs": "sha384-Cm+Rv0iLjpvZrfvNH3K6B+8Y27O3/JTQ1kfxR9T8QtYwQlrOHnl9qJLLX2nfGeL8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.266.1/LICENSE
```

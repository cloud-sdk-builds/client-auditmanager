...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.150.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.150.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2yOjS/R5/CSi9WoyL3DCHVcOGoUgsd5OF6ZF4938uPxMWUShTacoQ464suyD8naW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.150.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.150.0/index.min.mjs": "sha384-2yOjS/R5/CSi9WoyL3DCHVcOGoUgsd5OF6ZF4938uPxMWUShTacoQ464suyD8naW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.150.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.856.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.856.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wDOEcBG1fiamF6ce566sFORG9scf2Iyga43ksSFUXaxfu0PsfxdhUnPcEl/QagRe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.856.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.856.0/index.min.mjs": "sha384-wDOEcBG1fiamF6ce566sFORG9scf2Iyga43ksSFUXaxfu0PsfxdhUnPcEl/QagRe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.856.0/LICENSE
```

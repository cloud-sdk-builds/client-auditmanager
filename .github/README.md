...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.996.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.996.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qmhPT8nKgvOuTXP5/pp4h4MRk5PcDQ3k9lPMPDltBMLdt/G38cnS/jUiEpR1KNZv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.996.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.996.0/index.min.mjs": "sha384-qmhPT8nKgvOuTXP5/pp4h4MRk5PcDQ3k9lPMPDltBMLdt/G38cnS/jUiEpR1KNZv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.996.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.890.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.890.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gVTQDl3LIcKVQ59bq3ZwZ116JsdOraPfdjSVyGw95Qk789jAzf91/X6JB/3nmmhO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.890.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.890.0/index.min.mjs": "sha384-gVTQDl3LIcKVQ59bq3ZwZ116JsdOraPfdjSVyGw95Qk789jAzf91/X6JB/3nmmhO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.890.0/LICENSE
```

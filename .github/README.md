...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.163.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.163.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+0pvcustoA3DGixDAJ5QaCsakTvPEdt0VDPXKhk8jxFvEynXhNWLonJ6Okp3jbV5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.163.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.163.0/index.min.mjs": "sha384-+0pvcustoA3DGixDAJ5QaCsakTvPEdt0VDPXKhk8jxFvEynXhNWLonJ6Okp3jbV5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.163.0/LICENSE
```

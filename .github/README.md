...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.252.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.252.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1DCwNVs9HoHE0H78tpDLJpNR3G/DA0hAigCrGPjVyay/FaKi3s6RSwajgVAHQojD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.252.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.252.0/index.min.mjs": "sha384-1DCwNVs9HoHE0H78tpDLJpNR3G/DA0hAigCrGPjVyay/FaKi3s6RSwajgVAHQojD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.252.0/LICENSE
```

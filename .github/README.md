...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.726.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.726.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-CJ4HDTKM+5YfgMrCh5hW6D0oXi9QE4oTPseW1VSMtEvUvBnzv4vMbd6eJ1Jos5gY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.726.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.726.1/index.min.mjs": "sha384-CJ4HDTKM+5YfgMrCh5hW6D0oXi9QE4oTPseW1VSMtEvUvBnzv4vMbd6eJ1Jos5gY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.726.1/LICENSE
```

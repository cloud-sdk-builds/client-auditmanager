...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.295.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.295.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hqL9HKzsRUOIsvvHbRC8yLuPLLE3byLwqPe7ssHmTP0m+cxTk0er1XNprk+hE5oJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.295.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.295.0/index.min.mjs": "sha384-hqL9HKzsRUOIsvvHbRC8yLuPLLE3byLwqPe7ssHmTP0m+cxTk0er1XNprk+hE5oJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.295.0/LICENSE
```

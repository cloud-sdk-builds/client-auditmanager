...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.468.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.468.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lmCO6LNQvJaaNf52/alP6gEkryXgx7Sri+Veehq3guR8Nh86PHSuP7ojCaG9Jik6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.468.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.468.0/index.min.mjs": "sha384-lmCO6LNQvJaaNf52/alP6gEkryXgx7Sri+Veehq3guR8Nh86PHSuP7ojCaG9Jik6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.468.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.590.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.590.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rTtKQ3E34q6PLeyz+TnBhhHzrNXHT6d00tNIsbRgM1U9r5dNTcIw2CQg8pMkYoRp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.590.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.590.0/index.min.mjs": "sha384-rTtKQ3E34q6PLeyz+TnBhhHzrNXHT6d00tNIsbRgM1U9r5dNTcIw2CQg8pMkYoRp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.590.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.9.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.9.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jT4zt5uQ6l8PF92XR5YJCBpoAv0uNACEp4LgJdl2Zg7LCr1bYUbhldur3N8uNIzs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.9.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.9.0/index.min.mjs": "sha384-jT4zt5uQ6l8PF92XR5YJCBpoAv0uNACEp4LgJdl2Zg7LCr1bYUbhldur3N8uNIzs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.9.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.1010.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1010.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LUN4oYSrcspH6Sjwy+of7ETY50IB65cYo3BbDnrN6VGwJBBaKwqqLn+haO8LVKkq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1010.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1010.0/index.min.mjs": "sha384-LUN4oYSrcspH6Sjwy+of7ETY50IB65cYo3BbDnrN6VGwJBBaKwqqLn+haO8LVKkq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.1010.0/LICENSE
```

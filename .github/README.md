...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.15.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.15.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ALYwf4j7WCcNnkTHpyzofz7a1pLSHav1Eh1R5m3r1kPC1VUHvy3Lhsi03dEODY1Q
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.15.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.15.0/index.min.mjs": "sha384-ALYwf4j7WCcNnkTHpyzofz7a1pLSHav1Eh1R5m3r1kPC1VUHvy3Lhsi03dEODY1Q"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.15.0/LICENSE
```

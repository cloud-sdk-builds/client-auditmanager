...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.490.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.490.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cWd9bf7nRPzHlnbooXDWh5pyeYyU15B0Ukb3MbOtXyOAgHT2dWnpMYTBx7qwRehQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.490.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.490.0/index.min.mjs": "sha384-cWd9bf7nRPzHlnbooXDWh5pyeYyU15B0Ukb3MbOtXyOAgHT2dWnpMYTBx7qwRehQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.490.0/LICENSE
```

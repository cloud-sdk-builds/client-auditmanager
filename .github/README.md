...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.61.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.61.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Hk2eyn2/b2wvt2oBLnRme9ZbYpGwfLduqfryjhonvjA2o41biIFfiB8P4UdaYvgn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.61.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.61.0/index.min.mjs": "sha384-Hk2eyn2/b2wvt2oBLnRme9ZbYpGwfLduqfryjhonvjA2o41biIFfiB8P4UdaYvgn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.61.0/LICENSE
```

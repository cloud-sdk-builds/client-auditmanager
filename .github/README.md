...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.744.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.744.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WrWTBkY5/PrsNS5APb1xNFcneya+o6BrIxOAaWsoEihIjeswsg00iZIaedAbLLnJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.744.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.744.0/index.min.mjs": "sha384-WrWTBkY5/PrsNS5APb1xNFcneya+o6BrIxOAaWsoEihIjeswsg00iZIaedAbLLnJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.744.0/LICENSE
```

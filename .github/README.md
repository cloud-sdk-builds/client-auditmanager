...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.180.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.180.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lztc85PbDxaEiOtWEkl8ujSmznRksLvPEG7G0azj2a0Df6XEjnCUk/oWdtPZiXI3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.180.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.180.0/index.min.mjs": "sha384-lztc85PbDxaEiOtWEkl8ujSmznRksLvPEG7G0azj2a0Df6XEjnCUk/oWdtPZiXI3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.180.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.210.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.210.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-D7puaBKSFdB8ZkLZtsMyLw8t4lgpJxBzHq/Q+17sXNDjoG4VeMXW8EQIk9wJTFsM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.210.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.210.0/index.min.mjs": "sha384-D7puaBKSFdB8ZkLZtsMyLw8t4lgpJxBzHq/Q+17sXNDjoG4VeMXW8EQIk9wJTFsM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.210.0/LICENSE
```

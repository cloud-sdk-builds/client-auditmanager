...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.27.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.27.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WpyKtRK2l8AnUD7WUIjxOxkthpcQwD71BWytZLVpUWRGUNDxEyOasWz8X7raeD8y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.27.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.27.0/index.min.mjs": "sha384-WpyKtRK2l8AnUD7WUIjxOxkthpcQwD71BWytZLVpUWRGUNDxEyOasWz8X7raeD8y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.27.0/LICENSE
```

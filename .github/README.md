...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.992.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.992.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7BYnmuX9hcyi2edegyX1mBKpAUKumDCCOOXKQG19RnUnORA8IaeK8F5TR3UJOKcp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.992.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.992.0/index.min.mjs": "sha384-7BYnmuX9hcyi2edegyX1mBKpAUKumDCCOOXKQG19RnUnORA8IaeK8F5TR3UJOKcp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.992.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.862.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.862.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NMFAUlfihwj+ykNn3ucSZ11yC7qGO2MwldnXMZHjh4dsAY/Fei3m+IeRe1ctOcp/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.862.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.862.0/index.min.mjs": "sha384-NMFAUlfihwj+ykNn3ucSZ11yC7qGO2MwldnXMZHjh4dsAY/Fei3m+IeRe1ctOcp/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.862.0/LICENSE
```

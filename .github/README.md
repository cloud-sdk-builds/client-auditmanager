...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.667.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.667.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uoQ6Q/tIdhtEb/f6k+zqROGI70/sPkR7qGN/IoUccNWYZz+EZeAzB+7WRv2EamOv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.667.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.667.0/index.min.mjs": "sha384-uoQ6Q/tIdhtEb/f6k+zqROGI70/sPkR7qGN/IoUccNWYZz+EZeAzB+7WRv2EamOv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.667.0/LICENSE
```

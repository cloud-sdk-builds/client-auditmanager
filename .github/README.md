...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.953.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.953.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mgp7WdZVbriDaLDUpA4LL7X9EJi9apHluDkzYbR01Lh9P3FBywHko8OVNOIyW+jL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.953.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.953.0/index.min.mjs": "sha384-mgp7WdZVbriDaLDUpA4LL7X9EJi9apHluDkzYbR01Lh9P3FBywHko8OVNOIyW+jL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.953.0/LICENSE
```

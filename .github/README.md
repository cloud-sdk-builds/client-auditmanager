...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.577.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.577.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-no/wlWhBRe2n+vMsx0i/z0bta2X1G/Cr8K6clPKlug+uVPdVnPQY9+riRrrDnApJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.577.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.577.0/index.min.mjs": "sha384-no/wlWhBRe2n+vMsx0i/z0bta2X1G/Cr8K6clPKlug+uVPdVnPQY9+riRrrDnApJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.577.0/LICENSE
```

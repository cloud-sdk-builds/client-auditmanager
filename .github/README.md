...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.332.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.332.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ah+DYeS+8PxWxER/bL9C84+5vdA8/vZfkCOSdBL/GzAphcngJa4X66ynu8Q4nb0c
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.332.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.332.0/index.min.mjs": "sha384-ah+DYeS+8PxWxER/bL9C84+5vdA8/vZfkCOSdBL/GzAphcngJa4X66ynu8Q4nb0c"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.332.0/LICENSE
```

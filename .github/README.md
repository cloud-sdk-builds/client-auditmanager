...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.204.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.204.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sj0+cRyNPRKLXhGCqP4MSCh+e4PyN1AXXBWzwfeaNiR1xrUBTWlRJtq9ABW5DEJ4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.204.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.204.0/index.min.mjs": "sha384-sj0+cRyNPRKLXhGCqP4MSCh+e4PyN1AXXBWzwfeaNiR1xrUBTWlRJtq9ABW5DEJ4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.204.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.315.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.315.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-y5Ml2sZptR4q7DQMCCSYeNXgO/UaYAFb6OjLmDutSgPiCW+tmHDdlxAc5wbzNajU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.315.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.315.0/index.min.mjs": "sha384-y5Ml2sZptR4q7DQMCCSYeNXgO/UaYAFb6OjLmDutSgPiCW+tmHDdlxAc5wbzNajU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.315.0/LICENSE
```

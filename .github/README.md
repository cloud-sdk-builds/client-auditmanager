...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.474.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.474.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3vtCtLDzBQmZEPIBzdNfOcfETmi+ZLf1zU5qr2lTiU1fmuCdvcacW1C1aO86KekR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.474.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.474.0/index.min.mjs": "sha384-3vtCtLDzBQmZEPIBzdNfOcfETmi+ZLf1zU5qr2lTiU1fmuCdvcacW1C1aO86KekR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.474.0/LICENSE
```

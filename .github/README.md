...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.224.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.224.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5AixTZK479Uof/pB/SM0fx2xDPFimnmOS3xlSBwGTDFaLFXEBtn+KKuObU5wqNvP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.224.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.224.0/index.min.mjs": "sha384-5AixTZK479Uof/pB/SM0fx2xDPFimnmOS3xlSBwGTDFaLFXEBtn+KKuObU5wqNvP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.224.0/LICENSE
```

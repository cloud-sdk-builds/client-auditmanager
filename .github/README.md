...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.413.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.413.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LOwVEuEXOkE/tRi1P3i34G5DGXVyTxawMRESIRtLWdJLTAL/HK1iybgnVOrbYmsj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.413.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.413.0/index.min.mjs": "sha384-LOwVEuEXOkE/tRi1P3i34G5DGXVyTxawMRESIRtLWdJLTAL/HK1iybgnVOrbYmsj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.413.0/LICENSE
```

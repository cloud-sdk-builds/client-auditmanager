...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.691.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.691.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QvsByF5tABaTzhY3153YucrYqj2tu7utQX+afWma8f6rV1wloWQUGwhtW+jlS+os
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.691.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.691.0/index.min.mjs": "sha384-QvsByF5tABaTzhY3153YucrYqj2tu7utQX+afWma8f6rV1wloWQUGwhtW+jlS+os"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.691.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.1035.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1035.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EbPl2vDk8ebRCVwilSXO0M7e3a7UPfcR/Q76BCy+vKY+Ts6RAPD/0tMeA/mJTpo7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1035.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1035.0/index.min.mjs": "sha384-EbPl2vDk8ebRCVwilSXO0M7e3a7UPfcR/Q76BCy+vKY+Ts6RAPD/0tMeA/mJTpo7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.1035.0/LICENSE
```

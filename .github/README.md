...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.36.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.36.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-fwPY4uY7yi9Z7CjBBKKqc7zefVOO9Jyzp9ppan7vLg7yIM/QJReHX65MGiErbIr/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.36.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.36.1/index.min.mjs": "sha384-fwPY4uY7yi9Z7CjBBKKqc7zefVOO9Jyzp9ppan7vLg7yIM/QJReHX65MGiErbIr/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.36.1/LICENSE
```

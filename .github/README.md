...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.450.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.450.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZHftCyYPMjGCpVnAbgtK3SHaYBN1C6LSSQ7MvzzZ7lXXOJDFJM3d4vGsAj3lWbN0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.450.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.450.0/index.min.mjs": "sha384-ZHftCyYPMjGCpVnAbgtK3SHaYBN1C6LSSQ7MvzzZ7lXXOJDFJM3d4vGsAj3lWbN0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.450.0/LICENSE
```

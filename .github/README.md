...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.712.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.712.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nsObkchaiRvyzV8CJxVnj0acZnfp9BKITErW/o5XnkfP3NnDmJRJ9K9BSuX6hR6F
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.712.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.712.0/index.min.mjs": "sha384-nsObkchaiRvyzV8CJxVnj0acZnfp9BKITErW/o5XnkfP3NnDmJRJ9K9BSuX6hR6F"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.712.0/LICENSE
```

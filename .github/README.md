...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.568.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.568.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OzvRTaYA6ap4LWxc8PSChKrw86urDtVvZWFo/P+B0uKQ/e9fpP+rGBexI3vUJLeF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.568.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.568.0/index.min.mjs": "sha384-OzvRTaYA6ap4LWxc8PSChKrw86urDtVvZWFo/P+B0uKQ/e9fpP+rGBexI3vUJLeF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.568.0/LICENSE
```

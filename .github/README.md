...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.7.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.7.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Rzj95KUCx4OmtfM3WOX6oMFZfLnXhpEGrGTpbiNC+5wpG/renSsNQUsJNmp8qb7B
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.7.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.7.0/index.min.mjs": "sha384-Rzj95KUCx4OmtfM3WOX6oMFZfLnXhpEGrGTpbiNC+5wpG/renSsNQUsJNmp8qb7B"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.7.0/LICENSE
```

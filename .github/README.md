...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.772.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.772.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fjNXI6ajYQ7PaYuo1HyFHeJ6VXEMS1WXBwlmZAEHtN6VUcuLlcUOU/AddSzrvEpS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.772.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.772.0/index.min.mjs": "sha384-fjNXI6ajYQ7PaYuo1HyFHeJ6VXEMS1WXBwlmZAEHtN6VUcuLlcUOU/AddSzrvEpS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.772.0/LICENSE
```

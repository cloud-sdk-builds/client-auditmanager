...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.188.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.188.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FY6Lfp8GB8LAzhPNGX8jfxpx8OLpJoYzee5p53J4XIah7K28hZnjGuBZvQ8yGud1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.188.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.188.0/index.min.mjs": "sha384-FY6Lfp8GB8LAzhPNGX8jfxpx8OLpJoYzee5p53J4XIah7K28hZnjGuBZvQ8yGud1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.188.0/LICENSE
```

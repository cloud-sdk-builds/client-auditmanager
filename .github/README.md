...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.428.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.428.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xTO91A+R0S4jppumefhgdQqv3IbRsiY/+SxrHCYiIcWZY5KizkAGhkOYk2zDwDbM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.428.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.428.0/index.min.mjs": "sha384-xTO91A+R0S4jppumefhgdQqv3IbRsiY/+SxrHCYiIcWZY5KizkAGhkOYk2zDwDbM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.428.0/LICENSE
```

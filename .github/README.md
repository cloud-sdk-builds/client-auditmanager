...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.8.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.8.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-z7fofPtjhtpjzkSPWBlXWiUpqgUOdVGgyOoome8btGyWtz/CAl5uISGak8oXjD6a
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.8.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.8.1/index.min.mjs": "sha384-z7fofPtjhtpjzkSPWBlXWiUpqgUOdVGgyOoome8btGyWtz/CAl5uISGak8oXjD6a"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.8.1/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.379.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.379.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-WEGTojMAIKKfE4CROvCYk+AwICCwkDBBenIiD9J6j9nc/C/ZfK3UajJ2+mP4Xb+2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.379.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.379.1/index.min.mjs": "sha384-WEGTojMAIKKfE4CROvCYk+AwICCwkDBBenIiD9J6j9nc/C/ZfK3UajJ2+mP4Xb+2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.379.1/LICENSE
```

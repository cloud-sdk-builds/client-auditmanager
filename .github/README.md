...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.51.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.51.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sd67x6QILAzrjdYK9NmBwt58PW2aA1hUvW0Pb+/nsr3DDhEt+wlMmE8vvtgDapnk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.51.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.51.0/index.min.mjs": "sha384-sd67x6QILAzrjdYK9NmBwt58PW2aA1hUvW0Pb+/nsr3DDhEt+wlMmE8vvtgDapnk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.51.0/LICENSE
```

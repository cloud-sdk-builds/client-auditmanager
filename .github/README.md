...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.782.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.782.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-U2RhHk1E/PzfugksGcaV9MJf3OxHLEgRX6Tp0EK94Pbmp9COny7mT11y4mXMv6TB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.782.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.782.0/index.min.mjs": "sha384-U2RhHk1E/PzfugksGcaV9MJf3OxHLEgRX6Tp0EK94Pbmp9COny7mT11y4mXMv6TB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.782.0/LICENSE
```

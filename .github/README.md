...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.222.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.222.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kgcBDyaIn7cIKo5lZIurbcc2T2rdaIkB2QGjXvC2Pn0MH7N1PwEqxdV5XhJseJMM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.222.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.222.0/index.min.mjs": "sha384-kgcBDyaIn7cIKo5lZIurbcc2T2rdaIkB2QGjXvC2Pn0MH7N1PwEqxdV5XhJseJMM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.222.0/LICENSE
```

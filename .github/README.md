...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.716.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.716.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-23PI3a3kJY3C0zEj5AfyJC2+OIuB7keAxAqA/shssTA/7glgbTBnphPB2ZGoQdyY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.716.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.716.0/index.min.mjs": "sha384-23PI3a3kJY3C0zEj5AfyJC2+OIuB7keAxAqA/shssTA/7glgbTBnphPB2ZGoQdyY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.716.0/LICENSE
```

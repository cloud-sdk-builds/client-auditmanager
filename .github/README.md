...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.183.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.183.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZsW6m6UXLI1Ynm4k7+veD8/7p03kTnrxZ5vfQ4We74lVRGAbIv+EzyHveVQkr4pg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.183.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.183.0/index.min.mjs": "sha384-ZsW6m6UXLI1Ynm4k7+veD8/7p03kTnrxZ5vfQ4We74lVRGAbIv+EzyHveVQkr4pg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.183.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.665.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.665.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nsz0lsLHKpR5uvvcIQEoZhL49zPQdT7VFom2VeGpK3iFdIq6Em7HjcMF/iowSz15
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.665.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.665.0/index.min.mjs": "sha384-nsz0lsLHKpR5uvvcIQEoZhL49zPQdT7VFom2VeGpK3iFdIq6Em7HjcMF/iowSz15"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.665.0/LICENSE
```

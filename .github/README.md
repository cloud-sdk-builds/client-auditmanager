...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.926.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.926.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kUMMUCqF23Gyf2rPqTfU5kvjVEbNg1B+ZP5ZaKlfi6RZoTVlo1KQHDpd7Q8F6UYo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.926.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.926.0/index.min.mjs": "sha384-kUMMUCqF23Gyf2rPqTfU5kvjVEbNg1B+ZP5ZaKlfi6RZoTVlo1KQHDpd7Q8F6UYo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.926.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.947.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.947.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LDF5QUDY0+Hk4EYQqXX2AkyU5tgfr8sVg1YCcix3/zdDvSWFbhjmOs9JEEusexkk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.947.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.947.0/index.min.mjs": "sha384-LDF5QUDY0+Hk4EYQqXX2AkyU5tgfr8sVg1YCcix3/zdDvSWFbhjmOs9JEEusexkk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.947.0/LICENSE
```

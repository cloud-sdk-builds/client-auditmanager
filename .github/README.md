...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.82.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.82.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QqsRA2vbF2Ee5pYG0LxP9SSKm/N2Z9XalmA8DsbItTzAVtybfpp5joWC4EGundwX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.82.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.82.0/index.min.mjs": "sha384-QqsRA2vbF2Ee5pYG0LxP9SSKm/N2Z9XalmA8DsbItTzAVtybfpp5joWC4EGundwX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.82.0/LICENSE
```

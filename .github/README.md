...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.957.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.957.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JJ7jPFmEdXHt9kEVgwi/1ApTz5Lx47G1cvr0Jix4wrR11MnR0fhdWKjgsGRu522N
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.957.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.957.0/index.min.mjs": "sha384-JJ7jPFmEdXHt9kEVgwi/1ApTz5Lx47G1cvr0Jix4wrR11MnR0fhdWKjgsGRu522N"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.957.0/LICENSE
```

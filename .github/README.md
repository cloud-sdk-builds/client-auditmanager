...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.85.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.85.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/h3SQwY/PC2x2VyomiWwMJlmS0jVZ2ygjFnuLmBzxKDsnZI0Vx/ZtKgzA//rKuY2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.85.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.85.0/index.min.mjs": "sha384-/h3SQwY/PC2x2VyomiWwMJlmS0jVZ2ygjFnuLmBzxKDsnZI0Vx/ZtKgzA//rKuY2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.85.0/LICENSE
```

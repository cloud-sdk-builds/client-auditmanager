...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.208.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.208.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5wVljKbAFMtdzV6J7zh9j8YE/WDAu4d0DIxpryoljLBBABd16rsUVPmPj5YwwBnM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.208.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.208.0/index.min.mjs": "sha384-5wVljKbAFMtdzV6J7zh9j8YE/WDAu4d0DIxpryoljLBBABd16rsUVPmPj5YwwBnM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.208.0/LICENSE
```

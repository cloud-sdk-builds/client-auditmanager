...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.582.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.582.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vIEoGhJUT11Od8LhyrbOE6PlyaogIysftT9/tFNMEOY8Bfpfievoej3p7hGqxmAq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.582.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.582.0/index.min.mjs": "sha384-vIEoGhJUT11Od8LhyrbOE6PlyaogIysftT9/tFNMEOY8Bfpfievoej3p7hGqxmAq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.582.0/LICENSE
```

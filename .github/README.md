...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.142.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.142.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Kv3UKO7nEc6tcAAU9o9iLVbl0NyX9IKLkV8iTQsPoxR6x6+6HJiPMBHgAvOdUxMk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.142.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.142.0/index.min.mjs": "sha384-Kv3UKO7nEc6tcAAU9o9iLVbl0NyX9IKLkV8iTQsPoxR6x6+6HJiPMBHgAvOdUxMk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.142.0/LICENSE
```

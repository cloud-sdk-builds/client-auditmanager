...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.36.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.36.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-v60rWOP0873nIoU7btWYd0aFFCxYxdLAvGXjS+9sVEfA31fxbMOFAJX60+ij9euZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.36.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.36.0/index.min.mjs": "sha384-v60rWOP0873nIoU7btWYd0aFFCxYxdLAvGXjS+9sVEfA31fxbMOFAJX60+ij9euZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.36.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.714.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.714.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pgFz+N39oxiN5gAGYI0OcmapQdvsTJyECzJuHYNJYmd4GCteTxjG6+85hCp4nMVH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.714.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.714.0/index.min.mjs": "sha384-pgFz+N39oxiN5gAGYI0OcmapQdvsTJyECzJuHYNJYmd4GCteTxjG6+85hCp4nMVH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.714.0/LICENSE
```

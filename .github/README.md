...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.342.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.342.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LnqRlhA6fSY58ASvpYShDdIMIEZfGrNhlX+O48P4b8unP/gNM8AVwqFYl2UekaeG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.342.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.342.0/index.min.mjs": "sha384-LnqRlhA6fSY58ASvpYShDdIMIEZfGrNhlX+O48P4b8unP/gNM8AVwqFYl2UekaeG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.342.0/LICENSE
```

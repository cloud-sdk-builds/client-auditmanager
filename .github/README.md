...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.906.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.906.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-S/Etn1hGCpxgDaOEae8E1GbO4TeraTOrWhiUyUiVoy9uZp7wI9z9LcbTXf++iUAK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.906.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.906.0/index.min.mjs": "sha384-S/Etn1hGCpxgDaOEae8E1GbO4TeraTOrWhiUyUiVoy9uZp7wI9z9LcbTXf++iUAK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.906.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.489.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.489.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OzQi7KySEM5cPLPaDzdq98+CkMQJdCNhvyZsXDAticsl8v9aiXJ6QPyn005SuEDZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.489.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.489.0/index.min.mjs": "sha384-OzQi7KySEM5cPLPaDzdq98+CkMQJdCNhvyZsXDAticsl8v9aiXJ6QPyn005SuEDZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.489.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.214.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.214.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pvEvTuQkre/vaDE0j5BV7OonZD7ETk7pX6DSXipVJwnvTM0ItcyIlsQ2LryvanMj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.214.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.214.0/index.min.mjs": "sha384-pvEvTuQkre/vaDE0j5BV7OonZD7ETk7pX6DSXipVJwnvTM0ItcyIlsQ2LryvanMj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.214.0/LICENSE
```

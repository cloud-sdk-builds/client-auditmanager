...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.258.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.258.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dmfjZ4WbgnRd+mZgk9zlPayZJ8Y8mL5pTqipzBJVTixzBRrl6ZlMd97RnzvN8I55
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.258.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.258.0/index.min.mjs": "sha384-dmfjZ4WbgnRd+mZgk9zlPayZJ8Y8mL5pTqipzBJVTixzBRrl6ZlMd97RnzvN8I55"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.258.0/LICENSE
```

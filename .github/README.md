...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.501.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.501.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0MscVx1O/AO08PyTpf6/He3uDtRbK/vTybEZuBHhO9WMEUNuF64w07HuIqKTo1fU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.501.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.501.0/index.min.mjs": "sha384-0MscVx1O/AO08PyTpf6/He3uDtRbK/vTybEZuBHhO9WMEUNuF64w07HuIqKTo1fU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.501.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.741.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.741.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SvBT7OIMqabt0tepL5RrFnPiFMJ6CWm+j8Vczr8AjjwPXAHJRztFEom0yOfg1P2x
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.741.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.741.0/index.min.mjs": "sha384-SvBT7OIMqabt0tepL5RrFnPiFMJ6CWm+j8Vczr8AjjwPXAHJRztFEom0yOfg1P2x"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.741.0/LICENSE
```

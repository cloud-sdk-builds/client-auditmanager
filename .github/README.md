...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.968.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.968.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UFQztTlK/ZMXblU73bbOjdVZMqyMpR1c7Kb41Hh9ZXlxKRwkVMH60XYhUp59dSPG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.968.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.968.0/index.min.mjs": "sha384-UFQztTlK/ZMXblU73bbOjdVZMqyMpR1c7Kb41Hh9ZXlxKRwkVMH60XYhUp59dSPG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.968.0/LICENSE
```

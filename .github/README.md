...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.650.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.650.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JTPbjRbLGxQ4PGFFWJRY9Q2Urya757na+SyMTp+0sKvNsud58qNGtqg5dDqIGQI1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.650.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.650.0/index.min.mjs": "sha384-JTPbjRbLGxQ4PGFFWJRY9Q2Urya757na+SyMTp+0sKvNsud58qNGtqg5dDqIGQI1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.650.0/LICENSE
```

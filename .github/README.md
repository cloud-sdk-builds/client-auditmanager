...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.312.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.312.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-H8+HWOkGvDfGOs26JhqtRbwWmLTnLMATweVwWyS4G35JB8SvEr9nHCfYiHlNNQk5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.312.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.312.0/index.min.mjs": "sha384-H8+HWOkGvDfGOs26JhqtRbwWmLTnLMATweVwWyS4G35JB8SvEr9nHCfYiHlNNQk5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.312.0/LICENSE
```

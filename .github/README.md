...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.74.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.74.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cdCJZe69JxlG506UX6kLC4imDRJ9bcNqS+AqVidYhHbaOwAB5wcKOyrCNnUuigpI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.74.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.74.0/index.min.mjs": "sha384-cdCJZe69JxlG506UX6kLC4imDRJ9bcNqS+AqVidYhHbaOwAB5wcKOyrCNnUuigpI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.74.0/LICENSE
```

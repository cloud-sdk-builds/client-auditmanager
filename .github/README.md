...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.797.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.797.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xyHgFXJJxALHfSHwqn3+nB6GVYJsVTbxbDkKK80GCBI8RkYP2xFYWgK9V5xB+Oim
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.797.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.797.0/index.min.mjs": "sha384-xyHgFXJJxALHfSHwqn3+nB6GVYJsVTbxbDkKK80GCBI8RkYP2xFYWgK9V5xB+Oim"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.797.0/LICENSE
```

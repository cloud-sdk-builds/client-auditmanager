...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.986.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.986.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mI2xjY+K2onf4JH8Cx5lAQ3dW8gh4+usv+GMh+TLYcCNwOWmVhwn85IehrA9a0Po
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.986.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.986.0/index.min.mjs": "sha384-mI2xjY+K2onf4JH8Cx5lAQ3dW8gh4+usv+GMh+TLYcCNwOWmVhwn85IehrA9a0Po"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.986.0/LICENSE
```

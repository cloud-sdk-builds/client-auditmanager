...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.127.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.127.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SpGB5m96gNIWXF+4UYMHTl/mrJJYrEaBf6WuMZbY5NKaOR9fF9xA5wzGQDEJRJtF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.127.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.127.0/index.min.mjs": "sha384-SpGB5m96gNIWXF+4UYMHTl/mrJJYrEaBf6WuMZbY5NKaOR9fF9xA5wzGQDEJRJtF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.127.0/LICENSE
```

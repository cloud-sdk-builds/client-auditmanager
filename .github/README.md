...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.775.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.775.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Xssq/ODmv/23vNMI98nQNJZG32WpMwS6VNCfNQJQ+dq2UiHoelFC96647nJ9/AoC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.775.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.775.0/index.min.mjs": "sha384-Xssq/ODmv/23vNMI98nQNJZG32WpMwS6VNCfNQJQ+dq2UiHoelFC96647nJ9/AoC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.775.0/LICENSE
```

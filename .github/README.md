...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.721.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.721.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2xBN6UuqlAyQOzapC5hml6TIlmTJPJbsLcieolzC5AjtitR3fr6KrCA89nIAHEc4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.721.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.721.0/index.min.mjs": "sha384-2xBN6UuqlAyQOzapC5hml6TIlmTJPJbsLcieolzC5AjtitR3fr6KrCA89nIAHEc4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.721.0/LICENSE
```

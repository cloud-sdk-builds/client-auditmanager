...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.839.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.839.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-V+UcsKO2cS54ASKWrPGR6o5ibvYBQgFiGpY60Dw4dDazr8wv3iV05rBaBGeIPK1+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.839.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.839.0/index.min.mjs": "sha384-V+UcsKO2cS54ASKWrPGR6o5ibvYBQgFiGpY60Dw4dDazr8wv3iV05rBaBGeIPK1+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.839.0/LICENSE
```

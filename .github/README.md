...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.298.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.298.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4gbkmX/LFRkTDxv4GMgx0GQBNL1yLtKsDry9SEazgoFFDSyvIf0fhJYIvjmkKjES
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.298.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.298.0/index.min.mjs": "sha384-4gbkmX/LFRkTDxv4GMgx0GQBNL1yLtKsDry9SEazgoFFDSyvIf0fhJYIvjmkKjES"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.298.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.360.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.360.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FXjgYAv8+uCwHLeSDqgNO4hNTorBByyBoCpNOHwCpLaZRNiXBARNv9y31IJyv5dH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.360.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.360.0/index.min.mjs": "sha384-FXjgYAv8+uCwHLeSDqgNO4hNTorBByyBoCpNOHwCpLaZRNiXBARNv9y31IJyv5dH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.360.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.303.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.303.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ipzGqOULCLZ2ysO2b3jercwV/eIdtR2FF8JmtuAUwtdMa0dtun3Z9vhxJAtKUKST
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.303.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.303.0/index.min.mjs": "sha384-ipzGqOULCLZ2ysO2b3jercwV/eIdtR2FF8JmtuAUwtdMa0dtun3Z9vhxJAtKUKST"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.303.0/LICENSE
```

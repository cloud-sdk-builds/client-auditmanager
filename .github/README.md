...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.185.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.185.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-te4u8oxS6grfZ3tvsn1tew+nAGZSKzyH82t0rdqw3z9YZ4ZOYm7ZxZKXmKESI3bl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.185.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.185.0/index.min.mjs": "sha384-te4u8oxS6grfZ3tvsn1tew+nAGZSKzyH82t0rdqw3z9YZ4ZOYm7ZxZKXmKESI3bl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.185.0/LICENSE
```

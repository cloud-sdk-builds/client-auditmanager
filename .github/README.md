...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.954.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.954.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Gznbtjx+m2PPI/Lga8yrzlOIrdp2/BYAGbEtruEX/xpz/ILAN0ycIJImNrlJDQZt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.954.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.954.0/index.min.mjs": "sha384-Gznbtjx+m2PPI/Lga8yrzlOIrdp2/BYAGbEtruEX/xpz/ILAN0ycIJImNrlJDQZt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.954.0/LICENSE
```

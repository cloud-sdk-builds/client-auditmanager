...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.917.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.917.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nJKyugJNHV4I53E8nSMO+epHqSgYBoqryjg+mV+uTBudDf9629ciM/geJTwm22iz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.917.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.917.0/index.min.mjs": "sha384-nJKyugJNHV4I53E8nSMO+epHqSgYBoqryjg+mV+uTBudDf9629ciM/geJTwm22iz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.917.0/LICENSE
```

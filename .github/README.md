...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.235.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.235.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7XzDhTELveM2k05IfirKWT5apK53b5vdSFdpcGl1ZlvyhnBslJgg/OpMabxkbBQf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.235.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.235.0/index.min.mjs": "sha384-7XzDhTELveM2k05IfirKWT5apK53b5vdSFdpcGl1ZlvyhnBslJgg/OpMabxkbBQf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.235.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.23.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.23.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jMlDWWsYErrJiH9V+4ar9rAeRCLPhrqD/EL0IZ0K55RfumtS2NNA8QqXrJHhr/1I
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.23.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.23.0/index.min.mjs": "sha384-jMlDWWsYErrJiH9V+4ar9rAeRCLPhrqD/EL0IZ0K55RfumtS2NNA8QqXrJHhr/1I"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.23.0/LICENSE
```

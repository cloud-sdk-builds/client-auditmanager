...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.593.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.593.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aaSI9XZJ3hDBhpFc+fn2ywaozAcBNvI/aWvPdaqJeXV+e0U3IjCglSrJkoz7TKAw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.593.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.593.0/index.min.mjs": "sha384-aaSI9XZJ3hDBhpFc+fn2ywaozAcBNvI/aWvPdaqJeXV+e0U3IjCglSrJkoz7TKAw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.593.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.913.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.913.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GIDzwFne52TIEPRV3JBcWUL/nmmAw+XFnEsdHCS7lgzIp+1YVEMv/yaYRJwfvwBN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.913.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.913.0/index.min.mjs": "sha384-GIDzwFne52TIEPRV3JBcWUL/nmmAw+XFnEsdHCS7lgzIp+1YVEMv/yaYRJwfvwBN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.913.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.40.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.40.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qplZhluvrCumoZ5oAN9g4oDpwgIO8wFj/nsVRlmRmxtrdm7dx1XVI3vN7+UBiuCI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.40.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.40.0/index.min.mjs": "sha384-qplZhluvrCumoZ5oAN9g4oDpwgIO8wFj/nsVRlmRmxtrdm7dx1XVI3vN7+UBiuCI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.40.0/LICENSE
```

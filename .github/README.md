...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.696.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.696.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SG7YbhOKTNtiIOnGQx1/7e6Cm7DszMMrB61TNxmaKrrkd0/rECgpwcbfQEocZ9sM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.696.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.696.0/index.min.mjs": "sha384-SG7YbhOKTNtiIOnGQx1/7e6Cm7DszMMrB61TNxmaKrrkd0/rECgpwcbfQEocZ9sM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.696.0/LICENSE
```

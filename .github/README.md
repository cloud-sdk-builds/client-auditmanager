...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.911.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.911.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eIdE9bHQ1QvkwPNYZI5FoKH+Baqs6xuN1e91VA5oi7kjku7eFDHospNULVPm8iJn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.911.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.911.0/index.min.mjs": "sha384-eIdE9bHQ1QvkwPNYZI5FoKH+Baqs6xuN1e91VA5oi7kjku7eFDHospNULVPm8iJn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.911.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.325.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.325.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-313Dvr17KUSI9nzx4inkmeiEMuyB1OnYjVep1sszPEtD9qVjf+WyKCeFhTqcAd6m
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.325.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.325.0/index.min.mjs": "sha384-313Dvr17KUSI9nzx4inkmeiEMuyB1OnYjVep1sszPEtD9qVjf+WyKCeFhTqcAd6m"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.325.0/LICENSE
```

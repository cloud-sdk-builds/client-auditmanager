...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.863.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.863.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RZ2N1ClaxbfM/tsAgYcOpdXnght9l9FXwL4Qkth9KWhodXr+abqJl+pbvNnEkyyO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.863.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.863.0/index.min.mjs": "sha384-RZ2N1ClaxbfM/tsAgYcOpdXnght9l9FXwL4Qkth9KWhodXr+abqJl+pbvNnEkyyO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.863.0/LICENSE
```

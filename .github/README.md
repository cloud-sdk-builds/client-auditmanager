...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.934.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.934.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0w7RMNMFKEE6gRjfxYYjf9l912BHCpB1/fruZGXXnqKiwKamfjloEP6cbO0AGHcU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.934.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.934.0/index.min.mjs": "sha384-0w7RMNMFKEE6gRjfxYYjf9l912BHCpB1/fruZGXXnqKiwKamfjloEP6cbO0AGHcU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.934.0/LICENSE
```

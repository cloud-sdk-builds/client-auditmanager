...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.106.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.106.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3FCgumOammHkstFm344UHqST5Fc4o3maBFMnc4lh02yGp66xHDmEpY5Rwnji0dO+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.106.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.106.0/index.min.mjs": "sha384-3FCgumOammHkstFm344UHqST5Fc4o3maBFMnc4lh02yGp66xHDmEpY5Rwnji0dO+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.106.0/LICENSE
```

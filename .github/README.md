...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.933.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.933.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Yr1cU8KC7U3y8Ie23bgGA26Dm/qgSXo1T0Ogcc6Kmrgljl4+0/KJ8joefaCtYh7J
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.933.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.933.0/index.min.mjs": "sha384-Yr1cU8KC7U3y8Ie23bgGA26Dm/qgSXo1T0Ogcc6Kmrgljl4+0/KJ8joefaCtYh7J"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.933.0/LICENSE
```

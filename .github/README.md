...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.292.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.292.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eQbzr1cySoab2REZpWbl3Z3H0axfrk2Eif0CEJHrEcxQXI8ugPDXoqbqe0zZsmnG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.292.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.292.0/index.min.mjs": "sha384-eQbzr1cySoab2REZpWbl3Z3H0axfrk2Eif0CEJHrEcxQXI8ugPDXoqbqe0zZsmnG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.292.0/LICENSE
```

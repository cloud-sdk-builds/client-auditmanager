...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.29.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.29.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jvITAH/3z1cj0lOtKY8Uimf+b2/inuJjpiTIgCU2p3n8Th+daC1GK3yhM909es+w
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.29.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.29.0/index.min.mjs": "sha384-jvITAH/3z1cj0lOtKY8Uimf+b2/inuJjpiTIgCU2p3n8Th+daC1GK3yhM909es+w"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.29.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.473.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.473.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8TPl0aK7bjoh/uut/V52ZO00R+IWNNDbL4lFgXyupsvn6jWwGz4oWOMFQ+x3w10y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.473.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.473.0/index.min.mjs": "sha384-8TPl0aK7bjoh/uut/V52ZO00R+IWNNDbL4lFgXyupsvn6jWwGz4oWOMFQ+x3w10y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.473.0/LICENSE
```

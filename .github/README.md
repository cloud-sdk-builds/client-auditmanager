...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.458.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.458.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CCYvaJlP9SAgknGNIgiy2HPN5VLKvt8mBVKF20i2AbKpksM8DIx8Cm45IJc1Rmpf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.458.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.458.0/index.min.mjs": "sha384-CCYvaJlP9SAgknGNIgiy2HPN5VLKvt8mBVKF20i2AbKpksM8DIx8Cm45IJc1Rmpf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.458.0/LICENSE
```

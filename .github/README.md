...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.925.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.925.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cEaewnAzXzRW6OGLVmbEfaLKibh5cAdURvH5/v5HioZCkVxl6oT64nIYEUd5p2lV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.925.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.925.0/index.min.mjs": "sha384-cEaewnAzXzRW6OGLVmbEfaLKibh5cAdURvH5/v5HioZCkVxl6oT64nIYEUd5p2lV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.925.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.327.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.327.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KeocP0pVkZqyYNUlbBbqrtta/gYhqST/MqVnkUPjj3gvL4sxGvI4rWHwCslEwHMM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.327.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.327.0/index.min.mjs": "sha384-KeocP0pVkZqyYNUlbBbqrtta/gYhqST/MqVnkUPjj3gvL4sxGvI4rWHwCslEwHMM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.327.0/LICENSE
```

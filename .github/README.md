...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.675.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.675.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-r7apqH4hCKeO0PmiLzpHS9ZrJd/EaO9vKj78bopnPryruLXnURJMEp1ZC9oBtil9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.675.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.675.0/index.min.mjs": "sha384-r7apqH4hCKeO0PmiLzpHS9ZrJd/EaO9vKj78bopnPryruLXnURJMEp1ZC9oBtil9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.675.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.481.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.481.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fX9I186nX+63Yx3DbHfRL+KMru1ZjsRLJNtD4ztj+d4BEye+e3+ThzLbCpP8bHVD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.481.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.481.0/index.min.mjs": "sha384-fX9I186nX+63Yx3DbHfRL+KMru1ZjsRLJNtD4ztj+d4BEye+e3+ThzLbCpP8bHVD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.481.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.891.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.891.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Z7DaYIpGxkTHd++IpOEeE4ROsRCNSKPTJ/U2AdxGDn8Gl1Ivwfx+4BXI1NgvkmH2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.891.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.891.0/index.min.mjs": "sha384-Z7DaYIpGxkTHd++IpOEeE4ROsRCNSKPTJ/U2AdxGDn8Gl1Ivwfx+4BXI1NgvkmH2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.891.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.709.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.709.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PozvmZVy54K1rR1vKzWbDjOmqPfkM0oY1z+Gq+CiXT9DWX51OhE2d2bSyjACmyLN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.709.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.709.0/index.min.mjs": "sha384-PozvmZVy54K1rR1vKzWbDjOmqPfkM0oY1z+Gq+CiXT9DWX51OhE2d2bSyjACmyLN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.709.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.55.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.55.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MX0dDUB8yuR2QBFnSro16Tc1TcYYbV6Ch7CMkQdHYqw3rbhFR+bHI+p3rDKIBlLb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.55.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.55.0/index.min.mjs": "sha384-MX0dDUB8yuR2QBFnSro16Tc1TcYYbV6Ch7CMkQdHYqw3rbhFR+bHI+p3rDKIBlLb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.55.0/LICENSE
```

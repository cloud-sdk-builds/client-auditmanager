...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.935.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.935.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Qgl/Np9VmT32GLqYm7w7iCtCQ3r68aoeRs6B84paISBs2+QnanqAgArS54d0WKlR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.935.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.935.0/index.min.mjs": "sha384-Qgl/Np9VmT32GLqYm7w7iCtCQ3r68aoeRs6B84paISBs2+QnanqAgArS54d0WKlR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.935.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.583.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.583.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LRwIzPExEO9C98qPn7u5viJRmjES94R2SsMRl9JtmYJS6zqS/VzmgFkouU6P+pdV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.583.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.583.0/index.min.mjs": "sha384-LRwIzPExEO9C98qPn7u5viJRmjES94R2SsMRl9JtmYJS6zqS/VzmgFkouU6P+pdV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.583.0/LICENSE
```

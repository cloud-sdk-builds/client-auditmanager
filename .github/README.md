...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.888.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.888.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HqcOxvCjkYHw5K1jLdNO2Ykeh9Fw1myW0DaO4b0xSSzfJv3fZklO/ASz8GGTvfiN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.888.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.888.0/index.min.mjs": "sha384-HqcOxvCjkYHw5K1jLdNO2Ykeh9Fw1myW0DaO4b0xSSzfJv3fZklO/ASz8GGTvfiN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.888.0/LICENSE
```

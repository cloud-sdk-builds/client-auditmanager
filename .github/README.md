...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.995.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.995.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NdziA7hLEEwgHUV3WfnQk7QbsSHVvAdwKpK2Y1p9HOsI5jp6rNNApvRAPwyBh2K4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.995.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.995.0/index.min.mjs": "sha384-NdziA7hLEEwgHUV3WfnQk7QbsSHVvAdwKpK2Y1p9HOsI5jp6rNNApvRAPwyBh2K4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.995.0/LICENSE
```

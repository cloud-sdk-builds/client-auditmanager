...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.241.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.241.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aGVqqxt6sRxywTpsK5QgCpn1WV5zeQBhKUVw8aTfVjXuODXtAlrH3sEG+qyJmiIC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.241.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.241.0/index.min.mjs": "sha384-aGVqqxt6sRxywTpsK5QgCpn1WV5zeQBhKUVw8aTfVjXuODXtAlrH3sEG+qyJmiIC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.241.0/LICENSE
```

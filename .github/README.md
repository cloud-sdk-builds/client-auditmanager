...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.461.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.461.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Nk2hNv4QcQFFzX30UoppNHado2c2b/SYXW1yBP4DWXIIVXOBg3TsBPBRN4vwRiEM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.461.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.461.0/index.min.mjs": "sha384-Nk2hNv4QcQFFzX30UoppNHado2c2b/SYXW1yBP4DWXIIVXOBg3TsBPBRN4vwRiEM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.461.0/LICENSE
```

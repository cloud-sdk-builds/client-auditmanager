...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.723.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.723.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DVUTkLQpZ4fquGNtHdcGsJ4642S2fWRE0iMXWGybceH7g39aOoaQFSC23EqKL69B
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.723.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.723.0/index.min.mjs": "sha384-DVUTkLQpZ4fquGNtHdcGsJ4642S2fWRE0iMXWGybceH7g39aOoaQFSC23EqKL69B"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.723.0/LICENSE
```

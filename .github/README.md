...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.484.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.484.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PLfV7WkvvWaRxnroBGSEqxVxcQAUCuOJLr4e5AmgX2BMkRkt6jfCIQg2mHqFr4ww
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.484.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.484.0/index.min.mjs": "sha384-PLfV7WkvvWaRxnroBGSEqxVxcQAUCuOJLr4e5AmgX2BMkRkt6jfCIQg2mHqFr4ww"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.484.0/LICENSE
```

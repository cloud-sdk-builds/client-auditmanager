...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.899.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.899.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5QivIuMG1aBrzb6xZkoi74Sl2w1nWBUsKLM2OsdST6kMIJy5FUsz7YY/VrjLoi+j
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.899.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.899.0/index.min.mjs": "sha384-5QivIuMG1aBrzb6xZkoi74Sl2w1nWBUsKLM2OsdST6kMIJy5FUsz7YY/VrjLoi+j"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.899.0/LICENSE
```

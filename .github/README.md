...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.916.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.916.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FpyBpYEK8kZ0h5+ps7fVFRUsdKw7kL9WAzp3xQk6BuMusirCEDYqwKi8KdEdfXca
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.916.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.916.0/index.min.mjs": "sha384-FpyBpYEK8kZ0h5+ps7fVFRUsdKw7kL9WAzp3xQk6BuMusirCEDYqwKi8KdEdfXca"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.916.0/LICENSE
```

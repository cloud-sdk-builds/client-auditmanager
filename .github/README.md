...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.25.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.25.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1aMIicE5DFASyujqiMw9ikMgv4UUF67QLY7+8yt1IxydnIwEAowHMyJR1IThUO8/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.25.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.25.0/index.min.mjs": "sha384-1aMIicE5DFASyujqiMw9ikMgv4UUF67QLY7+8yt1IxydnIwEAowHMyJR1IThUO8/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.25.0/LICENSE
```

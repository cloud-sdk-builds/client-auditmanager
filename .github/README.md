...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.592.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.592.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UYLbPH8/4e4/zDtRu+nWsqyNnEyL8HyX78FPXsFS2EprzraxOg7t4M8DC5RJj99I
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.592.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.592.0/index.min.mjs": "sha384-UYLbPH8/4e4/zDtRu+nWsqyNnEyL8HyX78FPXsFS2EprzraxOg7t4M8DC5RJj99I"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.592.0/LICENSE
```

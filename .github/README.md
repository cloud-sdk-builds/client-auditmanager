...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.338.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.338.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PtONomMyNv6ZkcOqtPz5ReqlkQokrPXnWcAuw1JTcrMIPMIM23nv7l5wafuNQs6b
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.338.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.338.0/index.min.mjs": "sha384-PtONomMyNv6ZkcOqtPz5ReqlkQokrPXnWcAuw1JTcrMIPMIM23nv7l5wafuNQs6b"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.338.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.6.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.6.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-L9sjwQhd74EM1FzYQTGB2oNyGECYXbZ5wIlWdHVpc0NHL4tNCE3P5x+K5NDlpZDC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.6.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.6.1/index.min.mjs": "sha384-L9sjwQhd74EM1FzYQTGB2oNyGECYXbZ5wIlWdHVpc0NHL4tNCE3P5x+K5NDlpZDC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.6.1/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.1013.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1013.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rrlnBjLsHYk+EiVLW9PzfFwSIXxmbA3e3m6eAwqGeptk5whj+hWDPzBgkqbhdj+9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1013.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1013.0/index.min.mjs": "sha384-rrlnBjLsHYk+EiVLW9PzfFwSIXxmbA3e3m6eAwqGeptk5whj+hWDPzBgkqbhdj+9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.1013.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.991.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.991.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fTNA0vE16Dc4815JxoIqIWmfE389mFOjDU2tblf+ASeg/IWunhfLgs1jw4PXxohR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.991.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.991.0/index.min.mjs": "sha384-fTNA0vE16Dc4815JxoIqIWmfE389mFOjDU2tblf+ASeg/IWunhfLgs1jw4PXxohR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.991.0/LICENSE
```

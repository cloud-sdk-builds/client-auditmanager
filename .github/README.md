...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.261.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.261.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xfDI5gJCIvAKb/iO/BTLIGv7dGvNAyMLxZRXg71s0vkp+URiiq76KniHim5qoCJ6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.261.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.261.0/index.min.mjs": "sha384-xfDI5gJCIvAKb/iO/BTLIGv7dGvNAyMLxZRXg71s0vkp+URiiq76KniHim5qoCJ6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.261.0/LICENSE
```

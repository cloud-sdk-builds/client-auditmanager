...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.353.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.353.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Uxg/ov/EqHyoqNpNXZ9foPMIGxj4AQS/G+xU4YEUJcMTPg98XRy616+t9xB3H0Ui
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.353.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.353.0/index.min.mjs": "sha384-Uxg/ov/EqHyoqNpNXZ9foPMIGxj4AQS/G+xU4YEUJcMTPg98XRy616+t9xB3H0Ui"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.353.0/LICENSE
```

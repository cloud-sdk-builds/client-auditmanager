...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.34.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.34.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7XTl9W1f2GBRhRwGmWtjvJUFzIQjhMBYMHWSYpLRC/Y8HJIpRkaBaqw+l9g4r4JY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.34.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.34.0/index.min.mjs": "sha384-7XTl9W1f2GBRhRwGmWtjvJUFzIQjhMBYMHWSYpLRC/Y8HJIpRkaBaqw+l9g4r4JY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.34.0/LICENSE
```

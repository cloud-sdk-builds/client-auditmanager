...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.433.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.433.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9yPNVZ68JrhU/Mo0hR66wkI3Vm7PLApg2xF1mTfp2iFWn63LN8IAES5eOhZz6d/7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.433.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.433.0/index.min.mjs": "sha384-9yPNVZ68JrhU/Mo0hR66wkI3Vm7PLApg2xF1mTfp2iFWn63LN8IAES5eOhZz6d/7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.433.0/LICENSE
```

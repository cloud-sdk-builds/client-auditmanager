...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.321.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.321.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-HXzavmJTzRGGiAuly2KRGZ06aPzlDLX6erH5ahlvoV25UEoL7kfW8oQHy1QS+TMM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.321.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.321.1/index.min.mjs": "sha384-HXzavmJTzRGGiAuly2KRGZ06aPzlDLX6erH5ahlvoV25UEoL7kfW8oQHy1QS+TMM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.321.1/LICENSE
```

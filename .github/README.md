...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.918.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.918.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vinRH760ioEmOCJjQrwWHK2AjhgzPVK3mngSFAxPBg2MizYVySbxPcXegc7BXRtJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.918.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.918.0/index.min.mjs": "sha384-vinRH760ioEmOCJjQrwWHK2AjhgzPVK3mngSFAxPBg2MizYVySbxPcXegc7BXRtJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.918.0/LICENSE
```

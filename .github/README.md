...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.169.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.169.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HUry3rbxgKUTYle3FeW493uRlUqAe5Q9IKXD8dVyRTyxZHgqhzWa+kH33NCrh5TQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.169.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.169.0/index.min.mjs": "sha384-HUry3rbxgKUTYle3FeW493uRlUqAe5Q9IKXD8dVyRTyxZHgqhzWa+kH33NCrh5TQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.169.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.777.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.777.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OtK76xJJo1qp412E+GGtDIDID4NL6DRg4hj4rtRTwO3uHJ6airItvMbUS1OvOqna
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.777.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.777.0/index.min.mjs": "sha384-OtK76xJJo1qp412E+GGtDIDID4NL6DRg4hj4rtRTwO3uHJ6airItvMbUS1OvOqna"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.777.0/LICENSE
```

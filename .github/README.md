...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.981.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.981.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-M2X3t7cRsezCglOQObB3c3hyblbB6ICFiKZ4q9hGEuVY3cUl/jSuTtHi85zvqdik
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.981.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.981.0/index.min.mjs": "sha384-M2X3t7cRsezCglOQObB3c3hyblbB6ICFiKZ4q9hGEuVY3cUl/jSuTtHi85zvqdik"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.981.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.362.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.362.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5zKE9zcWNaowrlF+BTc8oeDlvfNnSHgszOiky44kXFIs70/9iJtp5OVPOgXzcHMu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.362.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.362.0/index.min.mjs": "sha384-5zKE9zcWNaowrlF+BTc8oeDlvfNnSHgszOiky44kXFIs70/9iJtp5OVPOgXzcHMu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.362.0/LICENSE
```

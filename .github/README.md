...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.410.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.410.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-P22vUUhsOp5CsGQSRjb7Wx6IRC+4LDwQ5R2J5iQnp0tK+stx1p6S6G9PuaY1E7U9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.410.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.410.0/index.min.mjs": "sha384-P22vUUhsOp5CsGQSRjb7Wx6IRC+4LDwQ5R2J5iQnp0tK+stx1p6S6G9PuaY1E7U9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.410.0/LICENSE
```

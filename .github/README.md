...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.682.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.682.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3zrr/cwRO7kUmpAH5s/fm48TUAs6/urGtTjPSCGheeQUmfhRIlKZjyw1gWQVRCwQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.682.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.682.0/index.min.mjs": "sha384-3zrr/cwRO7kUmpAH5s/fm48TUAs6/urGtTjPSCGheeQUmfhRIlKZjyw1gWQVRCwQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.682.0/LICENSE
```

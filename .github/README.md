...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.743.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.743.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SABZvqzxgfwMTunPGu7E/l/EEWw1KTr3k3MW69pUpGbGWZELST6Au5geY7mb3Pgf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.743.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.743.0/index.min.mjs": "sha384-SABZvqzxgfwMTunPGu7E/l/EEWw1KTr3k3MW69pUpGbGWZELST6Au5geY7mb3Pgf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.743.0/LICENSE
```

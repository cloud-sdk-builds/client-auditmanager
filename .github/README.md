...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.278.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.278.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6noy62SjY8kQVABBsW6wGW/NQ5f/+szIBEQ/LUkP+1yIfIdYfzINTkOdP6sffhjZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.278.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.278.0/index.min.mjs": "sha384-6noy62SjY8kQVABBsW6wGW/NQ5f/+szIBEQ/LUkP+1yIfIdYfzINTkOdP6sffhjZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.278.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.787.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.787.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ae0rtO/FzIxZR2GNBHdDDONtyQR1SVOwsmf7lLFD3y/uOH46nC5a8wJbW+FjPLF4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.787.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.787.0/index.min.mjs": "sha384-Ae0rtO/FzIxZR2GNBHdDDONtyQR1SVOwsmf7lLFD3y/uOH46nC5a8wJbW+FjPLF4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.787.0/LICENSE
```

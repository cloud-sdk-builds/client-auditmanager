...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.799.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.799.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3dJuQXvo2iD3D6V011nizPaMDgdvMlaG9AS1J4jk5bBX0Ol5Gciehja2HUjn0rRZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.799.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.799.0/index.min.mjs": "sha384-3dJuQXvo2iD3D6V011nizPaMDgdvMlaG9AS1J4jk5bBX0Ol5Gciehja2HUjn0rRZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.799.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.825.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.825.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Rmsq153Uk1Ll3phLpYL/veeaAT+3RECxyItz06FA9bwhYF6L3H//vve2ttO10+JA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.825.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.825.0/index.min.mjs": "sha384-Rmsq153Uk1Ll3phLpYL/veeaAT+3RECxyItz06FA9bwhYF6L3H//vve2ttO10+JA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.825.0/LICENSE
```

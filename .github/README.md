...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.635.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.635.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CGU9bDy4j1Lom5KHR1iwAasJdlxaENpvGqdiWbV6er2B9PrA7bIKkePXvsxj9/IR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.635.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.635.0/index.min.mjs": "sha384-CGU9bDy4j1Lom5KHR1iwAasJdlxaENpvGqdiWbV6er2B9PrA7bIKkePXvsxj9/IR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.635.0/LICENSE
```

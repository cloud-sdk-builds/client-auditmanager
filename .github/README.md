...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.209.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.209.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RL3O1qkbn8Z23NmdD70Qs6FyxQ9+clWxma0CMZQgHcoNB5bVw8pNOLArejoTQzsa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.209.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.209.0/index.min.mjs": "sha384-RL3O1qkbn8Z23NmdD70Qs6FyxQ9+clWxma0CMZQgHcoNB5bVw8pNOLArejoTQzsa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.209.0/LICENSE
```

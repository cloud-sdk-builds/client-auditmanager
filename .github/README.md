...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.614.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.614.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bx/DnNQW47Q6IJcoyUw12VFW1AdMEWeIYwqHMmndET1KI1BCX4QtrSlO4xDk/Ha9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.614.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.614.0/index.min.mjs": "sha384-bx/DnNQW47Q6IJcoyUw12VFW1AdMEWeIYwqHMmndET1KI1BCX4QtrSlO4xDk/Ha9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.614.0/LICENSE
```

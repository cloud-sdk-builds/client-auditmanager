...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.53.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.53.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ti8qSSu81n1XG69AKoSrablmGYKFFfkPxSUg5hmpWO5ykZCL5ONb5uWa6P20yspK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.53.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.53.0/index.min.mjs": "sha384-Ti8qSSu81n1XG69AKoSrablmGYKFFfkPxSUg5hmpWO5ykZCL5ONb5uWa6P20yspK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.53.0/LICENSE
```

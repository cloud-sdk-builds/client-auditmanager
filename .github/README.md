...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.287.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.287.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ke21/5rGUiXbftJeoDu5BOQLj+M2r2pphMfW0uU4PqOGjAd0WDMDwJj7DGJV2gAd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.287.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.287.0/index.min.mjs": "sha384-ke21/5rGUiXbftJeoDu5BOQLj+M2r2pphMfW0uU4PqOGjAd0WDMDwJj7DGJV2gAd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.287.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.52.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.52.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-c5OJ8QmlCPu33BeU97KNR1dEuIk58r+3ufFR7mOX9tv4nr3hN86DiBZKyUQPfool
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.52.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.52.0/index.min.mjs": "sha384-c5OJ8QmlCPu33BeU97KNR1dEuIk58r+3ufFR7mOX9tv4nr3hN86DiBZKyUQPfool"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.52.0/LICENSE
```

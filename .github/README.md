...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.848.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.848.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hAUVvjbqDPVSV4J6EF2sYs335Lkq9ZhYZ0fmMXnsSH8WSy5dUyeGwYCW8nCoOut2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.848.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.848.0/index.min.mjs": "sha384-hAUVvjbqDPVSV4J6EF2sYs335Lkq9ZhYZ0fmMXnsSH8WSy5dUyeGwYCW8nCoOut2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.848.0/LICENSE
```

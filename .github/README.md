...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.670.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.670.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UCytjsP1KFPuD0RPy6EdHEVbKQCt08rz+0bcTBcnddsKINza5mWJFoMIc6vJpaok
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.670.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.670.0/index.min.mjs": "sha384-UCytjsP1KFPuD0RPy6EdHEVbKQCt08rz+0bcTBcnddsKINza5mWJFoMIc6vJpaok"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.670.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.395.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.395.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pIVFgpdmjJRnum3J3QnD/oMvDZNa1svJFoy48d7Q95g2VPs0WdqUFNrpPXnr6qte
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.395.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.395.0/index.min.mjs": "sha384-pIVFgpdmjJRnum3J3QnD/oMvDZNa1svJFoy48d7Q95g2VPs0WdqUFNrpPXnr6qte"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.395.0/LICENSE
```

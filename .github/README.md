...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.359.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.359.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RDZFXIs6b0s1wSMTCTzGqvAb5nli6hOGYZx2t0pei5CZWay4kL1Adpu67FIpe9g4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.359.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.359.0/index.min.mjs": "sha384-RDZFXIs6b0s1wSMTCTzGqvAb5nli6hOGYZx2t0pei5CZWay4kL1Adpu67FIpe9g4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.359.0/LICENSE
```

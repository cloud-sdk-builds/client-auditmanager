...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.385.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.385.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BsXXK8gZOUU9oeuGRNlAzG/diG1Q3sittMFTlWRfUvpMD2VV+dlaEwZms3l7sHrv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.385.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.385.0/index.min.mjs": "sha384-BsXXK8gZOUU9oeuGRNlAzG/diG1Q3sittMFTlWRfUvpMD2VV+dlaEwZms3l7sHrv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.385.0/LICENSE
```

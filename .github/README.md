...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.943.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.943.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lEJipbr+SUK2gM6F2HJHsi0p8Z3Y8u8Oxjqk6JBju72nWTRrkAJuii2SGV8vD7HT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.943.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.943.0/index.min.mjs": "sha384-lEJipbr+SUK2gM6F2HJHsi0p8Z3Y8u8Oxjqk6JBju72nWTRrkAJuii2SGV8vD7HT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.943.0/LICENSE
```

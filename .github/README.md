...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.454.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.454.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OjrJCQRg8ehLA/TmXsT+ovuioMQWdNaeaMZ8rOAqIvcbSzHxVcF7SQ4uuQw2KlLO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.454.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.454.0/index.min.mjs": "sha384-OjrJCQRg8ehLA/TmXsT+ovuioMQWdNaeaMZ8rOAqIvcbSzHxVcF7SQ4uuQw2KlLO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.454.0/LICENSE
```

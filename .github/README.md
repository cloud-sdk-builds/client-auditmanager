...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.76.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.76.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ikssoRbtRuBLDjJb4YoEDO6Lj4JT5mnzGjPS5HEe5v5I6+I9Dx5xg7CKceixAZ9H
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.76.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.76.0/index.min.mjs": "sha384-ikssoRbtRuBLDjJb4YoEDO6Lj4JT5mnzGjPS5HEe5v5I6+I9Dx5xg7CKceixAZ9H"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.76.0/LICENSE
```

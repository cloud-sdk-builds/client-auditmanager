...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.13.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.13.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-f4Y1onse1NHiYrnlqDtyfrazuTc2pQKULsh6mfxbrcxZGklyTWBqoBf1lmQqzXEt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.13.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.13.1/index.min.mjs": "sha384-f4Y1onse1NHiYrnlqDtyfrazuTc2pQKULsh6mfxbrcxZGklyTWBqoBf1lmQqzXEt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.13.1/LICENSE
```

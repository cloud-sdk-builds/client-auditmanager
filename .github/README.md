...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.236.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.236.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-x646oenO3ljdLbdSMOgbUvEsBnBneCE1jVQ+tygOWwdtjlqvm5Q3ZikAK7hjpKo3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.236.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.236.0/index.min.mjs": "sha384-x646oenO3ljdLbdSMOgbUvEsBnBneCE1jVQ+tygOWwdtjlqvm5Q3ZikAK7hjpKo3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.236.0/LICENSE
```

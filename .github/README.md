...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.21.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.21.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5y/TSZAxYnjHtqbYA722Mrt6qiREtEyMMS1BJnvtwlEPVJtX4M6EjigMzTZKuDwx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.21.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.21.0/index.min.mjs": "sha384-5y/TSZAxYnjHtqbYA722Mrt6qiREtEyMMS1BJnvtwlEPVJtX4M6EjigMzTZKuDwx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.21.0/LICENSE
```

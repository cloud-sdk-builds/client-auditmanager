...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.549.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.549.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Qw+jdAppjZ+1EGkhC0ErcRDK2ZHRWTSisg99Ya5/SkriY1I/n8WTuJB3Ud9WUtuK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.549.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.549.0/index.min.mjs": "sha384-Qw+jdAppjZ+1EGkhC0ErcRDK2ZHRWTSisg99Ya5/SkriY1I/n8WTuJB3Ud9WUtuK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.549.0/LICENSE
```

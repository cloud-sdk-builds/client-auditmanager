...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.409.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.409.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RGay6yWa5mc578QECNW2OYtbc6e6JzikZeKxIJCWgpSuxZmBWJ7U0BL80Oz812d0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.409.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.409.0/index.min.mjs": "sha384-RGay6yWa5mc578QECNW2OYtbc6e6JzikZeKxIJCWgpSuxZmBWJ7U0BL80Oz812d0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.409.0/LICENSE
```

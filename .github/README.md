...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.377.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.377.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4YWHU0f+O+jLpRmHUOQ14HtVi5LyBuN1lQHfgARIP6XLqtd8J5lwEW2ewDC7vXda
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.377.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.377.0/index.min.mjs": "sha384-4YWHU0f+O+jLpRmHUOQ14HtVi5LyBuN1lQHfgARIP6XLqtd8J5lwEW2ewDC7vXda"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.377.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.18.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.18.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-N1fDpRjiITHxjTQj+RCMkydNhoHx71i42XKAeRyMyn6X5hlxYZQWAjtm9QqHff3F
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.18.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.18.0/index.min.mjs": "sha384-N1fDpRjiITHxjTQj+RCMkydNhoHx71i42XKAeRyMyn6X5hlxYZQWAjtm9QqHff3F"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.18.0/LICENSE
```

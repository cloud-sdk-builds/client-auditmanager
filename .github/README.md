...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.1022.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1022.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7RzwczD1xGzetO9nnm7oe0Lkc6h+l6tyNtPaUbv1xwPZQqIEGtNRRwT3l2IXCEvc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1022.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1022.0/index.min.mjs": "sha384-7RzwczD1xGzetO9nnm7oe0Lkc6h+l6tyNtPaUbv1xwPZQqIEGtNRRwT3l2IXCEvc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.1022.0/LICENSE
```

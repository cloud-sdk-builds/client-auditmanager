...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.882.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.882.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qTeKFGL4NR2SIxBJOUBI0679EY9XzRe5Ml+3zS6ZFhlAW4JyPolJQ3xmmbbe8i4D
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.882.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.882.0/index.min.mjs": "sha384-qTeKFGL4NR2SIxBJOUBI0679EY9XzRe5Ml+3zS6ZFhlAW4JyPolJQ3xmmbbe8i4D"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.882.0/LICENSE
```

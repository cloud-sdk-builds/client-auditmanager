...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.826.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.826.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+YvNoNxUNrPtywEzTEr81c0zdgI9GcchqUqEue8zgeB9NnBOYKvc1f4KilxUClrl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.826.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.826.0/index.min.mjs": "sha384-+YvNoNxUNrPtywEzTEr81c0zdgI9GcchqUqEue8zgeB9NnBOYKvc1f4KilxUClrl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.826.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.28.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.28.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3t0v+Kghfmc2vxX3VNmJntdikfHctVZgsP3+PVhf3KQS/vp4Ovox+8AeuzFF3yGb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.28.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.28.0/index.min.mjs": "sha384-3t0v+Kghfmc2vxX3VNmJntdikfHctVZgsP3+PVhf3KQS/vp4Ovox+8AeuzFF3yGb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.28.0/LICENSE
```

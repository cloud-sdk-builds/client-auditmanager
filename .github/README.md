...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.391.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.391.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LclX22WwoUkY5lURY0kdVsjEoSOGoKrm7EMaSFr5ZdWVr/tGIoFLjuoPtRX4K7S1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.391.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.391.0/index.min.mjs": "sha384-LclX22WwoUkY5lURY0kdVsjEoSOGoKrm7EMaSFr5ZdWVr/tGIoFLjuoPtRX4K7S1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.391.0/LICENSE
```

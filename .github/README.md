...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.666.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.666.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VZl32F5tMtMkrVerHURcHPx55a/FOIS4E1UBGUMDDmEI7huRyQ+1R26ll9f3qudj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.666.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.666.0/index.min.mjs": "sha384-VZl32F5tMtMkrVerHURcHPx55a/FOIS4E1UBGUMDDmEI7huRyQ+1R26ll9f3qudj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.666.0/LICENSE
```

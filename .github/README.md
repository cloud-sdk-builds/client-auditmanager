...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.931.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.931.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BfaxwWxDbi5m4wCZpJRqqjahP9Y1jsN3FPAvn1lKeE3xKchoDhf/Jnj6qwe6G3UH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.931.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.931.0/index.min.mjs": "sha384-BfaxwWxDbi5m4wCZpJRqqjahP9Y1jsN3FPAvn1lKeE3xKchoDhf/Jnj6qwe6G3UH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.931.0/LICENSE
```

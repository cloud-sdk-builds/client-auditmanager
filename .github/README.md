...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.168.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.168.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KTS5Zl+wvfKG+lA8cwWshW9kac8uzyhfFw4ko0t8CFkqp9sG3KaIsSTEXvbe1Ug4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.168.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.168.0/index.min.mjs": "sha384-KTS5Zl+wvfKG+lA8cwWshW9kac8uzyhfFw4ko0t8CFkqp9sG3KaIsSTEXvbe1Ug4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.168.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.982.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.982.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hM3xG7ZOSCMPAdXvu1jN0c2B2v0vZxp8tyS8fXet2TBDAwvY1f92cdZdFzeTcu3D
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.982.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.982.0/index.min.mjs": "sha384-hM3xG7ZOSCMPAdXvu1jN0c2B2v0vZxp8tyS8fXet2TBDAwvY1f92cdZdFzeTcu3D"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.982.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.414.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.414.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6mQxQlG7KABHtOT0CuomAyLUF0rKwFBeHd9jinbv4Ir33I3aB0+fchF2hAOVq+1p
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.414.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.414.0/index.min.mjs": "sha384-6mQxQlG7KABHtOT0CuomAyLUF0rKwFBeHd9jinbv4Ir33I3aB0+fchF2hAOVq+1p"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.414.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.554.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.554.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HL3SWGsFB0OSspvDb4Qt9V/RpeNmHQG0dN28Lo0STmsQ9U0N+r8BDFoskNfHZBv+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.554.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.554.0/index.min.mjs": "sha384-HL3SWGsFB0OSspvDb4Qt9V/RpeNmHQG0dN28Lo0STmsQ9U0N+r8BDFoskNfHZBv+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.554.0/LICENSE
```

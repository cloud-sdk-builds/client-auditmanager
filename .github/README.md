...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.43.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.43.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NiZABIdEQeWvidr/okmCYePr0vY3iyA6J41h2CfYy9obdew6KDm4TimRQd0MaARw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.43.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.43.0/index.min.mjs": "sha384-NiZABIdEQeWvidr/okmCYePr0vY3iyA6J41h2CfYy9obdew6KDm4TimRQd0MaARw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.43.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.990.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.990.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-luf5jG6lGYo3wW571GW2rKaIuRRS+dRhOkHtUSFjn/ezQzIF/VXWYhiMPFNgcMRX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.990.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.990.0/index.min.mjs": "sha384-luf5jG6lGYo3wW571GW2rKaIuRRS+dRhOkHtUSFjn/ezQzIF/VXWYhiMPFNgcMRX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.990.0/LICENSE
```

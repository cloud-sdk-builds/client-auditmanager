...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.1018.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1018.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9G5a2erxVwKx4uWoOVedUv9HvzQtOyaAKiIIIPGv4Pgw/TYFXWcNd6AcA4tbz5ul
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1018.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1018.0/index.min.mjs": "sha384-9G5a2erxVwKx4uWoOVedUv9HvzQtOyaAKiIIIPGv4Pgw/TYFXWcNd6AcA4tbz5ul"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.1018.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.213.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.213.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GGvslrpSPbpyc9CUvjiGIyENDhJ5Y296YaP0DGspss3qvZzvayyt9EdEv1zh8bj2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.213.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.213.0/index.min.mjs": "sha384-GGvslrpSPbpyc9CUvjiGIyENDhJ5Y296YaP0DGspss3qvZzvayyt9EdEv1zh8bj2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.213.0/LICENSE
```

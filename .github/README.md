...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.4.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.4.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-3onPL5G1AbmWO8FR0/KoCERnjq3mAhs3FnLHWqhAancDe2PNx2/0TW+5+BdZQrrr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.4.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.4.1/index.min.mjs": "sha384-3onPL5G1AbmWO8FR0/KoCERnjq3mAhs3FnLHWqhAancDe2PNx2/0TW+5+BdZQrrr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.4.1/LICENSE
```

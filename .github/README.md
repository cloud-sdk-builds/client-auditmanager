...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.632.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.632.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9YSrSl2seazEVL/bc1JY9XyMvTog69OkxwRXh4yiwC0Vmav9FYAXJ55OLzCeSO0+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.632.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.632.0/index.min.mjs": "sha384-9YSrSl2seazEVL/bc1JY9XyMvTog69OkxwRXh4yiwC0Vmav9FYAXJ55OLzCeSO0+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.632.0/LICENSE
```

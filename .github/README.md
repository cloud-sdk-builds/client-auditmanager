...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.1026.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1026.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1SCNcVnC3FVIvI0EJpXwCIluMbrLggU5MbNCBHD2E1oQNcGGvm5oIS+VcsOJ8CJH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1026.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1026.0/index.min.mjs": "sha384-1SCNcVnC3FVIvI0EJpXwCIluMbrLggU5MbNCBHD2E1oQNcGGvm5oIS+VcsOJ8CJH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.1026.0/LICENSE
```

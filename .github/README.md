...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.679.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.679.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2fJJt+zVajvGVJ/OyMJ9A/6rBOQ1TqmS6n4s+1DnN94lyKy8z3UtZijzyVF+ZB5A
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.679.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.679.0/index.min.mjs": "sha384-2fJJt+zVajvGVJ/OyMJ9A/6rBOQ1TqmS6n4s+1DnN94lyKy8z3UtZijzyVF+ZB5A"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.679.0/LICENSE
```

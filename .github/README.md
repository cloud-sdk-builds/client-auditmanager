...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.193.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.193.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GCeEOJ+oGeHWnlfSrpZ+D8jRlRv7Kq3HdSn+1Pll6hupteUBQkkUZFlZRi8sSFEc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.193.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.193.0/index.min.mjs": "sha384-GCeEOJ+oGeHWnlfSrpZ+D8jRlRv7Kq3HdSn+1Pll6hupteUBQkkUZFlZRi8sSFEc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.193.0/LICENSE
```

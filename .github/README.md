...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.970.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.970.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NbJ8qB979stiuSjsalomENQW8JrNeclTxs0FLxRFUxzo4ox6ilzdwsbw1w8jbE6M
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.970.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.970.0/index.min.mjs": "sha384-NbJ8qB979stiuSjsalomENQW8JrNeclTxs0FLxRFUxzo4ox6ilzdwsbw1w8jbE6M"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.970.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.137.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.137.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PFEpfx49dizUQ/lD7pX36Wa2+nVLb5uPaOrkSAiGpM/0uQfaTWgkIr73FEQW7lbS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.137.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.137.0/index.min.mjs": "sha384-PFEpfx49dizUQ/lD7pX36Wa2+nVLb5uPaOrkSAiGpM/0uQfaTWgkIr73FEQW7lbS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.137.0/LICENSE
```

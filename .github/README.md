...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.316.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.316.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uhdBn/oc6SUrsCJE9nvRYeKrDffJrNA4P2gQ6N6DFgwU5COQ1hqW4mMmjMhFupnS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.316.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.316.0/index.min.mjs": "sha384-uhdBn/oc6SUrsCJE9nvRYeKrDffJrNA4P2gQ6N6DFgwU5COQ1hqW4mMmjMhFupnS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.316.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.576.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.576.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kombfLAopOGFYOYV2kyEuh5vX+NPbY8fzVtmZhiV+1av4SAI0jeedJ6ZnqoFu7im
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.576.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.576.0/index.min.mjs": "sha384-kombfLAopOGFYOYV2kyEuh5vX+NPbY8fzVtmZhiV+1av4SAI0jeedJ6ZnqoFu7im"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.576.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.344.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.344.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-skZ1aGhjbaQ/5XWrbTbZQwFQ0o+qcNV/dDkgXHnNtPDqCA7J15gGghoBS+YrCJa9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.344.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.344.0/index.min.mjs": "sha384-skZ1aGhjbaQ/5XWrbTbZQwFQ0o+qcNV/dDkgXHnNtPDqCA7J15gGghoBS+YrCJa9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.344.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.54.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.54.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OJ54hEcsfCUq00+U2r40W7IvdBRsl34bm8jWaEXrpPDW8s6gavod/hxN/x/6QiIX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.54.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.54.0/index.min.mjs": "sha384-OJ54hEcsfCUq00+U2r40W7IvdBRsl34bm8jWaEXrpPDW8s6gavod/hxN/x/6QiIX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.54.0/LICENSE
```

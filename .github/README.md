...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.190.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.190.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tP/dvi0KeNbcwjpX2bkBrEKrbpeWTaikPoiNvQmsfnB8nXjbzZqGJQOlZW9j9yTh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.190.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.190.0/index.min.mjs": "sha384-tP/dvi0KeNbcwjpX2bkBrEKrbpeWTaikPoiNvQmsfnB8nXjbzZqGJQOlZW9j9yTh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.190.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.87.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.87.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+B15WSnljbn/Y7fcorNZtHjywCiWmeFBTItEVLnfyL6nlB8b1VmiROBW6zEJ36zv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.87.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.87.0/index.min.mjs": "sha384-+B15WSnljbn/Y7fcorNZtHjywCiWmeFBTItEVLnfyL6nlB8b1VmiROBW6zEJ36zv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.87.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.803.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.803.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YHTd1e95if5oZCtFIhkAidZFnRxMnIDW8kuu3U4qcmjC1HgAK44Jrg/yiHMRIdD1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.803.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.803.0/index.min.mjs": "sha384-YHTd1e95if5oZCtFIhkAidZFnRxMnIDW8kuu3U4qcmjC1HgAK44Jrg/yiHMRIdD1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.803.0/LICENSE
```

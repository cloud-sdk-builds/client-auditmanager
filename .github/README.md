...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.654.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.654.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FAdSsN42/sk+QJl/o4ehAyXkud5fUzqkgJemtl2QS/sZuDZLrFuM3m/wFyBiLpIm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.654.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.654.0/index.min.mjs": "sha384-FAdSsN42/sk+QJl/o4ehAyXkud5fUzqkgJemtl2QS/sZuDZLrFuM3m/wFyBiLpIm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.654.0/LICENSE
```

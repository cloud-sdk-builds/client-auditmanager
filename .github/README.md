...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.726.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.726.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NQ2BMyqU7LRZC7br7UCEYF3ViKOMSL2EOpbdh3e66TlXWW+QKJwkhA2nyT5meFbr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.726.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.726.0/index.min.mjs": "sha384-NQ2BMyqU7LRZC7br7UCEYF3ViKOMSL2EOpbdh3e66TlXWW+QKJwkhA2nyT5meFbr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.726.0/LICENSE
```

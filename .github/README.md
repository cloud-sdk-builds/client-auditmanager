...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.215.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.215.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rmlpkPlgQ5tFAAYXKLP4pMMh5mQzA7mkj+M7msnEJxXlpykCba0ovfcKZg37QD9K
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.215.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.215.0/index.min.mjs": "sha384-rmlpkPlgQ5tFAAYXKLP4pMMh5mQzA7mkj+M7msnEJxXlpykCba0ovfcKZg37QD9K"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.215.0/LICENSE
```

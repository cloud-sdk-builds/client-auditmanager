...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.1037.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1037.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-M5V/9YBFC0D8HElgysmzzoFq46VMdcA+qJ2Qkdn70KoqU6ilJgAT+fK0XTHVkmiy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1037.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1037.0/index.min.mjs": "sha384-M5V/9YBFC0D8HElgysmzzoFq46VMdcA+qJ2Qkdn70KoqU6ilJgAT+fK0XTHVkmiy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.1037.0/LICENSE
```

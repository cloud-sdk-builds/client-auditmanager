...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.100.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.100.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/V+6aape9R2B8ro521b+vKnp6mjZ1RO8xzJdXG+n/E1aUfMS2y8/QcnDwmCTviZw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.100.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.100.0/index.min.mjs": "sha384-/V+6aape9R2B8ro521b+vKnp6mjZ1RO8xzJdXG+n/E1aUfMS2y8/QcnDwmCTviZw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.100.0/LICENSE
```

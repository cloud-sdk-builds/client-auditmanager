...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.112.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.112.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0c7j4lEAnfax75umAdWWZYC67xl4XEr3Si8MGTBcYPk9C8zZEWGKkStjFRR8Txk9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.112.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.112.0/index.min.mjs": "sha384-0c7j4lEAnfax75umAdWWZYC67xl4XEr3Si8MGTBcYPk9C8zZEWGKkStjFRR8Txk9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.112.0/LICENSE
```

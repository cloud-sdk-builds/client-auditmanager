...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.1004.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1004.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-M4nA2zeomkzNDvXvyaV7bailTJjVkdqQ3G1ZT9O2Nr44XbOuCpT95vrmGbvNZcEE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1004.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1004.0/index.min.mjs": "sha384-M4nA2zeomkzNDvXvyaV7bailTJjVkdqQ3G1ZT9O2Nr44XbOuCpT95vrmGbvNZcEE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.1004.0/LICENSE
```

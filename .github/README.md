...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.985.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.985.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hc/eRrN4STN5POKFz51iQCqWrt4xZoSy0dls7x6xjqUghFBP5a1jV2NUv0+dvBJ7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.985.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.985.0/index.min.mjs": "sha384-hc/eRrN4STN5POKFz51iQCqWrt4xZoSy0dls7x6xjqUghFBP5a1jV2NUv0+dvBJ7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.985.0/LICENSE
```

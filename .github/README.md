...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.499.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.499.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mLr4YYUQIsu1tukckSHA2+pwpxXADOF+UGv6h3AAtU1FlCwj3G5MvC9P6DHmTkgq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.499.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.499.0/index.min.mjs": "sha384-mLr4YYUQIsu1tukckSHA2+pwpxXADOF+UGv6h3AAtU1FlCwj3G5MvC9P6DHmTkgq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.499.0/LICENSE
```

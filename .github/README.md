...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.620.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.620.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ItALKCzre4pN4ky98OPutwvr6pNvvuMe3X5sPNkLXgg4xNAkehr+oXHJ9gQFvLCK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.620.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.620.0/index.min.mjs": "sha384-ItALKCzre4pN4ky98OPutwvr6pNvvuMe3X5sPNkLXgg4xNAkehr+oXHJ9gQFvLCK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.620.0/LICENSE
```

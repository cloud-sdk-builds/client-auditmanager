...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.830.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.830.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-D9tBPDyMDIWDZ+Dp2X3mDIKO1DeA1fERP5IDneDHKLxqWa6OAo2AGE8FNtBIwByF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.830.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.830.0/index.min.mjs": "sha384-D9tBPDyMDIWDZ+Dp2X3mDIKO1DeA1fERP5IDneDHKLxqWa6OAo2AGE8FNtBIwByF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.830.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.623.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.623.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hKHX+I6X8FtgFw2njucJPcYh92cY9Zmz4sBBZybiQX3sfM5OGkvKWknrpbRSbFdB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.623.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.623.0/index.min.mjs": "sha384-hKHX+I6X8FtgFw2njucJPcYh92cY9Zmz4sBBZybiQX3sfM5OGkvKWknrpbRSbFdB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.623.0/LICENSE
```

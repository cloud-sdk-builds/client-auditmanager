...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.288.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.288.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tbdLUkZSwJXyPte0XcRTZIzHh2KI/3gbUbutkzZcA+MdyVLu6uz3xuCZcWqNoRhu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.288.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.288.0/index.min.mjs": "sha384-tbdLUkZSwJXyPte0XcRTZIzHh2KI/3gbUbutkzZcA+MdyVLu6uz3xuCZcWqNoRhu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.288.0/LICENSE
```

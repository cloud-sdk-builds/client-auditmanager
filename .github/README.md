...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.846.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.846.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fH7LSkdenigNwdOMFN0HWIUG9+rMlfCHcRuOMdXs/P4n72RPEQqZEHgBy1fArDGB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.846.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.846.0/index.min.mjs": "sha384-fH7LSkdenigNwdOMFN0HWIUG9+rMlfCHcRuOMdXs/P4n72RPEQqZEHgBy1fArDGB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.846.0/LICENSE
```

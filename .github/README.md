...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.445.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.445.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8X4MoiU6K72MXqGHZI3PtGLVZcq1ah0qdGhDE0iprhBqUOzan2kYFDymif+PJl+V
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.445.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.445.0/index.min.mjs": "sha384-8X4MoiU6K72MXqGHZI3PtGLVZcq1ah0qdGhDE0iprhBqUOzan2kYFDymif+PJl+V"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.445.0/LICENSE
```

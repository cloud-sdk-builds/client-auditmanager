...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.879.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.879.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GD2zuppL6GtIJFVj9sYqr+Eml7lmS9eZKgjkkpgt8v8bUCwa3ex3iJVMfecstPps
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.879.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.879.0/index.min.mjs": "sha384-GD2zuppL6GtIJFVj9sYqr+Eml7lmS9eZKgjkkpgt8v8bUCwa3ex3iJVMfecstPps"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.879.0/LICENSE
```

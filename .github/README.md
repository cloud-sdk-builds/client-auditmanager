...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.37.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.37.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wHordD8xey/CIsAm63bv62apAaAO/yOU89uQmjZwIfLaayWO0KhhOYJ5yApcIx1e
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.37.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.37.0/index.min.mjs": "sha384-wHordD8xey/CIsAm63bv62apAaAO/yOU89uQmjZwIfLaayWO0KhhOYJ5yApcIx1e"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.37.0/LICENSE
```

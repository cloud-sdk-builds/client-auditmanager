...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.758.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.758.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bm4bkfZQnxfgbL4TEFxKYu1AGCOC7QgZkIxpNJDILOO90vC+SJHDWjWM7p7AlVBl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.758.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.758.0/index.min.mjs": "sha384-bm4bkfZQnxfgbL4TEFxKYu1AGCOC7QgZkIxpNJDILOO90vC+SJHDWjWM7p7AlVBl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.758.0/LICENSE
```

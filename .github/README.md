...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.989.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.989.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mZCZN7ZftATpPntObbD5SaB9x9U4R7mPaVvqg3DnLlbJGSablKH3GfCVpMAmRCOj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.989.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.989.0/index.min.mjs": "sha384-mZCZN7ZftATpPntObbD5SaB9x9U4R7mPaVvqg3DnLlbJGSablKH3GfCVpMAmRCOj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.989.0/LICENSE
```

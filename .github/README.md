...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.649.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.649.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gLCMqcaP7FUFA0EQfCpxIWLAYHZL/CtjOTDm6swcOKLNuwBk1kTjBwPdA1iS3M7i
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.649.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.649.0/index.min.mjs": "sha384-gLCMqcaP7FUFA0EQfCpxIWLAYHZL/CtjOTDm6swcOKLNuwBk1kTjBwPdA1iS3M7i"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.649.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.38.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.38.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vDY7MGR10LCD1Qv59GG83gc+MTYbYCR2ixSqY352yqBfA86TXhkI8od5U+VA5jUd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.38.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.38.0/index.min.mjs": "sha384-vDY7MGR10LCD1Qv59GG83gc+MTYbYCR2ixSqY352yqBfA86TXhkI8od5U+VA5jUd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.38.0/LICENSE
```

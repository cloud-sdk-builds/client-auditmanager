...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.131.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.131.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pBbgoW6QRX/LtvB5JuDxRZyvf1S4fy4UjvDFRh2KzNnbsZA0CF/WXr9WoeidrWCc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.131.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.131.0/index.min.mjs": "sha384-pBbgoW6QRX/LtvB5JuDxRZyvf1S4fy4UjvDFRh2KzNnbsZA0CF/WXr9WoeidrWCc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.131.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.199.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.199.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/M+nLmUKN74UeZsBm+j16p9b7lCFluwQlroqvfuHgsosHY27NsxCUHH507dCjMEm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.199.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.199.0/index.min.mjs": "sha384-/M+nLmUKN74UeZsBm+j16p9b7lCFluwQlroqvfuHgsosHY27NsxCUHH507dCjMEm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.199.0/LICENSE
```

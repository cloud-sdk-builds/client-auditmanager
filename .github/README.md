...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.629.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.629.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HkNhGVhLa5A5+cKbUvZdWYg4cJMBJuEPVJ/RBC+Cys8usDZHmwpRuOHzN+xEB5D7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.629.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.629.0/index.min.mjs": "sha384-HkNhGVhLa5A5+cKbUvZdWYg4cJMBJuEPVJ/RBC+Cys8usDZHmwpRuOHzN+xEB5D7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.629.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.118.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.118.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-JcSE4tCHhDzf4bhvXfjnT1TRfzVgzWHAj3r/76QEnGEZuFuhqCeu/DjrQQP4858R
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.118.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.118.1/index.min.mjs": "sha384-JcSE4tCHhDzf4bhvXfjnT1TRfzVgzWHAj3r/76QEnGEZuFuhqCeu/DjrQQP4858R"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.118.1/LICENSE
```

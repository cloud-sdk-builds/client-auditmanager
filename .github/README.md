...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.12.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.12.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/5hgVGqhN/Pa6/+FjJtmzA+SNNjzg71KAYiuPFj3PW7DYr6swWFWJM6o+mBd+Tq0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.12.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.12.0/index.min.mjs": "sha384-/5hgVGqhN/Pa6/+FjJtmzA+SNNjzg71KAYiuPFj3PW7DYr6swWFWJM6o+mBd+Tq0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.12.0/LICENSE
```

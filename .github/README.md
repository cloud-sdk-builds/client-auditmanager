...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.651.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.651.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-iIChTco44tU0CQyXfJzDAtm71Zjf1N167KJQRbB/KC93oQ58TSeI1ncgg5rwawMr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.651.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.651.1/index.min.mjs": "sha384-iIChTco44tU0CQyXfJzDAtm71Zjf1N167KJQRbB/KC93oQ58TSeI1ncgg5rwawMr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.651.1/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.965.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.965.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Bycn1A4Kwv6BgKk0ZCqJQS4iargC3U5nr9zLVE1Vy8dY8aXmfNICoEKutKaVvizO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.965.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.965.0/index.min.mjs": "sha384-Bycn1A4Kwv6BgKk0ZCqJQS4iargC3U5nr9zLVE1Vy8dY8aXmfNICoEKutKaVvizO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.965.0/LICENSE
```

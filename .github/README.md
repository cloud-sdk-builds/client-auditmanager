...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.282.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.282.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-63/+0pS5Xj8Vf3ftc7Js57SBLfAHTWDOaB2NzXd6xjJzGIc4pbcXrvzm/wYzotc2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.282.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.282.0/index.min.mjs": "sha384-63/+0pS5Xj8Vf3ftc7Js57SBLfAHTWDOaB2NzXd6xjJzGIc4pbcXrvzm/wYzotc2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.282.0/LICENSE
```

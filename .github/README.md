...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.552.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.552.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zIyfItmH8Yq6N2CSUv/Fi+b1FxuAWo0SEIE1T81jtpsU/SsU+d6QduZ9ge1Nce1w
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.552.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.552.0/index.min.mjs": "sha384-zIyfItmH8Yq6N2CSUv/Fi+b1FxuAWo0SEIE1T81jtpsU/SsU+d6QduZ9ge1Nce1w"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.552.0/LICENSE
```

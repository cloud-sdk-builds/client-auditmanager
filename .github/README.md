...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.514.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.514.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eQ8Q/yHbqfOVWGH9eZawvu47Yp7URjABv0Q7KjNXfYCioX+oHMan3bFb/LOdckOW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.514.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.514.0/index.min.mjs": "sha384-eQ8Q/yHbqfOVWGH9eZawvu47Yp7URjABv0Q7KjNXfYCioX+oHMan3bFb/LOdckOW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.514.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.930.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.930.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NO/eTrqMTgweCr4E8t4m8856tvUqlriruOtOE7JAUBwN9MS0Ibat2DxdNobtgtJh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.930.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.930.0/index.min.mjs": "sha384-NO/eTrqMTgweCr4E8t4m8856tvUqlriruOtOE7JAUBwN9MS0Ibat2DxdNobtgtJh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.930.0/LICENSE
```

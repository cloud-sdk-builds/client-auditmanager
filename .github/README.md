...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.46.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.46.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DgjzeV0UlOAxZI3fJlBxbITGYXKQXT36r2fwxjA9q/ysYrajfFtiaWPE6/toK5I8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.46.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.46.0/index.min.mjs": "sha384-DgjzeV0UlOAxZI3fJlBxbITGYXKQXT36r2fwxjA9q/ysYrajfFtiaWPE6/toK5I8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.46.0/LICENSE
```

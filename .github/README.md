...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.350.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.350.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2OTOzTeCEjJrUFqwdHo8dtW+2Yvp/jF0caoENid1B5HxedxfLUjYiDdSdr3rWVDm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.350.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.350.0/index.min.mjs": "sha384-2OTOzTeCEjJrUFqwdHo8dtW+2Yvp/jF0caoENid1B5HxedxfLUjYiDdSdr3rWVDm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.350.0/LICENSE
```

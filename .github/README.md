...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.678.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.678.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-A8o5vlg/uvtJT+N+4VAhtRMMx2t5BEof3QBdqOvc98pf7MN3HXVTVNfL/2tBCNCy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.678.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.678.0/index.min.mjs": "sha384-A8o5vlg/uvtJT+N+4VAhtRMMx2t5BEof3QBdqOvc98pf7MN3HXVTVNfL/2tBCNCy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.678.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.328.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.328.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8/2c1Y9lwRvBxF+sXCvPtiiKxoCRyS3ajnQIAawS4m1FvEYIm5ikmqNP3Np3cVyJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.328.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.328.0/index.min.mjs": "sha384-8/2c1Y9lwRvBxF+sXCvPtiiKxoCRyS3ajnQIAawS4m1FvEYIm5ikmqNP3Np3cVyJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.328.0/LICENSE
```

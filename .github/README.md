...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.1001.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1001.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-u32dkoSOrey7sJllp+by8w5+jx1EZPEHP+QQtsxoTV7olg4udLFDcR7qR05mR7EJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1001.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1001.0/index.min.mjs": "sha384-u32dkoSOrey7sJllp+by8w5+jx1EZPEHP+QQtsxoTV7olg4udLFDcR7qR05mR7EJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.1001.0/LICENSE
```

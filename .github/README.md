...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.964.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.964.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BJW5v7Hby9mwD/mTjWsbaxRHIMIb0LLhadixqARv+KNix9C4W4rvMe92FmXjBXnl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.964.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.964.0/index.min.mjs": "sha384-BJW5v7Hby9mwD/mTjWsbaxRHIMIb0LLhadixqARv+KNix9C4W4rvMe92FmXjBXnl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.964.0/LICENSE
```

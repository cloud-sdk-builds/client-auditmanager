...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.948.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.948.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qGClph4r9iUD/bYtT7FlJbDwwXlLBwUJnuHxkU+Q5EzV2+3/xb3Hp7pwOhYRjhvP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.948.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.948.0/index.min.mjs": "sha384-qGClph4r9iUD/bYtT7FlJbDwwXlLBwUJnuHxkU+Q5EzV2+3/xb3Hp7pwOhYRjhvP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.948.0/LICENSE
```

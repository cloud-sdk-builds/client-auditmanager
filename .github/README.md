...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.883.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.883.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qU+7xYhCnaq7A9VcsWCMoBHGrlIqAz9F3ANtHUQwuE9OfflHwX757MUjgVs8Zcrs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.883.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.883.0/index.min.mjs": "sha384-qU+7xYhCnaq7A9VcsWCMoBHGrlIqAz9F3ANtHUQwuE9OfflHwX757MUjgVs8Zcrs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.883.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.664.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.664.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mAzmxa2ZvEYtCfsEEWw6xt8VIBY6Brwk2SzIYvLRhmqFrVqe9/evW9+IwBzJuJvN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.664.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.664.0/index.min.mjs": "sha384-mAzmxa2ZvEYtCfsEEWw6xt8VIBY6Brwk2SzIYvLRhmqFrVqe9/evW9+IwBzJuJvN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.664.0/LICENSE
```

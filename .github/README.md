...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.48.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.48.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Xs8Sh4rt8LkNozZY5htc3XlPnjmmWDqBJwGExURq+UdHCCGVIigWuZEkDNlA6F8P
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.48.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.48.0/index.min.mjs": "sha384-Xs8Sh4rt8LkNozZY5htc3XlPnjmmWDqBJwGExURq+UdHCCGVIigWuZEkDNlA6F8P"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.48.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.141.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.141.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8OWajgIa+O5yLFQrWafyro230V7aLBLaU0JYBEl1efIzT2Zv21P6SlSBNPtQbCxa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.141.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.141.0/index.min.mjs": "sha384-8OWajgIa+O5yLFQrWafyro230V7aLBLaU0JYBEl1efIzT2Zv21P6SlSBNPtQbCxa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.141.0/LICENSE
```

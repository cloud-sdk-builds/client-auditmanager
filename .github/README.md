...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.994.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.994.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FkIsOuYOS4SPQK9uOFI3Bc39Y7JeGWQsWKcExC75JhEIt7R2hbZ4W9+qTd2LrVC4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.994.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.994.0/index.min.mjs": "sha384-FkIsOuYOS4SPQK9uOFI3Bc39Y7JeGWQsWKcExC75JhEIt7R2hbZ4W9+qTd2LrVC4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.994.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.441.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.441.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KKHnNHDKCJAymrUawRk/bKTbFWT8SzDrtDii00yK/9IXvTQm6R0C8ICucgIpd9W/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.441.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.441.0/index.min.mjs": "sha384-KKHnNHDKCJAymrUawRk/bKTbFWT8SzDrtDii00yK/9IXvTQm6R0C8ICucgIpd9W/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.441.0/LICENSE
```

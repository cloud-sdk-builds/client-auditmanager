...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.211.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.211.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6eeAIGS8i4/FUdvlTkMzpRWMr7LlXeKRc0Wf7ydNOyVvukI5iOivv+2nh0USwHFL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.211.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.211.0/index.min.mjs": "sha384-6eeAIGS8i4/FUdvlTkMzpRWMr7LlXeKRc0Wf7ydNOyVvukI5iOivv+2nh0USwHFL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.211.0/LICENSE
```

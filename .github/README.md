...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.387.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.387.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-44RL75fb/sGlNzzhokvsLEVh38K7epT82cqA7VcVe/joR+wcngTe1qPfzmKwhz+A
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.387.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.387.0/index.min.mjs": "sha384-44RL75fb/sGlNzzhokvsLEVh38K7epT82cqA7VcVe/joR+wcngTe1qPfzmKwhz+A"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.387.0/LICENSE
```

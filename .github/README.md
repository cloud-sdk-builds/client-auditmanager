...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.95.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.95.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PD4lKAk2FpE4ZODfG3+k9ChNi9cuk1N4rlW/lSJCPOPDlakunSMbRtVO1vDxQZ+6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.95.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.95.0/index.min.mjs": "sha384-PD4lKAk2FpE4ZODfG3+k9ChNi9cuk1N4rlW/lSJCPOPDlakunSMbRtVO1vDxQZ+6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.95.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.844.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.844.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rBlVTChKZZn5HBMm3zm8GdQ8PRdtQFrH6AXCoi9/oQUWvB83hyMHEmSMnZS89cJq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.844.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.844.0/index.min.mjs": "sha384-rBlVTChKZZn5HBMm3zm8GdQ8PRdtQFrH6AXCoi9/oQUWvB83hyMHEmSMnZS89cJq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.844.0/LICENSE
```

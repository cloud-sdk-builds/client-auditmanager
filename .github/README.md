...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.864.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.864.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aohmk6VUGMbiGLYXEakRKRTpcX8Cf/gxPUgpZpecHl4LNfiCUKCwHS0Iwbd+12K7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.864.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.864.0/index.min.mjs": "sha384-aohmk6VUGMbiGLYXEakRKRTpcX8Cf/gxPUgpZpecHl4LNfiCUKCwHS0Iwbd+12K7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.864.0/LICENSE
```

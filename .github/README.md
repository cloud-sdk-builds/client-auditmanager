...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.622.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.622.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-M2VCyDbyY9DJRRffpFLimrJVxve6u4qUgCwN1ekq0Otcrkj33+b4mL2yfexuYdpP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.622.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.622.0/index.min.mjs": "sha384-M2VCyDbyY9DJRRffpFLimrJVxve6u4qUgCwN1ekq0Otcrkj33+b4mL2yfexuYdpP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.622.0/LICENSE
```

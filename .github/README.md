...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.297.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.297.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ds4Gz2j0cIU2eqlQxs4WNJOUTyTbAP08wvwDrt9M1ECBMOUvH1wp2+GosvdIWPbn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.297.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.297.0/index.min.mjs": "sha384-ds4Gz2j0cIU2eqlQxs4WNJOUTyTbAP08wvwDrt9M1ECBMOUvH1wp2+GosvdIWPbn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.297.0/LICENSE
```

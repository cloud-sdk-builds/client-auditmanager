...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.6.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.6.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gVo9/owJHV9INXLp+dDTL3GH0CtdrW95hEaJC0a/XCobgMIByQfeGyVuxvSqVwCa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.6.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.6.0/index.min.mjs": "sha384-gVo9/owJHV9INXLp+dDTL3GH0CtdrW95hEaJC0a/XCobgMIByQfeGyVuxvSqVwCa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.6.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.845.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.845.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-t3LtfniHQU0qglquebIo8juqX3EVJC8MgeWEaSAikBK/GLNyrvmHh8PbEfKasqXe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.845.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.845.0/index.min.mjs": "sha384-t3LtfniHQU0qglquebIo8juqX3EVJC8MgeWEaSAikBK/GLNyrvmHh8PbEfKasqXe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.845.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.999.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.999.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rR+q1wjC5C7wFqMhC+td0w+uFIcmBOJCR2QD3izQ2ZNOAsKsyF0wKIiT3SGj9a0W
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.999.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.999.0/index.min.mjs": "sha384-rR+q1wjC5C7wFqMhC+td0w+uFIcmBOJCR2QD3izQ2ZNOAsKsyF0wKIiT3SGj9a0W"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.999.0/LICENSE
```

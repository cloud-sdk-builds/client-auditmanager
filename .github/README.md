...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.16.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.16.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5LjoYwk9Ea64Iu2+G/OwvuV50igpAOn0ypPTjAU/rgmkOkC3fydTbK7SY22X3ujo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.16.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.16.0/index.min.mjs": "sha384-5LjoYwk9Ea64Iu2+G/OwvuV50igpAOn0ypPTjAU/rgmkOkC3fydTbK7SY22X3ujo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.16.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.914.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.914.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-K9UZB3YiD4Q5MXvSoHpS4nypOlp8OVlSP1ZXBG+h+k6dRjXqkafxtTD/yTuZSxXl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.914.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.914.0/index.min.mjs": "sha384-K9UZB3YiD4Q5MXvSoHpS4nypOlp8OVlSP1ZXBG+h+k6dRjXqkafxtTD/yTuZSxXl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.914.0/LICENSE
```

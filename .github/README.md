...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.290.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.290.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gfb6Syx7uUeLkaiu6QlOsHX+pfwGo7QHJkHeRfkIcxDW8RnpUcrjeUG6QEgQDfYm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.290.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.290.0/index.min.mjs": "sha384-gfb6Syx7uUeLkaiu6QlOsHX+pfwGo7QHJkHeRfkIcxDW8RnpUcrjeUG6QEgQDfYm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.290.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.72.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.72.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+5iW8jq02Uc6PIuFql/pkEFbEPNEqGaQVKxQLZp/uWHcfqzVWOVTwIOhQ+ExwjWb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.72.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.72.0/index.min.mjs": "sha384-+5iW8jq02Uc6PIuFql/pkEFbEPNEqGaQVKxQLZp/uWHcfqzVWOVTwIOhQ+ExwjWb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.72.0/LICENSE
```

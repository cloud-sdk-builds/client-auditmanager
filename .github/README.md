...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.347.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.347.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sAoCV7s/fkdoIS5I7NE9YnB/fakZZKHphpPDMOG/+hTwTlSdUJSKgAsCOKv5aldk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.347.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.347.0/index.min.mjs": "sha384-sAoCV7s/fkdoIS5I7NE9YnB/fakZZKHphpPDMOG/+hTwTlSdUJSKgAsCOKv5aldk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.347.0/LICENSE
```

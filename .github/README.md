...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.109.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.109.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AyZuJHO7VPvtlEcMhFrE+Z/pJ+qxZ0QurL6UyGpFlRaDNbrBeXjDoejZT0dM7TVc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.109.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.109.0/index.min.mjs": "sha384-AyZuJHO7VPvtlEcMhFrE+Z/pJ+qxZ0QurL6UyGpFlRaDNbrBeXjDoejZT0dM7TVc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.109.0/LICENSE
```

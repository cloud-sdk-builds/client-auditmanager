...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.895.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.895.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/UzFheKPeCoOUW7k1stKtLfsftIoaId3S5BKrVorVrx1NRupwLS3eNtVT6J0O2sM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.895.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.895.0/index.min.mjs": "sha384-/UzFheKPeCoOUW7k1stKtLfsftIoaId3S5BKrVorVrx1NRupwLS3eNtVT6J0O2sM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.895.0/LICENSE
```

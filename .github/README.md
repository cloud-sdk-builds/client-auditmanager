...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.306.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.306.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jP8wov6yUS2ZNm3vGGzszM3PiepiL/hnnkjTEgJ872XlhvmN9e1Bcu+bzsRRRp8q
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.306.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.306.0/index.min.mjs": "sha384-jP8wov6yUS2ZNm3vGGzszM3PiepiL/hnnkjTEgJ872XlhvmN9e1Bcu+bzsRRRp8q"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.306.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.92.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.92.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4VmAZGU7M7r0xlPZ5s1OqzCgjGFUWF7WNHDr98W31xgGzYxaBsgk1E4/IlpOCyW9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.92.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.92.0/index.min.mjs": "sha384-4VmAZGU7M7r0xlPZ5s1OqzCgjGFUWF7WNHDr98W31xgGzYxaBsgk1E4/IlpOCyW9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.92.0/LICENSE
```

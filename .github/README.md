...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.1014.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1014.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oHg7vCNb873te3xnrZfmHqNquBSdlbg4eZX/og6eYqurrG/fjbTgyj2fDdfkPlkI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1014.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1014.0/index.min.mjs": "sha384-oHg7vCNb873te3xnrZfmHqNquBSdlbg4eZX/og6eYqurrG/fjbTgyj2fDdfkPlkI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.1014.0/LICENSE
```

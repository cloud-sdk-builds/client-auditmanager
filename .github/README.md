...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.816.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.816.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-q+9S4VCo0dOg1qI3fxvwGShfNZTNhgVScdY1N2xIODCW39pfOEaoAxUzJQtEp4tv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.816.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.816.0/index.min.mjs": "sha384-q+9S4VCo0dOg1qI3fxvwGShfNZTNhgVScdY1N2xIODCW39pfOEaoAxUzJQtEp4tv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.816.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.821.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.821.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aqjSseTHraw9e3PTcW7RuVUmRUpw4HfeCT0E5OjFEZ2vUO7PMzY4N8p/WEIIUNZ/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.821.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.821.0/index.min.mjs": "sha384-aqjSseTHraw9e3PTcW7RuVUmRUpw4HfeCT0E5OjFEZ2vUO7PMzY4N8p/WEIIUNZ/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.821.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.56.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.56.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Dwz3uXcjS8lVgj4vcQCfcEiRryY/COpERJDPPiC5/RE0ZyhjPkQEDwKUFXY24yzZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.56.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.56.0/index.min.mjs": "sha384-Dwz3uXcjS8lVgj4vcQCfcEiRryY/COpERJDPPiC5/RE0ZyhjPkQEDwKUFXY24yzZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.56.0/LICENSE
```

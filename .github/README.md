...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.449.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.449.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BZnGTihFN/dLyOqtw2Z0NI4rcsz8RDPmE55iPPNxSGQDnvdclFECqpSHMNLZtCPf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.449.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.449.0/index.min.mjs": "sha384-BZnGTihFN/dLyOqtw2Z0NI4rcsz8RDPmE55iPPNxSGQDnvdclFECqpSHMNLZtCPf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.449.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.600.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.600.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-U8XK2+kc2kyHY5Xu2uU/mmmtDEUCJKyiJzk1ey5Bi2Uriwg6MgsMS0AtlyoF6NFz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.600.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.600.0/index.min.mjs": "sha384-U8XK2+kc2kyHY5Xu2uU/mmmtDEUCJKyiJzk1ey5Bi2Uriwg6MgsMS0AtlyoF6NFz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.600.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.181.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.181.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PByUj+Y1QAprBiA9qrpbUI/Dohb6B+Lp89FKGRGHBMq61X0JTI4pg5u7xI/29kkq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.181.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.181.0/index.min.mjs": "sha384-PByUj+Y1QAprBiA9qrpbUI/Dohb6B+Lp89FKGRGHBMq61X0JTI4pg5u7xI/29kkq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.181.0/LICENSE
```

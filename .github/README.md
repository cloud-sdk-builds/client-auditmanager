...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.962.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.962.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DOxIu2gWUYKTnwMkfgqrXxP5ORCgC4MC6UxrJQ+3Fid26orB/Qjs9uoHJLB8GLtY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.962.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.962.0/index.min.mjs": "sha384-DOxIu2gWUYKTnwMkfgqrXxP5ORCgC4MC6UxrJQ+3Fid26orB/Qjs9uoHJLB8GLtY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.962.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.31.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.31.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FwJeDrK8UTotPH6G+dpkPO+qSPkNaFDWvyyc9KtP3rW5wkMmuIKqVXDCK4hohM8t
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.31.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.31.0/index.min.mjs": "sha384-FwJeDrK8UTotPH6G+dpkPO+qSPkNaFDWvyyc9KtP3rW5wkMmuIKqVXDCK4hohM8t"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.31.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.256.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.256.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZbsHzs04XOcEWUh/xHq266oWLRMlBQCmmwg3hyH5r8cD5t9oEWTWqyqIee7Jn2UH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.256.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.256.0/index.min.mjs": "sha384-ZbsHzs04XOcEWUh/xHq266oWLRMlBQCmmwg3hyH5r8cD5t9oEWTWqyqIee7Jn2UH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.256.0/LICENSE
```

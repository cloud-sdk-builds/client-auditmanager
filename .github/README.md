...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.386.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.386.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eFIZtKErAk2cGs1unDBrNmArGr+Nsgh1iwdRwg86YtNN5LXj/IcCfh4JcsR4P5De
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.386.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.386.0/index.min.mjs": "sha384-eFIZtKErAk2cGs1unDBrNmArGr+Nsgh1iwdRwg86YtNN5LXj/IcCfh4JcsR4P5De"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.386.0/LICENSE
```

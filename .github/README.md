...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.1011.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1011.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-i0cXRH9foln1qzbx9VCPtSJq4CJHYFB7sLGjC9OIhNxl+uTllN8mOh6k8SAFSfnc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1011.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1011.0/index.min.mjs": "sha384-i0cXRH9foln1qzbx9VCPtSJq4CJHYFB7sLGjC9OIhNxl+uTllN8mOh6k8SAFSfnc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.1011.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.429.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.429.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-C1P6+vm+yzbOCzRPhm4Xgu+129mnAe20k+4rJwZtMB+dDXE+RiFencTmVAFYGueI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.429.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.429.0/index.min.mjs": "sha384-C1P6+vm+yzbOCzRPhm4Xgu+129mnAe20k+4rJwZtMB+dDXE+RiFencTmVAFYGueI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.429.0/LICENSE
```

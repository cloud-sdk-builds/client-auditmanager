...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.513.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.513.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-R7cml2s4cgDK1+uke+fqe7fAUtg6/1EjGNh3HFh3psYms3YPpVkhQ7SpJGmo0Pd3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.513.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.513.0/index.min.mjs": "sha384-R7cml2s4cgDK1+uke+fqe7fAUtg6/1EjGNh3HFh3psYms3YPpVkhQ7SpJGmo0Pd3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.513.0/LICENSE
```

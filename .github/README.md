...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.161.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.161.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rnl40JEHRG1XyuCZYDL7h7tX7mNAUUxfet3DPcd+bv19Ii3rPycFnJfCWYRyfSOC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.161.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.161.0/index.min.mjs": "sha384-rnl40JEHRG1XyuCZYDL7h7tX7mNAUUxfet3DPcd+bv19Ii3rPycFnJfCWYRyfSOC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.161.0/LICENSE
```

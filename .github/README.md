...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.254.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.254.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KKUMF/g5wwdembdJn/b2k1MaC/GZAlxU4dKOwTw5QKHwPaJZY6VPpwSTZ0PSiFWj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.254.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.254.0/index.min.mjs": "sha384-KKUMF/g5wwdembdJn/b2k1MaC/GZAlxU4dKOwTw5QKHwPaJZY6VPpwSTZ0PSiFWj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.254.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.378.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.378.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-iMwkNRZ/B5G4ooXg7TSFKsELN1zCPMbaON5Jfwt/UkIZ0nuKpnVHb4dlACna1205
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.378.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.378.0/index.min.mjs": "sha384-iMwkNRZ/B5G4ooXg7TSFKsELN1zCPMbaON5Jfwt/UkIZ0nuKpnVHb4dlACna1205"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.378.0/LICENSE
```

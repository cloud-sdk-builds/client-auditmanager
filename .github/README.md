...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.3.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.3.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rUFbxuj7DXMx/kY88/SGobYel7gvTvaKXqF8a7pgxESTYdnbn0EmbOhOV89RQLW7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.3.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.3.0/index.min.mjs": "sha384-rUFbxuj7DXMx/kY88/SGobYel7gvTvaKXqF8a7pgxESTYdnbn0EmbOhOV89RQLW7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.3.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.774.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.774.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DX0noJh8iwbrRxhJGmPGR7fornJy76CNxXltElsrwTs5N6ztUZ0ZQst7Fhc7waL9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.774.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.774.0/index.min.mjs": "sha384-DX0noJh8iwbrRxhJGmPGR7fornJy76CNxXltElsrwTs5N6ztUZ0ZQst7Fhc7waL9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.774.0/LICENSE
```

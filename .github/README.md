...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.971.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.971.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1qYR6REjLVhqbCe7a6VspG8BS/1+cXALF9VAFRx7WhTty1DErO0AkazUaCb6Hzht
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.971.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.971.0/index.min.mjs": "sha384-1qYR6REjLVhqbCe7a6VspG8BS/1+cXALF9VAFRx7WhTty1DErO0AkazUaCb6Hzht"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.971.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.345.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.345.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zd5F6mN48Rvz2uSyZZo4TNd8ZLQEJvwp/ukXTI//rvQMsKjnHs+WVdH7/9gMsOfR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.345.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.345.0/index.min.mjs": "sha384-zd5F6mN48Rvz2uSyZZo4TNd8ZLQEJvwp/ukXTI//rvQMsKjnHs+WVdH7/9gMsOfR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.345.0/LICENSE
```

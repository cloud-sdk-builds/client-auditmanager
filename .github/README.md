...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.99.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.99.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JvJ6k7dmVhZ0yt8uNRvzZhBPdDXySIvVzP2p7wDsUFx4A4jk8UUSmzT/90vXLA/f
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.99.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.99.0/index.min.mjs": "sha384-JvJ6k7dmVhZ0yt8uNRvzZhBPdDXySIvVzP2p7wDsUFx4A4jk8UUSmzT/90vXLA/f"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.99.0/LICENSE
```

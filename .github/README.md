...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.699.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.699.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bKNCZ2zJ0TIl3kmN0ucasm2vX1wekun7G50f5yCERBZyOlLYYM0Dkqsdg3BwviRc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.699.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.699.0/index.min.mjs": "sha384-bKNCZ2zJ0TIl3kmN0ucasm2vX1wekun7G50f5yCERBZyOlLYYM0Dkqsdg3BwviRc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.699.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.980.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.980.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MKIL8nicYEaTDuCQkxbJlwPahIplSkqgwoGHI7UwIOS4TG/4KSz50bNAlwi2GgIn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.980.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.980.0/index.min.mjs": "sha384-MKIL8nicYEaTDuCQkxbJlwPahIplSkqgwoGHI7UwIOS4TG/4KSz50bNAlwi2GgIn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.980.0/LICENSE
```

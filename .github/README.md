...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.669.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.669.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-G/kYDnk9546mAehA//G2cuzGDYsRS0MBSTD9lywto0lvyLGl5KXvLb3v62MUOhRl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.669.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.669.0/index.min.mjs": "sha384-G/kYDnk9546mAehA//G2cuzGDYsRS0MBSTD9lywto0lvyLGl5KXvLb3v62MUOhRl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.669.0/LICENSE
```

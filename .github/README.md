...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.35.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.35.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-urBVRnc34MVvEt+ysyOxS7YzQy3v9yrMTRBcvgAk6+JNEfCrcgpmhnpVjKbquK5R
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.35.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.35.0/index.min.mjs": "sha384-urBVRnc34MVvEt+ysyOxS7YzQy3v9yrMTRBcvgAk6+JNEfCrcgpmhnpVjKbquK5R"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.35.0/LICENSE
```

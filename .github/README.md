...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.873.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.873.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tbiNVyOV1gyOthZBV0ts19FVKBkg7rmKGkJ7mIQb35LgokViKLSpRHJ1JVzlh1R/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.873.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.873.0/index.min.mjs": "sha384-tbiNVyOV1gyOthZBV0ts19FVKBkg7rmKGkJ7mIQb35LgokViKLSpRHJ1JVzlh1R/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.873.0/LICENSE
```

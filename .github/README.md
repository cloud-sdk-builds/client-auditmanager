...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.525.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.525.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UdsjQn2TETPuDWf5HKDq7yozP5tHw3rMZH6cPU39lj9YyspGkPoXBj2bnh7pqeak
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.525.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.525.0/index.min.mjs": "sha384-UdsjQn2TETPuDWf5HKDq7yozP5tHw3rMZH6cPU39lj9YyspGkPoXBj2bnh7pqeak"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.525.0/LICENSE
```

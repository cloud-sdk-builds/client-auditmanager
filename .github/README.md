...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.264.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.264.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-M0PHOmRaJw09cXZSQY7SyuFw+Gk8NwSTplUgV/jkudbz/MydxyOoCqC8hTprmkL4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.264.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.264.0/index.min.mjs": "sha384-M0PHOmRaJw09cXZSQY7SyuFw+Gk8NwSTplUgV/jkudbz/MydxyOoCqC8hTprmkL4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.264.0/LICENSE
```

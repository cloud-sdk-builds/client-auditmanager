...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.1040.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1040.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PGuQ8FT+eZ44/MypwTpk+rZInb+67kmn2A5K5kmW2/Kwx4WCcPGWJUX4dyGW6Zej
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1040.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1040.0/index.min.mjs": "sha384-PGuQ8FT+eZ44/MypwTpk+rZInb+67kmn2A5K5kmW2/Kwx4WCcPGWJUX4dyGW6Zej"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.1040.0/LICENSE
```

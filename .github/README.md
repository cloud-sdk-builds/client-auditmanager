...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.955.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.955.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XykutFRv6uEhY1pAaE8fw0T0tQlWdPxrA5T8uBotuP7DnTdZMhkXvdYXeoWs2odP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.955.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.955.0/index.min.mjs": "sha384-XykutFRv6uEhY1pAaE8fw0T0tQlWdPxrA5T8uBotuP7DnTdZMhkXvdYXeoWs2odP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.955.0/LICENSE
```

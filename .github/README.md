...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.798.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.798.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AF2rHRvasGt08Rfj6+34xD6aaFtDaiXhalL/WBDjf3LJh9+3WxR6q0MhjWXenpHb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.798.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.798.0/index.min.mjs": "sha384-AF2rHRvasGt08Rfj6+34xD6aaFtDaiXhalL/WBDjf3LJh9+3WxR6q0MhjWXenpHb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.798.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.620.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.620.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-IjRUm7l/ymvccaOmbG8Xrg3+5vtwj/f7caFbvAhjHPVwELO+vaqkgA9U/dSRNwnq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.620.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.620.1/index.min.mjs": "sha384-IjRUm7l/ymvccaOmbG8Xrg3+5vtwj/f7caFbvAhjHPVwELO+vaqkgA9U/dSRNwnq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.620.1/LICENSE
```

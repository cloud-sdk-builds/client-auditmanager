...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.540.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.540.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pkfho33yRp9Xj30CEeq6QbzBuEUE3NZiVW/cdWlcxE5TLUnKp02vXIyli1vcq/B5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.540.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.540.0/index.min.mjs": "sha384-pkfho33yRp9Xj30CEeq6QbzBuEUE3NZiVW/cdWlcxE5TLUnKp02vXIyli1vcq/B5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.540.0/LICENSE
```

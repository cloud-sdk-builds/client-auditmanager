...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.997.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.997.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-G8OZPyOPtihfp+vfRXWNAXASs0IwhLjSAYBQ5ogOcrAPeFv5wfdfc/0TEIwm20ty
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.997.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.997.0/index.min.mjs": "sha384-G8OZPyOPtihfp+vfRXWNAXASs0IwhLjSAYBQ5ogOcrAPeFv5wfdfc/0TEIwm20ty"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.997.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.613.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.613.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ulfLy7Guvdlh+nPsup+ZS5i9N9PHdHzo14dGPE+FA2KEQ3mprsYsBqCmOS1qGFhz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.613.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.613.0/index.min.mjs": "sha384-ulfLy7Guvdlh+nPsup+ZS5i9N9PHdHzo14dGPE+FA2KEQ3mprsYsBqCmOS1qGFhz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.613.0/LICENSE
```

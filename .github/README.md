...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.921.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.921.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ij16sZ93wzxJOX2IGJu8nSAOLksuBlgUMK4IezIbGk6HMDbDNak52nnV/PfgPz+T
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.921.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.921.0/index.min.mjs": "sha384-ij16sZ93wzxJOX2IGJu8nSAOLksuBlgUMK4IezIbGk6HMDbDNak52nnV/PfgPz+T"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.921.0/LICENSE
```

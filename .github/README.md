...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.17.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.17.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5SE4sqOsxfALJ+HmKybtx6ztZXaLK9lhZBUEZCTpvkGjJjyxhkYjoynXfNs/QnVO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.17.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.17.0/index.min.mjs": "sha384-5SE4sqOsxfALJ+HmKybtx6ztZXaLK9lhZBUEZCTpvkGjJjyxhkYjoynXfNs/QnVO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.17.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.281.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.281.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-I5MYKcNfjJkFz5T6ChPbFkMLyGWTJQbTw+vmImH4wJ8dNSoKp+R+JwlsvHczMJ3q
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.281.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.281.0/index.min.mjs": "sha384-I5MYKcNfjJkFz5T6ChPbFkMLyGWTJQbTw+vmImH4wJ8dNSoKp+R+JwlsvHczMJ3q"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.281.0/LICENSE
```

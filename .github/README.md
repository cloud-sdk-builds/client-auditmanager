...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.507.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.507.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NBj1Qkw7arcpMv9gdU0tvINcPqilVMuccOqQG5tQY3dh6uoUdZP43So/bXf+E12F
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.507.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.507.0/index.min.mjs": "sha384-NBj1Qkw7arcpMv9gdU0tvINcPqilVMuccOqQG5tQY3dh6uoUdZP43So/bXf+E12F"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.507.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.165.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.165.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jpKUgPJ7BDZdLd9h1xQPT4igqsWkErDlunYHLvmgGhu6UYYIZ4d4rJp0OA+TgD+9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.165.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.165.0/index.min.mjs": "sha384-jpKUgPJ7BDZdLd9h1xQPT4igqsWkErDlunYHLvmgGhu6UYYIZ4d4rJp0OA+TgD+9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.165.0/LICENSE
```

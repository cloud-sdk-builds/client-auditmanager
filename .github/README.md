...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.535.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.535.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-z/mV/fg+vDFZg29NvfSLnsJfK8oXgq3ypBch/Q4+BTGjzUbs9QKp8zfUjdrG5yx1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.535.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.535.0/index.min.mjs": "sha384-z/mV/fg+vDFZg29NvfSLnsJfK8oXgq3ypBch/Q4+BTGjzUbs9QKp8zfUjdrG5yx1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.535.0/LICENSE
```

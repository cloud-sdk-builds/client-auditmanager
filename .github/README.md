...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.293.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.293.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hBdGn2O7OFLVu/4S3AMi42FKFJFnhR9sIsmweXjzWY1ctezWMCHUIxtQSPP/aoXq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.293.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.293.0/index.min.mjs": "sha384-hBdGn2O7OFLVu/4S3AMi42FKFJFnhR9sIsmweXjzWY1ctezWMCHUIxtQSPP/aoXq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.293.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.294.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.294.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Gxm5nkSPwdmeYFC1TaosBRAywcP/wHDM7Y4hcWbVbmtn8+Y7UOnVTyAyLYxCDU12
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.294.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.294.0/index.min.mjs": "sha384-Gxm5nkSPwdmeYFC1TaosBRAywcP/wHDM7Y4hcWbVbmtn8+Y7UOnVTyAyLYxCDU12"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.294.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.616.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.616.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+oBwLKlLxItbgU6Wqhjmb964xsGztDVwDMklahJ+u1h6htlfE3gJ7T6qOElWNPtI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.616.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.616.0/index.min.mjs": "sha384-+oBwLKlLxItbgU6Wqhjmb964xsGztDVwDMklahJ+u1h6htlfE3gJ7T6qOElWNPtI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.616.0/LICENSE
```

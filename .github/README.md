...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.569.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.569.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Bv4lzKv6sBBLwadxRvDuoAmlfXQd8vwWwTRzssw+x6B3pXusHL8+nj0Jb2vd8Rzi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.569.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.569.0/index.min.mjs": "sha384-Bv4lzKv6sBBLwadxRvDuoAmlfXQd8vwWwTRzssw+x6B3pXusHL8+nj0Jb2vd8Rzi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.569.0/LICENSE
```

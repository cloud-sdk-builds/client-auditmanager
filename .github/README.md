...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.713.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.713.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HEH0BQ6fh2aoHOtQC5V5rOeauuRiNNDa1otxSIh1aROwoKZiiAriUU2dQgJVmXoZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.713.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.713.0/index.min.mjs": "sha384-HEH0BQ6fh2aoHOtQC5V5rOeauuRiNNDa1otxSIh1aROwoKZiiAriUU2dQgJVmXoZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.713.0/LICENSE
```

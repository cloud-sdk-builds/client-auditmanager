...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.730.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.730.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KpzR4Mp3Ognt/DXud8YPapqdPW7b/AvEpVYBhT53VeqV0WyL30wrxLY0DB9Er473
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.730.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.730.0/index.min.mjs": "sha384-KpzR4Mp3Ognt/DXud8YPapqdPW7b/AvEpVYBhT53VeqV0WyL30wrxLY0DB9Er473"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.730.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.130.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.130.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-86OeFEbo7bwEi0kf4oFMxB3GXCtSuOAW1yAggv3sSXOA8y9vqBM+Q/l4HLi3K7i3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.130.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.130.0/index.min.mjs": "sha384-86OeFEbo7bwEi0kf4oFMxB3GXCtSuOAW1yAggv3sSXOA8y9vqBM+Q/l4HLi3K7i3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.130.0/LICENSE
```

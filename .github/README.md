...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.572.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.572.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+PwzqJmyVP/ClTB57w181Q8cKbotw5WxjmF2e5ck7NCuUTKk0Lv+M1t2f77UTx7y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.572.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.572.0/index.min.mjs": "sha384-+PwzqJmyVP/ClTB57w181Q8cKbotw5WxjmF2e5ck7NCuUTKk0Lv+M1t2f77UTx7y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.572.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.11.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.11.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2bYLmgncIXO9TglCwnqKZZlhy4s0Ctiq8fEvuTBiVulyHyqxfVfWO8n8Xp3W6sV1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.11.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.11.0/index.min.mjs": "sha384-2bYLmgncIXO9TglCwnqKZZlhy4s0Ctiq8fEvuTBiVulyHyqxfVfWO8n8Xp3W6sV1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.11.0/LICENSE
```

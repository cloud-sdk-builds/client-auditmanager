...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.75.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.75.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CkLc3B+BoidoLh8c4x/MQTZ7jB3MamuTCFnvcNy06VlVxQH/B1kcz25kPH57xi7Q
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.75.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.75.0/index.min.mjs": "sha384-CkLc3B+BoidoLh8c4x/MQTZ7jB3MamuTCFnvcNy06VlVxQH/B1kcz25kPH57xi7Q"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.75.0/LICENSE
```

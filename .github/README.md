...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.523.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.523.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xbtaXVv0sGLrwnVw8fF36CQGXsxqoqV/O5xrbPURE3Rlv7NEej+1KHUyNf2GvaRB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.523.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.523.0/index.min.mjs": "sha384-xbtaXVv0sGLrwnVw8fF36CQGXsxqoqV/O5xrbPURE3Rlv7NEej+1KHUyNf2GvaRB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.523.0/LICENSE
```

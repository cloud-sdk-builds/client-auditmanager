...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.121.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.121.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ejkb6xj7B2Z4YJ9OWGC98rM6TZ7zt1cYOnrJEg915F+sKNTy0dDSa+wszuzf2OS3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.121.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.121.0/index.min.mjs": "sha384-Ejkb6xj7B2Z4YJ9OWGC98rM6TZ7zt1cYOnrJEg915F+sKNTy0dDSa+wszuzf2OS3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.121.0/LICENSE
```

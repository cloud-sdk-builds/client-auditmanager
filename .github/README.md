...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.956.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.956.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-iAdEKTSmw/dUejcuahBtOOh2I+r+5UYygoafiWVYMlP2gpNjsa8V26J7kw8+99Ol
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.956.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.956.0/index.min.mjs": "sha384-iAdEKTSmw/dUejcuahBtOOh2I+r+5UYygoafiWVYMlP2gpNjsa8V26J7kw8+99Ol"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.956.0/LICENSE
```

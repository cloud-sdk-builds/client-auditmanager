...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.229.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.229.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pKkwbjQ84nUuOu3/N+TwZlTIXPpzNn1n3VucXBglQ2IEWPesFI2ngbXZSohBtDe+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.229.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.229.0/index.min.mjs": "sha384-pKkwbjQ84nUuOu3/N+TwZlTIXPpzNn1n3VucXBglQ2IEWPesFI2ngbXZSohBtDe+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.229.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.658.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.658.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QyyBLooGon8kyeEMv93oCNQI2PVmSWOnPkfrEdAdS9iSmiIzqmh6CmmdgvZt1WC5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.658.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.658.0/index.min.mjs": "sha384-QyyBLooGon8kyeEMv93oCNQI2PVmSWOnPkfrEdAdS9iSmiIzqmh6CmmdgvZt1WC5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.658.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.223.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.223.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2m0grtXlhyGkexUbiGunu6AnFrHXj4E2aKs1K8u4yJNWxfkWSs7Qnsbx81Il5eBn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.223.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.223.0/index.min.mjs": "sha384-2m0grtXlhyGkexUbiGunu6AnFrHXj4E2aKs1K8u4yJNWxfkWSs7Qnsbx81Il5eBn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.223.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.922.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.922.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FANp0oaSwrqTQ2TRjXkELmfwbyl53KYbq4LzGQT2mtJpyea6lA92xtQyDkqkKYgX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.922.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.922.0/index.min.mjs": "sha384-FANp0oaSwrqTQ2TRjXkELmfwbyl53KYbq4LzGQT2mtJpyea6lA92xtQyDkqkKYgX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.922.0/LICENSE
```

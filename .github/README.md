...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.932.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.932.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-y1YU8h0fkjyDqHvgwEFXDrBR4Cj4S5F5SPSfRC6/OaMPsS/zvj470v1nLAu63jal
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.932.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.932.0/index.min.mjs": "sha384-y1YU8h0fkjyDqHvgwEFXDrBR4Cj4S5F5SPSfRC6/OaMPsS/zvj470v1nLAu63jal"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.932.0/LICENSE
```

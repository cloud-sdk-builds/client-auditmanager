...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.370.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.370.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Qldn2WJ7csIh2fRpqdYGpOoyieSSTYy0pV6NtAN323KaKqhmGks5XO/Ou9QIqjm0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.370.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.370.0/index.min.mjs": "sha384-Qldn2WJ7csIh2fRpqdYGpOoyieSSTYy0pV6NtAN323KaKqhmGks5XO/Ou9QIqjm0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.370.0/LICENSE
```

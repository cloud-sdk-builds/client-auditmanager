...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.110.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.110.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yvFsD/V6awipgPJoHHFvDQZMYHH5z9fY6ahBr7l7oEMUlTpm9vNum1/KYQJ7IN6c
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.110.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.110.0/index.min.mjs": "sha384-yvFsD/V6awipgPJoHHFvDQZMYHH5z9fY6ahBr7l7oEMUlTpm9vNum1/KYQJ7IN6c"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.110.0/LICENSE
```

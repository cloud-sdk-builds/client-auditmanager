...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.257.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.257.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pZ9iASP4wK8aQBxlQp9+OEvtscPUBhcq6qQ8AC5+qQAjVuulaFYEZHMYLnWZTqf5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.257.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.257.0/index.min.mjs": "sha384-pZ9iASP4wK8aQBxlQp9+OEvtscPUBhcq6qQ8AC5+qQAjVuulaFYEZHMYLnWZTqf5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.257.0/LICENSE
```

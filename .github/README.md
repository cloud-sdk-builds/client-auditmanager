...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.178.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.178.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+7L1O4pPObN+u/NUyYgm6H3VO6JuzGYp75F3f+0R6zlFP5ApouqLU3uOuM47fuVa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.178.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.178.0/index.min.mjs": "sha384-+7L1O4pPObN+u/NUyYgm6H3VO6JuzGYp75F3f+0R6zlFP5ApouqLU3uOuM47fuVa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.178.0/LICENSE
```

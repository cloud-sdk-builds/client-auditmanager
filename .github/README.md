...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.886.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.886.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lJB9UIazR5/6zERYfJwpnml4xCoqT14R/hxI0O6WnagPeLTdx5w8q4LVNCyuG9IH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.886.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.886.0/index.min.mjs": "sha384-lJB9UIazR5/6zERYfJwpnml4xCoqT14R/hxI0O6WnagPeLTdx5w8q4LVNCyuG9IH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.886.0/LICENSE
```

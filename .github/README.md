...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.81.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.81.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aws8eA8MDQYUM+ZRhhVqu8zVm3P9iMjr5MM++vy1Qzm7NxVGHBGeRNjtUlqHLe7X
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.81.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.81.0/index.min.mjs": "sha384-aws8eA8MDQYUM+ZRhhVqu8zVm3P9iMjr5MM++vy1Qzm7NxVGHBGeRNjtUlqHLe7X"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.81.0/LICENSE
```

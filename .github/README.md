...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.575.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.575.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-L2mCqHlISQ+yoOHLVvDILhY3Fk5wzI5AEtNvQMm6BSwjlWLsMkGIWn4ENNq2mRYU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.575.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.575.0/index.min.mjs": "sha384-L2mCqHlISQ+yoOHLVvDILhY3Fk5wzI5AEtNvQMm6BSwjlWLsMkGIWn4ENNq2mRYU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.575.0/LICENSE
```

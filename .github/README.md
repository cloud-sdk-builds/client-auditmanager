...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.984.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.984.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4V8VZMZAaqqGBHbdNYyY8Ut7qav8TnVD3MTEmILQ7tt9hklxFSOWH/Tv6AQmo5q+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.984.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.984.0/index.min.mjs": "sha384-4V8VZMZAaqqGBHbdNYyY8Ut7qav8TnVD3MTEmILQ7tt9hklxFSOWH/Tv6AQmo5q+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.984.0/LICENSE
```

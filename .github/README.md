...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.352.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.352.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aLjfXYcM1qv2Xhjd0BBjzyECoSimzx96jA75Ct1iXH31vKKXyGkPCKp3Bripaknf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.352.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.352.0/index.min.mjs": "sha384-aLjfXYcM1qv2Xhjd0BBjzyECoSimzx96jA75Ct1iXH31vKKXyGkPCKp3Bripaknf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.352.0/LICENSE
```

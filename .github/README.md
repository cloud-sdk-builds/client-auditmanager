...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.1039.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1039.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qsjpktcScW5/aCGqUwpi8qNRHD6/59MAUNZ+s8PO1lPZU0SgGTd+8BQUFKhm+wC4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1039.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1039.0/index.min.mjs": "sha384-qsjpktcScW5/aCGqUwpi8qNRHD6/59MAUNZ+s8PO1lPZU0SgGTd+8BQUFKhm+wC4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.1039.0/LICENSE
```

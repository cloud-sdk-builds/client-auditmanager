...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.13.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.13.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8uZGNkEzO48ezHY6E1gzDlLLDrmyN+vWBfmCrh8npupff+4PmlLUq4y7IFdVlQ1d
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.13.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.13.0/index.min.mjs": "sha384-8uZGNkEzO48ezHY6E1gzDlLLDrmyN+vWBfmCrh8npupff+4PmlLUq4y7IFdVlQ1d"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.13.0/LICENSE
```

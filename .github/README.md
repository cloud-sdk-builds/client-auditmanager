...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.857.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.857.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Sum8RtvJk3+OQPpuGUP+6uQMyLeRNCPTIWggM2xptw+bf5pzd1Mf4cz6h1+jwk6U
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.857.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.857.0/index.min.mjs": "sha384-Sum8RtvJk3+OQPpuGUP+6uQMyLeRNCPTIWggM2xptw+bf5pzd1Mf4cz6h1+jwk6U"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.857.0/LICENSE
```

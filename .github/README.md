...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.201.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.201.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wmwdSPNoM8N9aRcSlnYqrfToN65j0Laira6jRDF2eejZM/DPzmU1hV0f9YDH6NHe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.201.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.201.0/index.min.mjs": "sha384-wmwdSPNoM8N9aRcSlnYqrfToN65j0Laira6jRDF2eejZM/DPzmU1hV0f9YDH6NHe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.201.0/LICENSE
```

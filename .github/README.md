...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.587.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.587.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Tq/1fAjXfECOWi7Ze7FVAtIkLiJy/3hYN68VGBpSJeT3v57+5t9gfi56IF6PJ21d
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.587.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.587.0/index.min.mjs": "sha384-Tq/1fAjXfECOWi7Ze7FVAtIkLiJy/3hYN68VGBpSJeT3v57+5t9gfi56IF6PJ21d"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.587.0/LICENSE
```

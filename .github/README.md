...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.128.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.128.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WFQf3tWu82JCXV+p8NC2ymobHye1Jtb7MdDG/QF3FQso217dpWmko9dnDz+oi18s
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.128.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.128.0/index.min.mjs": "sha384-WFQf3tWu82JCXV+p8NC2ymobHye1Jtb7MdDG/QF3FQso217dpWmko9dnDz+oi18s"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.128.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.485.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.485.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pMVWyGSbcrOJ5IG9O0URtV3DWX6qHShNyxJnHnUUzC4bjH2p3FsyQ0BDiqXp+F3M
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.485.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.485.0/index.min.mjs": "sha384-pMVWyGSbcrOJ5IG9O0URtV3DWX6qHShNyxJnHnUUzC4bjH2p3FsyQ0BDiqXp+F3M"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.485.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.437.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.437.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AOLYjp/UzfUWuiJ5upnwXtpQAKx0z2GwQ2s8Mw2cdXlWWt+iMFqLIHunP5XNGs03
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.437.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.437.0/index.min.mjs": "sha384-AOLYjp/UzfUWuiJ5upnwXtpQAKx0z2GwQ2s8Mw2cdXlWWt+iMFqLIHunP5XNGs03"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.437.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.341.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.341.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9FbH+V11o1k/1f3b9HyeDj5Bv4SZjZF+ARvev1zM2p1EMvqOrB7j8AnzaPWDDc6l
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.341.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.341.0/index.min.mjs": "sha384-9FbH+V11o1k/1f3b9HyeDj5Bv4SZjZF+ARvev1zM2p1EMvqOrB7j8AnzaPWDDc6l"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.341.0/LICENSE
```

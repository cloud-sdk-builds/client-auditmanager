...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.823.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.823.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-N7EXdhq8ufQQsu4Phuv5GdkcQMtnj9R3Cyw4GkOa9E+yXT94R38GhYiyCrNfbqDW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.823.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.823.0/index.min.mjs": "sha384-N7EXdhq8ufQQsu4Phuv5GdkcQMtnj9R3Cyw4GkOa9E+yXT94R38GhYiyCrNfbqDW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.823.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.159.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.159.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lChKjU7z7oQ5MUiMji6iKadYtmwiq/cEX3KZfz3/XK38DZ5dWMCq387gy62yhR2r
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.159.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.159.0/index.min.mjs": "sha384-lChKjU7z7oQ5MUiMji6iKadYtmwiq/cEX3KZfz3/XK38DZ5dWMCq387gy62yhR2r"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.159.0/LICENSE
```

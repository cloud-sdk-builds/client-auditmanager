...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.301.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.301.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MyEAp0nW6sC4nnuC1fSaSTDcS0+NlU3YszjyeIZ3oxM74fwib0s5NKGBZ2Orlhiq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.301.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.301.0/index.min.mjs": "sha384-MyEAp0nW6sC4nnuC1fSaSTDcS0+NlU3YszjyeIZ3oxM74fwib0s5NKGBZ2Orlhiq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.301.0/LICENSE
```

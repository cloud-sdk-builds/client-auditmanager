...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.369.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.369.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yeOMO2DpIfd3178BVaTFNH0pS/PoOf1BvtdThhKgM+7dVD7PAfsQkqCXWRBpnGZu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.369.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.369.0/index.min.mjs": "sha384-yeOMO2DpIfd3178BVaTFNH0pS/PoOf1BvtdThhKgM+7dVD7PAfsQkqCXWRBpnGZu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.369.0/LICENSE
```

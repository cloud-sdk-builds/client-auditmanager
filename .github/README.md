...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.974.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.974.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8ksdWKLqr6tqbpzaeDWDscaFakg9leuEiylUso5Bj79ZJv2VeCCbZ/bBJy6YtQtI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.974.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.974.0/index.min.mjs": "sha384-8ksdWKLqr6tqbpzaeDWDscaFakg9leuEiylUso5Bj79ZJv2VeCCbZ/bBJy6YtQtI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.974.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.608.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.608.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PXGdM7vKlSPLuaxPdD6fmkz1fzne2JfQ0WjmOl2eqWk8ORKjVv2jL254nzIoVN3R
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.608.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.608.0/index.min.mjs": "sha384-PXGdM7vKlSPLuaxPdD6fmkz1fzne2JfQ0WjmOl2eqWk8ORKjVv2jL254nzIoVN3R"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.608.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.451.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.451.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-t/NhjxTnc++9rHOwFQYJDssVQlQzD2nIT6/z97WzrEejpz5z+KRoKYrYKhXKxMjq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.451.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.451.0/index.min.mjs": "sha384-t/NhjxTnc++9rHOwFQYJDssVQlQzD2nIT6/z97WzrEejpz5z+KRoKYrYKhXKxMjq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.451.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.987.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.987.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-r6aVVR1TR7m7R3QB6iMszNt0/l0fcS1GFkDbnaQ5WAJJSkpAlki/uP6ax9qI/vRX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.987.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.987.0/index.min.mjs": "sha384-r6aVVR1TR7m7R3QB6iMszNt0/l0fcS1GFkDbnaQ5WAJJSkpAlki/uP6ax9qI/vRX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.987.0/LICENSE
```

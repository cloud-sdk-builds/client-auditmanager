...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.49.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.49.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ygXCyMp2Q1t6t1ClxnuiVnHKcrQSurlqPei8T+MaDS+Ta0gdovoT6vNkm6+L2K49
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.49.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.49.0/index.min.mjs": "sha384-ygXCyMp2Q1t6t1ClxnuiVnHKcrQSurlqPei8T+MaDS+Ta0gdovoT6vNkm6+L2K49"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.49.0/LICENSE
```

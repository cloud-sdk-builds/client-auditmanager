...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.859.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.859.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tzA/RT5HXTB3bSSYWzMa56chBU4/vfgurSH8PFMI15+Cv4QYvmkGEnC1xBfiypGA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.859.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.859.0/index.min.mjs": "sha384-tzA/RT5HXTB3bSSYWzMa56chBU4/vfgurSH8PFMI15+Cv4QYvmkGEnC1xBfiypGA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.859.0/LICENSE
```

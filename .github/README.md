...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.54.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.54.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-sATsA2TIsZHzdyikmpgAn87Nd0N3+xTVfN8EvZ24NBeiLVgBMvrRT9cXCdoJOAE6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.54.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.54.1/index.min.mjs": "sha384-sATsA2TIsZHzdyikmpgAn87Nd0N3+xTVfN8EvZ24NBeiLVgBMvrRT9cXCdoJOAE6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.54.1/LICENSE
```

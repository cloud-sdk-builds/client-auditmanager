...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.609.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.609.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Dl0Y6ICWqGMyUhgE82yvTAK/2juR1cxrxqGQar8zNb3qh0F5qFcenNx3IgZTY6G1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.609.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.609.0/index.min.mjs": "sha384-Dl0Y6ICWqGMyUhgE82yvTAK/2juR1cxrxqGQar8zNb3qh0F5qFcenNx3IgZTY6G1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.609.0/LICENSE
```

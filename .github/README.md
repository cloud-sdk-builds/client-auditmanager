...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.460.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.460.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Pm+AVymudYotZUxVFaIJZgKK2+fmAhTFWmxdJUeDFl4aPKZ17fE9BqRWqcVza5vX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.460.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.460.0/index.min.mjs": "sha384-Pm+AVymudYotZUxVFaIJZgKK2+fmAhTFWmxdJUeDFl4aPKZ17fE9BqRWqcVza5vX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.460.0/LICENSE
```

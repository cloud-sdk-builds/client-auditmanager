...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.14.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.14.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aql2ZnMA5jM18YWsHMG0g9lIVKHu3mpQ9P8mm+waElK+F+9qvDf7RdFG71EWfZDH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.14.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.14.0/index.min.mjs": "sha384-aql2ZnMA5jM18YWsHMG0g9lIVKHu3mpQ9P8mm+waElK+F+9qvDf7RdFG71EWfZDH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.14.0/LICENSE
```

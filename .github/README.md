...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.20.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.20.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-40kcUh6l1RbKuOp/+lRl3R0u43/E2gldyweBOrl2QV0iSnDKLrQdNzn0tjrclUdQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.20.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.20.0/index.min.mjs": "sha384-40kcUh6l1RbKuOp/+lRl3R0u43/E2gldyweBOrl2QV0iSnDKLrQdNzn0tjrclUdQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.20.0/LICENSE
```

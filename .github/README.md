...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.22.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.22.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5srEYJzplyTxi+kacqHPRp98m8G7T/nt1vTNR90/mtklKPGF4PBuORHUjqnz8pkM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.22.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.22.0/index.min.mjs": "sha384-5srEYJzplyTxi+kacqHPRp98m8G7T/nt1vTNR90/mtklKPGF4PBuORHUjqnz8pkM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.22.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.738.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.738.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aXzNQfvuLUiKHPfyMa4vGELYFzW7QN2oT3qcMClQvf36vLIpxV+i2b36vwmL69MT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.738.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.738.0/index.min.mjs": "sha384-aXzNQfvuLUiKHPfyMa4vGELYFzW7QN2oT3qcMClQvf36vLIpxV+i2b36vwmL69MT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.738.0/LICENSE
```

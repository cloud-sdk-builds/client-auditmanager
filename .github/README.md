...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.840.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.840.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xcLbvYGX+jql7FJCN9tIi01Bc31ycqQ9Ld0mCjEVhNKShnVoq/VY7p4lHMfgDEcl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.840.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.840.0/index.min.mjs": "sha384-xcLbvYGX+jql7FJCN9tIi01Bc31ycqQ9Ld0mCjEVhNKShnVoq/VY7p4lHMfgDEcl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.840.0/LICENSE
```

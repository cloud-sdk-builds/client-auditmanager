...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.4.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.4.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-c8dRAvMLjUq4IYIHqspQrIM2swCBwQ6jlCZm/jr2I6GPfS0XVOQj39FEqyZ0JbjI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.4.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.4.0/index.min.mjs": "sha384-c8dRAvMLjUq4IYIHqspQrIM2swCBwQ6jlCZm/jr2I6GPfS0XVOQj39FEqyZ0JbjI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.4.0/LICENSE
```

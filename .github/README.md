...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.967.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.967.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-C/l81epwyUhq2pAuttMNDh2oNWnCHKcIPAJFbL1FHcaSb5FdyI6Lz0U66Dgg/S6S
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.967.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.967.0/index.min.mjs": "sha384-C/l81epwyUhq2pAuttMNDh2oNWnCHKcIPAJFbL1FHcaSb5FdyI6Lz0U66Dgg/S6S"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.967.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.58.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.58.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CLB+2REmteTvSS8U4m+E+S3rL15MyNrc290fVH5hvNHECVyAZzrBmeXOkVXuvWWW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.58.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.58.0/index.min.mjs": "sha384-CLB+2REmteTvSS8U4m+E+S3rL15MyNrc290fVH5hvNHECVyAZzrBmeXOkVXuvWWW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.58.0/LICENSE
```

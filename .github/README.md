...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.218.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.218.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OPmJyD5Bo5rres4T2A+UGWy3ihYS0vaNzlmkbRo/JV6Ok9TWZ9LNxq39l0DmFDrN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.218.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.218.0/index.min.mjs": "sha384-OPmJyD5Bo5rres4T2A+UGWy3ihYS0vaNzlmkbRo/JV6Ok9TWZ9LNxq39l0DmFDrN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.218.0/LICENSE
```

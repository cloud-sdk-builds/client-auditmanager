...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.192.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.192.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VmATbJdlu3sB0GLc+cB2jPR8nXb1Ex5csPI6HhH0/On1GcE1r1IKw2ZZPZqbPXuJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.192.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.192.0/index.min.mjs": "sha384-VmATbJdlu3sB0GLc+cB2jPR8nXb1Ex5csPI6HhH0/On1GcE1r1IKw2ZZPZqbPXuJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.192.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.145.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.145.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9UP+r1gXeAfnYKd+1im72E6AGo33SGeb8Avr3hlpPn02HoNX8irwhwnHPtyqAnqd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.145.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.145.0/index.min.mjs": "sha384-9UP+r1gXeAfnYKd+1im72E6AGo33SGeb8Avr3hlpPn02HoNX8irwhwnHPtyqAnqd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.145.0/LICENSE
```

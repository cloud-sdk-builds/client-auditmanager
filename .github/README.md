...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.226.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.226.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-V1/Dmj8LCBqFiQPMJKTrnUM6o9hDdXLCAQ+rTBNpA7sUk3Y+OTGZ1cUEx0S/lOIL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.226.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.226.0/index.min.mjs": "sha384-V1/Dmj8LCBqFiQPMJKTrnUM6o9hDdXLCAQ+rTBNpA7sUk3Y+OTGZ1cUEx0S/lOIL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.226.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.300.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.300.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dUFv8NEbQ8L3t2sn8dhvHrf3eSoRtrpEigZH4XefHeOs12qS0rwm/Ohy5dw8rRnF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.300.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.300.0/index.min.mjs": "sha384-dUFv8NEbQ8L3t2sn8dhvHrf3eSoRtrpEigZH4XefHeOs12qS0rwm/Ohy5dw8rRnF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.300.0/LICENSE
```

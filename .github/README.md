...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.436.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.436.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BGgxClMS2lzeDVRO5lCaUeeaCmJlumzFOa0i6k0jcZVEjleV5j6CD4K6AXpb04L5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.436.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.436.0/index.min.mjs": "sha384-BGgxClMS2lzeDVRO5lCaUeeaCmJlumzFOa0i6k0jcZVEjleV5j6CD4K6AXpb04L5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.436.0/LICENSE
```

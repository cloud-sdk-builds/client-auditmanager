...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.326.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.326.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-t3VD3ks6VUx0HyirKu0DcL+//A6ymZyZQv7R0YuVF9HEAp1Qmucn0H3Bkfmmxd/4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.326.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.326.0/index.min.mjs": "sha384-t3VD3ks6VUx0HyirKu0DcL+//A6ymZyZQv7R0YuVF9HEAp1Qmucn0H3Bkfmmxd/4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.326.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.94.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.94.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bn+R2Pcj135pvCc4tpZjtXFEMy6Xkq4STD9U3Ag9cBEMMsHyAlsB+t7s+csQa6vj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.94.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.94.0/index.min.mjs": "sha384-bn+R2Pcj135pvCc4tpZjtXFEMy6Xkq4STD9U3Ag9cBEMMsHyAlsB+t7s+csQa6vj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.94.0/LICENSE
```

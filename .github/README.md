...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.272.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.272.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kjjM7IephHYqRa/nLiLlfQbtpMxltRzzdtdCJAKWki94/Nm/mG46Wx5i2A16ig+I
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.272.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.272.0/index.min.mjs": "sha384-kjjM7IephHYqRa/nLiLlfQbtpMxltRzzdtdCJAKWki94/Nm/mG46Wx5i2A16ig+I"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.272.0/LICENSE
```

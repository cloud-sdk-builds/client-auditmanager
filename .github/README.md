...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.1036.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1036.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yTPl3X/43J6iPPZcoJwuJeYLaEDIuSQ8TigWHEK/DPMPjqpH38WzTcf7jA5GfuOU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1036.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1036.0/index.min.mjs": "sha384-yTPl3X/43J6iPPZcoJwuJeYLaEDIuSQ8TigWHEK/DPMPjqpH38WzTcf7jA5GfuOU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.1036.0/LICENSE
```

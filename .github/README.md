...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.946.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.946.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1FSQShZ5UpJJ61KTsW7g7rCOKE1wA2yFCl1l7PmSYI3HfRc7rR0xvh/uZ4jAIGAT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.946.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.946.0/index.min.mjs": "sha384-1FSQShZ5UpJJ61KTsW7g7rCOKE1wA2yFCl1l7PmSYI3HfRc7rR0xvh/uZ4jAIGAT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.946.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.10.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.10.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rzPFRTE58iRj1pEg/MtUrY2Si3IpxNWYcUqxERi3dKgOqRIiDjsIkjC66MUUXAM0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.10.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.10.0/index.min.mjs": "sha384-rzPFRTE58iRj1pEg/MtUrY2Si3IpxNWYcUqxERi3dKgOqRIiDjsIkjC66MUUXAM0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.10.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.503.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.503.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-d1rcNaioO0Fww2dhgCpbpxY8i257eA69gpf0ZFkr7Qko90nzQbAwFwUV3hqL12mX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.503.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.503.1/index.min.mjs": "sha384-d1rcNaioO0Fww2dhgCpbpxY8i257eA69gpf0ZFkr7Qko90nzQbAwFwUV3hqL12mX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.503.1/LICENSE
```

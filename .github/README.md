...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.470.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.470.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6Zo+neWhBMlPKewFWc1Gp8MHc0tz/BGKPfRO9ufqx+3zOmD9dkCE/xZ5jFTQZGfn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.470.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.470.0/index.min.mjs": "sha384-6Zo+neWhBMlPKewFWc1Gp8MHc0tz/BGKPfRO9ufqx+3zOmD9dkCE/xZ5jFTQZGfn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.470.0/LICENSE
```

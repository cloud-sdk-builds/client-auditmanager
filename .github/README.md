...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.266.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.266.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5AO64nyPU0TJamqVHFZXUb8oMdLxIfE+MAeq0uXycfHiJUm7S0qzVWowjp79xU6V
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.266.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.266.0/index.min.mjs": "sha384-5AO64nyPU0TJamqVHFZXUb8oMdLxIfE+MAeq0uXycfHiJUm7S0qzVWowjp79xU6V"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.266.0/LICENSE
```

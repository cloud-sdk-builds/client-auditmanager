...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.47.2).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.47.2/index.min.mjs
```

SRI SHA Hash

```text
sha384-/n37CoV3oidZJVe5rfPOWFBGtHCp3Y9f014C3aYlcWCd8pHlE5R5dJhpd7detPAz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.47.2/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.47.2/index.min.mjs": "sha384-/n37CoV3oidZJVe5rfPOWFBGtHCp3Y9f014C3aYlcWCd8pHlE5R5dJhpd7detPAz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.47.2/LICENSE
```

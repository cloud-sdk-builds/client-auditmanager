...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.41.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.41.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-86JFQQiPWYzA02GhFZ21jy8yPyoNa60SNKYqnu/q+pt+D37NeERXdcq/tMghggkb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.41.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.41.0/index.min.mjs": "sha384-86JFQQiPWYzA02GhFZ21jy8yPyoNa60SNKYqnu/q+pt+D37NeERXdcq/tMghggkb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.41.0/LICENSE
```

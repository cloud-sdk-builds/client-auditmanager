...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.478.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.478.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9LitUjDUN8oupm46XVZZfq3KCKtISR8sSYjSD7oFASBB4jp+yq9OBEePrI5cpsBM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.478.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.478.0/index.min.mjs": "sha384-9LitUjDUN8oupm46XVZZfq3KCKtISR8sSYjSD7oFASBB4jp+yq9OBEePrI5cpsBM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.478.0/LICENSE
```

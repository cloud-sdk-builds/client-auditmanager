...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.631.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.631.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-X87HCtGwPFVERxN23QflJRJJ6VKb1eCe8+DSFDsnM8Yyx0esoX6NQP+SjKEBkCWq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.631.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.631.0/index.min.mjs": "sha384-X87HCtGwPFVERxN23QflJRJJ6VKb1eCe8+DSFDsnM8Yyx0esoX6NQP+SjKEBkCWq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.631.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.1025.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1025.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dNH70GVZBoNZkQufup816ZGVSkmGI8CHdlpTyQm/Ol5rlvviq5+eYlEPGz7Sc/vs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1025.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1025.0/index.min.mjs": "sha384-dNH70GVZBoNZkQufup816ZGVSkmGI8CHdlpTyQm/Ol5rlvviq5+eYlEPGz7Sc/vs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.1025.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.358.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.358.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IS+1ZnVabQ8mjqUf+YVHpjUBRBFSUjyRFoU09Q7orx6LZgjn5oCUmLN367FsEUKa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.358.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.358.0/index.min.mjs": "sha384-IS+1ZnVabQ8mjqUf+YVHpjUBRBFSUjyRFoU09Q7orx6LZgjn5oCUmLN367FsEUKa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.358.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.319.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.319.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-P3iCcADkeUiP2FzyDHSiWcj0qzMcTtCJPojLCbRTxXF79iVzWfEGEligQr3kLFmW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.319.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.319.0/index.min.mjs": "sha384-P3iCcADkeUiP2FzyDHSiWcj0qzMcTtCJPojLCbRTxXF79iVzWfEGEligQr3kLFmW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.319.0/LICENSE
```

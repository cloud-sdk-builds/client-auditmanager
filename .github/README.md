...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.677.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.677.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pc5W8cBPx6ILJJ4G+BVdIGu6dUJIPYAkgMfAkqABt+jLLJzOy07ZWRr5wayDG2TK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.677.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.677.0/index.min.mjs": "sha384-pc5W8cBPx6ILJJ4G+BVdIGu6dUJIPYAkgMfAkqABt+jLLJzOy07ZWRr5wayDG2TK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.677.0/LICENSE
```

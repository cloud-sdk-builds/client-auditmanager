...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.750.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.750.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RWz2i7J/Hk/xHAzyJuPwQr4LiBdzEVdF5JBZMmelMl5+c475b4uHiMuv7e/LX1t9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.750.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.750.0/index.min.mjs": "sha384-RWz2i7J/Hk/xHAzyJuPwQr4LiBdzEVdF5JBZMmelMl5+c475b4uHiMuv7e/LX1t9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.750.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.267.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.267.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hCMA7jkbry+esSmGpLdbLegCK/7ClHPa1EUOEy3ItHcqrfAmzNcwO4HC3PCVwNZ4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.267.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.267.0/index.min.mjs": "sha384-hCMA7jkbry+esSmGpLdbLegCK/7ClHPa1EUOEy3ItHcqrfAmzNcwO4HC3PCVwNZ4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.267.0/LICENSE
```

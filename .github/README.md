...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.186.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.186.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+O4w5N6ma+lO28HZS2SqKx08o6cqx53zzOsz+GnXR9TmNn+rVVksiNXLIGjPkug3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.186.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.186.0/index.min.mjs": "sha384-+O4w5N6ma+lO28HZS2SqKx08o6cqx53zzOsz+GnXR9TmNn+rVVksiNXLIGjPkug3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.186.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.118.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.118.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-apQw+pESEixlZCYk2c/IdYRiaGQgh9zkjtXRlEq0xNtaZ3tpALFUAYKxu/0Rl+eS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.118.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.118.0/index.min.mjs": "sha384-apQw+pESEixlZCYk2c/IdYRiaGQgh9zkjtXRlEq0xNtaZ3tpALFUAYKxu/0Rl+eS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.118.0/LICENSE
```

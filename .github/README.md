...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.26.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.26.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-X8yErLamtxZnjEAObpNEGNuZRXhSW8UsEzaS2dAtdFyY3sInOvVRFsSLo+QFqxxu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.26.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.26.0/index.min.mjs": "sha384-X8yErLamtxZnjEAObpNEGNuZRXhSW8UsEzaS2dAtdFyY3sInOvVRFsSLo+QFqxxu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.26.0/LICENSE
```

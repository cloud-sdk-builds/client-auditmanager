...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.1015.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1015.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ee7hDxftLSJc14NBbfzIiuuJY/4iNNIJvn7ihSJUMd90cxJMZT8U1ip1cOYOP3m3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1015.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1015.0/index.min.mjs": "sha384-ee7hDxftLSJc14NBbfzIiuuJY/4iNNIJvn7ihSJUMd90cxJMZT8U1ip1cOYOP3m3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.1015.0/LICENSE
```

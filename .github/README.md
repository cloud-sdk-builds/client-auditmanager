...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.5.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.5.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0RefP7nFvfLcUJGjz0u82Ov0WrvrvHWw0vogKNyvUuzPd02WMGUa9iMIJjyVNlMn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.5.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.5.0/index.min.mjs": "sha384-0RefP7nFvfLcUJGjz0u82Ov0WrvrvHWw0vogKNyvUuzPd02WMGUa9iMIJjyVNlMn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.5.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.0.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.0.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hn1uz7RCESoBRZlW6BM+IswCw4N5690SkcvWnChQQgIIXVRht7nO++stXiAAO0ZE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.0.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.0.0/index.min.mjs": "sha384-hn1uz7RCESoBRZlW6BM+IswCw4N5690SkcvWnChQQgIIXVRht7nO++stXiAAO0ZE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.0.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.972.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.972.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1XOcthuNGXZBEt18Z/TuATY1IJSBJCqB6wnSg0mWMiaWOr7k7lS4HDKOSZO94owR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.972.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.972.0/index.min.mjs": "sha384-1XOcthuNGXZBEt18Z/TuATY1IJSBJCqB6wnSg0mWMiaWOr7k7lS4HDKOSZO94owR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.972.0/LICENSE
```

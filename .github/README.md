...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.329.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.329.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HzEw1yP8aqXvMwAIZF3yKsf0FFVxEJ2sRH8Mea08dwoEwNq2CzfjKKeSM8CWPuvJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.329.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.329.0/index.min.mjs": "sha384-HzEw1yP8aqXvMwAIZF3yKsf0FFVxEJ2sRH8Mea08dwoEwNq2CzfjKKeSM8CWPuvJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.329.0/LICENSE
```

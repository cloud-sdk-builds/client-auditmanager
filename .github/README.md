...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.477.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.477.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-F1KhMxlh+7j0r+s8hclxeYQdQ4ettAgbdbfhBXxtT54526oQG5IxPjpt/GnmJ78M
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.477.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.477.0/index.min.mjs": "sha384-F1KhMxlh+7j0r+s8hclxeYQdQ4ettAgbdbfhBXxtT54526oQG5IxPjpt/GnmJ78M"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.477.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.645.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.645.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ahWaWX7OWVKfZtqTladbVpEwb7oH5ioprDtT+GRUV15+LuHXzJCweo6RjJDMjU6s
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.645.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.645.0/index.min.mjs": "sha384-ahWaWX7OWVKfZtqTladbVpEwb7oH5ioprDtT+GRUV15+LuHXzJCweo6RjJDMjU6s"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.645.0/LICENSE
```

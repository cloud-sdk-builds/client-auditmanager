...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.1008.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1008.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cAxjMt2jGmsKrlPxE2CRXDOeaafVQdKtk1V63Uu6m20Y+niF1O38AVuOeeg3Lffo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1008.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.1008.0/index.min.mjs": "sha384-cAxjMt2jGmsKrlPxE2CRXDOeaafVQdKtk1V63Uu6m20Y+niF1O38AVuOeeg3Lffo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.1008.0/LICENSE
```

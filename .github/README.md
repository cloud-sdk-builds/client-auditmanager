...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.382.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.382.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NB/B7LRq7V12jKQ90IG6acgkY/aPdK8eSREy2YfSbzohRwMR/p2bxB4HrC3Kw4BE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.382.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.382.0/index.min.mjs": "sha384-NB/B7LRq7V12jKQ90IG6acgkY/aPdK8eSREy2YfSbzohRwMR/p2bxB4HrC3Kw4BE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.382.0/LICENSE
```

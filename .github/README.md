...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.289.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.289.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lPRFMwf49iSrhRvYhwsnk/r7u0y5/qSJCSeyCbHNN6lazxyKUez06QijdeouTQO8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.289.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.289.0/index.min.mjs": "sha384-lPRFMwf49iSrhRvYhwsnk/r7u0y5/qSJCSeyCbHNN6lazxyKUez06QijdeouTQO8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.289.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.858.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.858.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-e5tYsGuwf2glUJm0zU23xO9iiTmHcs7R0RenIaEN9lyRfceAHHxde7j11cjdPXfO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.858.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.858.0/index.min.mjs": "sha384-e5tYsGuwf2glUJm0zU23xO9iiTmHcs7R0RenIaEN9lyRfceAHHxde7j11cjdPXfO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.858.0/LICENSE
```

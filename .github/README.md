...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.8.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.8.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-miIHpXOBqWwsESqmscxypom0PG4/NOe26QJ8XdNT6gH5xGwD6bsrlURtUQQaXUVi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.8.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.8.0/index.min.mjs": "sha384-miIHpXOBqWwsESqmscxypom0PG4/NOe26QJ8XdNT6gH5xGwD6bsrlURtUQQaXUVi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.8.0/LICENSE
```

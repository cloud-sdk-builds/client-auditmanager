...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.896.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.896.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1qLm3E6SP/zrxME6x4jvio8B8Kp88MOOVpVQR9j/m3Og2m5w2UzacOUwt1ywsDju
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.896.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.896.0/index.min.mjs": "sha384-1qLm3E6SP/zrxME6x4jvio8B8Kp88MOOVpVQR9j/m3Og2m5w2UzacOUwt1ywsDju"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.896.0/LICENSE
```

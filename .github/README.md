...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.47.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.47.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-IUZtwv4p86nxprDbuMMFscRdxavTvh8rIelTydOw6GdRDb02kgcdfXCMBBXuLq7y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.47.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.47.1/index.min.mjs": "sha384-IUZtwv4p86nxprDbuMMFscRdxavTvh8rIelTydOw6GdRDb02kgcdfXCMBBXuLq7y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.47.1/LICENSE
```

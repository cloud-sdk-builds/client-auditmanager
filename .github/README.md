...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.388.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.388.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cyzbsMZjUAw4x7V6TZOyDQGkJpn6QPEoEqPL9VNb3R3QsRbKrcEBlyUw1Yw0gIiV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.388.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.388.0/index.min.mjs": "sha384-cyzbsMZjUAw4x7V6TZOyDQGkJpn6QPEoEqPL9VNb3R3QsRbKrcEBlyUw1Yw0gIiV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.388.0/LICENSE
```

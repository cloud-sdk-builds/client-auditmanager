...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.940.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.940.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-e4MFdlDONyCoJDudttmqr1hzPDw7xpmFMlqFer2jl3An8h2ftSrdyr29B2H0YThy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.940.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.940.0/index.min.mjs": "sha384-e4MFdlDONyCoJDudttmqr1hzPDw7xpmFMlqFer2jl3An8h2ftSrdyr29B2H0YThy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.940.0/LICENSE
```

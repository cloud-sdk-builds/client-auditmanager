...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.936.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.936.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3RHzgo7oI0Q1w+O3JU0yzydFI/G3q8Asa+cs7RpMhGU9zngawZDavmvn7yBizcfT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.936.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.936.0/index.min.mjs": "sha384-3RHzgo7oI0Q1w+O3JU0yzydFI/G3q8Asa+cs7RpMhGU9zngawZDavmvn7yBizcfT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.936.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.196.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.196.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nzRbOFVhmGLxbB8Ue3zkDD4weJePanlZawq46YMQ549GjuLmY0z8nV5C6pSlfipA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.196.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.196.0/index.min.mjs": "sha384-nzRbOFVhmGLxbB8Ue3zkDD4weJePanlZawq46YMQ549GjuLmY0z8nV5C6pSlfipA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.196.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.431.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.431.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4eRvq6Vnd1Rz2nb/EBQWvCo/R7njBA/UXSIYfVqDVDKkLGqWQbUf35RyHscSHf4N
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.431.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.431.0/index.min.mjs": "sha384-4eRvq6Vnd1Rz2nb/EBQWvCo/R7njBA/UXSIYfVqDVDKkLGqWQbUf35RyHscSHf4N"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.431.0/LICENSE
```

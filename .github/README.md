...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.202.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.202.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ibEtws9H0l8l8G+EfV9gfdKxu71dUZ5W4tJ/ZBnKgxN3F1K0L2mPn6cgsfX9t0a/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.202.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.202.0/index.min.mjs": "sha384-ibEtws9H0l8l8G+EfV9gfdKxu71dUZ5W4tJ/ZBnKgxN3F1K0L2mPn6cgsfX9t0a/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.202.0/LICENSE
```

...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.19.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.19.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/AIjq5OoWg0zNX1D9lRrp3Kkz4M/wx45X3yvtYDBRTbHdkEAsZjjE5sR3lOm7Hg/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.19.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.19.0/index.min.mjs": "sha384-/AIjq5OoWg0zNX1D9lRrp3Kkz4M/wx45X3yvtYDBRTbHdkEAsZjjE5sR3lOm7Hg/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.19.0/LICENSE
```

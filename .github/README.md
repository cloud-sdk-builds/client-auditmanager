...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.337.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.337.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LAIx38H/aBi8K4m224j0JbxbIs90/6EXDUyVoayyd1uKoz7btqhIFRUPy7j2JwyV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.337.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.337.0/index.min.mjs": "sha384-LAIx38H/aBi8K4m224j0JbxbIs90/6EXDUyVoayyd1uKoz7btqhIFRUPy7j2JwyV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.337.0/LICENSE
```

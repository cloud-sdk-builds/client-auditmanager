...
[`@aws-sdk/client-auditmanager`](https://www.npmjs.com/package/@aws-sdk/client-auditmanager/v/3.275.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.275.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cb8/ortEA3Ec7/NWuW+/vis7dKC0Vl4C7usw/gaDTTKNeWTU3BuvbjcVEw3Y7uHD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auditmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.275.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auditmanager@3.275.0/index.min.mjs": "sha384-cb8/ortEA3Ec7/NWuW+/vis7dKC0Vl4C7usw/gaDTTKNeWTU3BuvbjcVEw3Y7uHD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auditmanager/blob/refs/tags/3.275.0/LICENSE
```
